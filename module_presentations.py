   ...
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (player_get_slot, ":faction_id", ":my_player_id", slot_player_faction_id),
   ...
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (else_try),
        ...
        (this_or_next|eq, "$g_list_players_event_value", admin_action_freeze_player),
        (eq, "$g_list_players_event_value", admin_action_outlaw_player),
      ...
      (assign,":factions_begin",factions_begin),
      ...
      (else_try), # only one iteration of the loop, for the targeted faction
        (assign, ":factions_begin", "$g_list_players_faction_id"),
        (store_add, ":factions_end", ":factions_begin", 1),
      (try_end),
      
      (try_begin),
        (is_between, "$g_list_players_faction_id", factions_begin, factions_end),#Players between factions
        
        (try_for_range, ":player_id", 1, ":max_players"),
          (player_is_active, ":player_id"),
          (try_for_range, ":current_faction_id", ":factions_begin", ":factions_end"),#Get the right players for the list
            ...
            (try_begin),
              ...
              (str_store_string, s0, "str_player_list"),
              ...
              (try_begin), # for player slot toggling, update the player name color with the current setting
                ...
                (else_try),
                  (eq, "$g_list_players_event_value", faction_admin_action_set_marshal),
                  (player_slot_eq, ":player_id", slot_player_is_marshal, 1),
                (else_try),
                  (eq, "$g_list_players_event_value", faction_admin_action_set_steward),
      ...
      (else_try),
        (eq, "$g_list_players_faction_id", -1),#All players
  ...
  ("list_factions", prsntf_manual_end_only, 0,
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (assign,":castles_begin",castle_factions_begin),
      (val_add,":castles_begin",1), ##Correct for Townwatch
      (try_for_range, ":faction_id", ":castles_begin", factions_end),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":overlay_id"),
      ...
      (assign,":castles_begin",castle_factions_begin),
      (val_add,":castles_begin",1), ##Correct for Townwatch
      (try_for_range, ":faction_id", ":castles_begin", ":loop_end"),
   ...
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (val_add, ":cur_y", escape_menu_item_height),
      (else_try),
        (assign, "$g_presentation_obj_admin_menu_reset_carts", -1),
      (try_end),
      ...
      (try_begin),
        ...
        (val_add, ":cur_y", escape_menu_item_height),
      (else_try),
        (player_slot_eq, ":my_player_id", slot_player_admin_no_event_troop, 0),
        (create_button_overlay, reg0, "str_become_special"),
        (assign, "$g_presentation_obj_admin_menu_become_godlike", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        ...
        (val_add, ":cur_y", escape_menu_item_height),
      (else_try),
        (player_slot_eq, ":my_player_id", slot_player_admin_no_guide_troop, 0),
        (create_button_overlay, reg0, "str_become_guide"),
        (assign, "$g_presentation_obj_admin_menu_become_godlike", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
      ...
      (else_try),
        ...
        (assign, "$g_presentation_obj_admin_menu_teleport_player_to_admin", -1),
      (try_end),
      
      (try_begin),
        (player_slot_eq, ":my_player_id", slot_player_admin_no_factions, 0),
        (create_button_overlay, reg0, "str_outlaw_player"),
        (assign, "$g_presentation_obj_admin_menu_outlaw_player", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (val_add, ":cur_y", escape_menu_item_height),
      (else_try),
        (assign, "$g_presentation_obj_admin_menu_outlaw_player", -1),
      (try_end),
      ...
      (try_begin),
        (player_slot_eq, ":my_player_id", slot_player_admin_no_permanent_ban, 0),
        (create_button_overlay, reg0, "str_karma_player", 0),
        (assign, "$g_presentation_obj_admin_menu_karma_player", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (val_add, ":cur_y", escape_menu_item_height),
      (else_try),
        (assign, "$g_presentation_obj_admin_menu_karma_player", -1),
      (try_end),
      
      (try_begin),
        (player_slot_eq, ":my_player_id", slot_player_admin_no_permanent_ban, 0),
        (create_button_overlay, reg0, "str_warn_player", 0),
        (assign, "$g_presentation_obj_admin_menu_warn_player", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (val_add, ":cur_y", escape_menu_item_height),
      (else_try),
        (assign, "$g_presentation_obj_admin_menu_warn_player", -1),
      (try_end),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      (try_begin),
        ...
        (assign, "$g_list_players_action_string_id", "str_kick"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_menu_warn_player"),
        (assign, ":action", admin_action_warn_player),
        (assign, "$g_list_players_action_string_id", "str_warn"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_menu_karma_player"),
        (assign, ":action", admin_action_karma_player),
        (assign, "$g_list_players_action_string_id", "str_karma"),
      (else_try),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_menu_outlaw_player"),
        (assign, ":action", admin_action_outlaw_player),
  ...
  ("faction_admin_menu", prsntf_manual_end_only, 0,
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        (neq, "$g_game_type", "mt_no_money"),
        (assign, reg0, faction_cost_assign_steward),
      (try_end),
      (str_store_string, s0, "str_assign_steward"),
      (create_button_overlay, "$g_presentation_obj_faction_admin_set_steward", "str_s0__reg0_", tf_center_justify),
      (overlay_set_color, "$g_presentation_obj_faction_admin_set_steward", 0xFFFFFF),
      (overlay_set_size, "$g_presentation_obj_faction_admin_set_steward", pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, "$g_presentation_obj_faction_admin_set_steward", pos1),
      (val_add, ":cur_y", escape_menu_item_height),
      
      (try_begin),
        (neq, "$g_game_type", "mt_no_money"),
        (assign, reg0, faction_cost_assign_marshal),
      (try_end),
      (str_store_string, s0, "str_assign_marshal"),
      (create_button_overlay, "$g_presentation_obj_faction_admin_set_marshal", "str_s0__reg0_", tf_center_justify),
      (overlay_set_color, "$g_presentation_obj_faction_admin_set_marshal", 0xFFFFFF),
      (overlay_set_size, "$g_presentation_obj_faction_admin_set_marshal", pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, "$g_presentation_obj_faction_admin_set_marshal", pos1),
      (val_add, ":cur_y", escape_menu_item_height),
      ...
      (player_get_slot, ":whitelist_banner", ":player_id", slot_player_banner_id),
      (try_begin),
        (eq,":whitelist_banner",0),
        (try_begin),
          (neq, "$g_game_type", "mt_no_money"),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        (assign, ":found", 1),
        (try_begin),
          (eq, ":object", "$g_presentation_obj_faction_admin_set_marshal"),
          (assign, "$g_list_players_event_value", faction_admin_action_set_marshal),
          (assign, "$g_list_players_action_string_id", "str_become_marshal"),
        (else_try),
          (eq, ":object", "$g_presentation_obj_faction_admin_set_steward"),
          (assign, "$g_list_players_event_value", faction_admin_action_set_steward),
          (assign, "$g_list_players_action_string_id", "str_become_steward"),
        (else_try),
      ...
      (try_begin),
        ...
        (else_try),
          ...
          (try_begin), # check for valid castles to spawn at, displaying the next if that control is pressed
            ...
            (assign,":faction_start",castle_factions_begin),
            (is_between, ":faction_id", ":faction_start", factions_end),
     ...
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_for_range, ":faction_id", factions_begin, factions_end), # create symbol buttons for all active factions in the scene
        ...
        (else_try),
          (eq, ":faction_id", "fac_1"),
          (faction_get_slot, ":banner_mesh", ":faction_id", slot_faction_banner_mesh),
          (create_image_button_overlay_with_tableau_material, ":button_overlay_id", "mesh_pw_stats_chart_banner", "tableau_stats_chart_banner", ":banner_mesh"),
        (else_try),
      ...
      (try_for_range_backwards, ":player_index", 0, ":player_count"),
        ...
        #(create_text_overlay, reg1, "str_reg0", 0),
        #temp
     ...
     [(store_trigger_param_1, ":current_time"),
      ...
      (else_try),
        ...
        (try_for_agents, ":agent_id"),
          ...
          (agent_get_item_slot, ":body_item_id", ":agent_id", ek_head),
          ...
          (try_begin),
            (try_begin),
              ...
              (player_get_slot, ":my_player_faction_id", ":my_player", slot_player_faction_id),
              (player_get_slot, ":player_faction_id", ":player_id", slot_player_faction_id),
              (assign,":CustomTitleSize",100),
              (assign, ":color", 0xFFFFFF),#Non hostiles white
              (try_begin),
                (call_script, "script_cf_factions_are_hostile", ":my_player_faction_id", ":player_faction_id"),
                (try_begin),
                  (gt,":my_player_faction_id",castle_factions_begin), # Ignore Commoners/Outlaws/Townwatch
                  (gt,":player_faction_id",castle_factions_begin), # Ensure we are both in a faction
                  (assign, ":color", 0xCC0000),#Hostiles red
                (else_try),
                  (eq,":my_player_faction_id",warlords_begin),#Ensure we dont show other bandit members see the red names
                  (neq,":player_faction_id",warlords_begin),
                  (assign, ":color", 0xCC0000),#Hostiles red
                (else_try),
                  (eq,":player_faction_id",warlords_begin),#Bandits are hostile with everyone
                  (assign, ":color", 0xCC0000),#Hostiles red
                (try_end),
              (try_end),
              (try_begin),
                ...
                (store_skill_level, ":wage", "skl_wage", ":troop"),
                (try_begin),# lords/leaders
                  (player_slot_eq, ":player_id", slot_player_is_lord, 1),
                  (store_skill_level, ":leadership", "skl_leadership", ":troop"),
                  (neq, ":leadership", 0),
                  (str_store_string, s2, "str_s2_s3_s4_title"),
                (else_try), # Anyone higher than 2 wage have title in their name
                  (ge,":wage",2),
                  (str_store_string, s2, "str_s2_s3_s4_title"),
                (else_try), # Specific troop types needing the titles
                  (this_or_next|eq,":troop","trp_merchant"),
                  (this_or_next|eq,":troop","trp_engineer"),
                  (this_or_next|eq,":troop","trp_blacksmith"),
                  (eq,":troop","trp_armoursmith"),
                  (try_begin),
                    (eq,":player_faction_id","fac_commoners"),
                      (str_store_string, s2, "str_s2_s4"),
                   (else_try),
                      (str_store_string, s2, "str_s2_s3_s4_title"),
                  (try_end),
                (else_try),#mercenarys
                  (is_between,":troop",mercenarys_begin,mercenarys_end),
                  (try_begin),
                    (eq,":player_faction_id","fac_commoners"),
                      (str_store_string, s2, "str_s2_s4"),
                   (else_try),
                      (str_store_string, s2, "str_s2_s3_merc"),
                  (try_end),
                (else_try),#rebels
                  (is_between,":troop", "trp_rebel"),
                  (try_begin),
                    (eq,":player_faction_id","fac_commoners"),
                      (str_store_string, s2, "str_s2_s4"),
                   (else_try),
                      (str_store_string, s2, "str_s2_s3_rebel"),
                  (try_end),
                (else_try),#Event Characters
                  (eq,":troop","trp_event_hero"),
                      (str_store_string, s2, "str_s2_event_character"),
                (else_try),#special troop name
                  (troop_slot_eq,":troop",slot_troop_special_name,1),
                    (str_store_string, s2, "str_s2_s4"),
                (else_try),
                  (try_begin),
                    (eq,":player_faction_id","fac_commoners"),
            ...
            (else_try),
              ...
              (assign,":CustomTitleSize",100),
            (try_end),
            (try_begin),# Name colors
              (eq,":troop","trp_godlike_hero"),
              (assign, ":color", admin_name_color),
            (else_try),
              (eq,":troop","trp_event_hero"),
              (assign, ":color", event_character_name_color),
            (else_try),
              (eq,":troop","trp_guide"),
              (assign, ":color", guide_name_color),
            (try_end),
            (overlay_set_text, ":overlay_id", s2),
            (overlay_set_color, ":overlay_id", ":color"),
            (overlay_set_position, ":overlay_id", pos4),
            (copy_position, pos5, pos3),
            (position_move_z, pos5, ":CustomTitleSize"), # move the 3D position up by 200 and check the 2D distance moved, to get the appropriate text size (reducing with distance)
  ...
  ("faction_banner_selection", prsntf_manual_end_only, 0, # display faction banners 16 at a time, redrawing the presentation for page changes
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (val_min, ":page_banners_end", banner_custom_meshes_end),
      ...
      (store_sub, "$g_presentation_faction_banner_page_count", banner_custom_meshes_end, banner_meshes_begin),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        ...
        (try_begin),
          (is_between, ":selected_banner", banner_meshes_begin, banner_custom_meshes_end),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        ...
        #Banks - Money Chest
        (try_begin),
          (neq, ":chest_count", -1), # no money chest found so look for bank chests
          (assign, ":fail_message", 0),
          (scene_prop_get_num_instances, ":bank_count", "spr_fw_bank_money_chest"),
          (try_for_range, ":bank_no", 0, ":bank_count"),
            (scene_prop_get_instance, ":instance_id", "spr_fw_bank_money_chest", ":bank_no"),
            (try_begin),
              (call_script, "script_cf_use_bank_money_chest", ":my_player_id", ":instance_id", ":chest_transfer_gold"),
              (assign, ":bank_count", -1),
            (else_try),
              (this_or_next|eq, ":fail_message", 0),
              (neq, reg0, "str_no_money_chest_nearby"),
     ...
     [(store_trigger_param_1, ":overlay_id"),
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (try_begin), # allow admins in special armor to attach carts from long distances, to retrieve them from inaccessible locations
            (player_is_admin, ":my_player_id"),
            (agent_get_item_slot, ":body_item_id", ":my_agent_id", ek_head),
            (this_or_next|eq, ":body_item_id", "itm_invisible_head"),
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (agent_is_active, ":my_agent_id"),
          (agent_is_alive, ":my_agent_id"),
          (multiplayer_send_message_to_server, client_event_reveal_money_pouch),
        (try_end),
      (else_try),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":overlay_id"),
      ...
      (try_begin), # main menu: show a sub menu
        ...
        (try_begin),
          (eq,":menu_item",6),##Handle Surrender Select
          (multiplayer_get_my_player, ":my_player_id"),
          (player_is_active, ":my_player_id"),
          ...
          (try_begin),
            (eq,":anim","anim_surrender"),
              (multiplayer_send_3_int_to_server, client_event_agent_animate, "anim_surrender_finish",1),
          (else_try),
            (multiplayer_send_3_int_to_server, client_event_agent_animate, "anim_surrender",1),
          (try_end),
          (clear_omitted_keys),
          (presentation_set_duration, 0),
          (assign, "$g_animation_menu_selected", 0),
