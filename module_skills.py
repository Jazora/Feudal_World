...
skills = [
  ("trade","Trade",sf_base_att_cha|sf_effects_party,10,"This skill gives you better trade rates for importing/exporting goods."),
  ...
  ("musician","Musician",sf_base_att_cha,10,"This skill allows you to play musical instruments."),
  ("alchemy","Alchemy",sf_base_att_int,10,"This skill determines your effectiveness with alchemy."),
  ("wage","Wage",sf_base_att_int,10,"This determines how much wage you receieve."),
  ("siege","Siege",sf_base_att_int,10,"This determines the siege equipment you can use."),
