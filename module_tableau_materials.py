...
tableaus = [
  ...
  ("heraldic_coarse_tunic_a", 0, "coarse_tunic_a", 512, 512, 0, 0, 0, 0, tableau_armor_color("mesh_tableau_mesh_heraldic_coarse_tunic_a")),
  ("heraldic_peasant_dress_b", 0, "peasant_dress_b", 512, 512, 0, 0, 0, 0, tableau_armor_color("mesh_tableau_mesh_heraldic_peasant_dress_b")),
  ("heraldic_blue_dress", 0, "blue_dress", 512, 512, 0, 0, 0, 0, tableau_armor_color("mesh_tableau_mesh_heraldic_blue_dress")),
  ("heraldic_red_gambeson_a", 0, "red_gambeson_a", 512, 512, 0, 0, 0, 0, tableau_armor_color("mesh_tableau_mesh_heraldic_red_gambeson_a")),
  ("heraldic_rich_tunic_a", 0, "rich_tunic_a", 1024, 1024, 0, 0, 0, 0, tableau_armor_banner("mesh_tableau_mesh_heraldic_rich_tunic_a", banner_xyz=(46,67,10), banner_scale=13)),
  ("heraldic_full_plate", 0, "full_plate", 1024, 1024, 0, 0, 0, 0, tableau_armor_banner("mesh_tableau_mesh_heraldic_full_plate", banner_xyz=(34,117,80), banner_scale=70)),
