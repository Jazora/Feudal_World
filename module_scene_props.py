...
def spr_export_item_triggers(item_id, use_string="str_export", price_multiplier=base_export_percentage):
...
def spr_import_item_triggers(item_id, pos_offset=(5,0,2), rotate=(0,0,0), use_string="str_import", price_multiplier=base_import_percentage, check_script=None):
  buy_trigger = (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      (prop_instance_get_position, pos1, ":instance_id")])
  spr_apply_pos_offset(buy_trigger[1], pos_offset, rotate)
  buy_trigger[1].append((call_script, "script_cf_import_item", ":agent_id", ":instance_id"))
...
def spr_hit_field_triggers(height=200, full_hp=1000, resource_hp=200, tool_class=-1, regrow_interval=600, use_string="str_harvest"):
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
    ...
    (ti_on_scene_prop_hit,
     [(store_trigger_param_1, ":instance_id"),
      (store_trigger_param_2, ":hit_damage"),
      (call_script, "script_cf_hit_field", ":instance_id", ":hit_damage", resource_hp, tool_class, regrow_interval),
      ]),
    (ti_on_scene_prop_destroy, []),
    (ti_on_scene_prop_use, []),
    [init_scene_prop, "script_cf_setup_field"]]
...
def spr_capture_castle_triggers():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_capture_castle"),
      ]),
    spr_call_script_use_trigger("script_cf_use_capture_point")]
  
def spr_subjugate_castle_triggers():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_subjugate_castle"),
      ]),
    spr_call_script_use_trigger("script_cf_use_subjugate_point")]
  ...
  return [(ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      ...
      (try_begin),
        ...
        (assign,":new_item","itm_water_bucket"),
      (else_try),
        (eq, ":wielded_item_id", "itm_water_bucket"),
        (assign,":new_item","itm_water_bucket_throw"),
      (try_end),
      (gt,":new_item",-1),
      (call_script, "script_cf_agent_consume_item", ":agent_id", ":wielded_item_id", 1),
      (agent_equip_item, ":agent_id", ":new_item"),
      (agent_set_wielded_item, ":agent_id", ":new_item"),
      ])]
...
# A chop block for cutting wood
def spr_chop_block_triggers():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_chop_block"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_id, 0),
      ]),
    (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      (call_script, "script_cf_process_chop_block", ":agent_id", ":instance_id", 1),
      ]),
    (ti_on_scene_prop_hit, [
      (store_trigger_param_1, ":instance_id"),
      (set_fixed_point_multiplier, 1),
      (position_get_x, ":agent_id", pos2),
      (call_script, "script_cf_process_hit_chop_block", ":agent_id", ":instance_id"),
      ]),
    ]    
...
def spr_mannequin():
  return [(ti_on_scene_prop_init,
      [#(store_trigger_param_1, ":instance_id"),
      #(prop_instance_get_variation_id, ":faction_id", ":instance_id"), # So this is the faction that owns it
      #(prop_instance_get_variation_id_2, ":mannequin_type", ":instance_id"), # This is type it can be heavy/medium/light
     # (scene_prop_set_slot, ":instance_id", slot_scene_prop_capture_faction_id, ":faction_id"),
     ]),
    ]

# Mannequin parts setup
def spr_mannequin_parts():
  return [(ti_on_scene_prop_init,
      [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_id, -1),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_stock_count_update_time, -1),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_stock_count, 0),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_average_craft_skill, 0),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_resources_default_cost, 0),
     ]),
    (ti_on_scene_prop_use,
      [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (str_store_string, s1, "str_http_server"),
          (neg|str_is_empty, s1),
          (str_store_string, s2, "str_http_server_password"),
          (neg|str_is_empty, s2),
          ...
          (assign,reg4,":item_id"),
          (str_store_string, s0, "str_http_mannequin_craft"),
...
# An anvil For crafting various pieces of metalwork
def spr_anvil_triggers():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_process_hammer_metal"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_id, 0),
      ]),
    (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      (call_script, "script_cf_process_anvil", ":agent_id", ":instance_id", 1),
      ]),
    (ti_on_scene_prop_hit, [
      (store_trigger_param_1, ":instance_id"),
      (set_fixed_point_multiplier, 1),
      (position_get_x, ":agent_id", pos2),
      (call_script, "script_cf_process_hit_anvil", ":agent_id", ":instance_id"),
      ]),
    ]
    
# Forging Iron and Coal into Steel
def spr_forge_triggers():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_forge_metal"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_1, -1),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_2, -1),
      ]),
    (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      (call_script, "script_cf_process_forge", ":agent_id", ":instance_id"),
      ]),
    ]

# Heating up the forge
def spr_bellows_triggers():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_bellows_use"),
    ...
    (ti_on_scene_prop_use,
     [
      (store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      (call_script, "script_cf_process_bellows", ":instance_id", ":agent_id"),
      (prop_instance_play_sound, ":instance_id", "snd_bellows2"),
      ]),
    (ti_on_scene_prop_start_use,
     [
      (store_trigger_param_2, ":instance_id"),
        (prop_instance_stop_sound, ":instance_id"),
        (prop_instance_play_sound, ":instance_id", "snd_bellows1"),
      ]),
    ]

# Unheat metal
def spr_unheat_metal_triggers():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_unheat_metal"),
      ]),
    (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      (call_script, "script_cf_process_unheat_metal", ":agent_id", ":instance_id", 1),
      ]),
    ]
    
# Grinding unheated metal to shapes
def spr_grindstone_triggers():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_grind_metal"),
      ]),
    (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      (call_script, "script_cf_process_grindstone", ":agent_id", ":instance_id", 1),
      ]),
    ]
    
# bending wood into shapes
def spr_bow_tiller_triggers():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_bend_wood"),
      ]),
    (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      (call_script, "script_cf_process_bow_tiller", ":agent_id", ":instance_id", 1),
      ]),
    ]

#Combining weapon parts to make a weapon
def spr_weapon_stand():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_weapon_stand"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_1, 0),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_2, 0),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_3, 0),
      ]),
    (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      ...
      (try_begin),
        (gt,":item",-1),
        (call_script, "script_cf_process_weapon_stand_item", ":agent_id", ":instance_id"),
      (else_try),
        (call_script, "script_cf_process_weapon_stand", ":agent_id", ":instance_id"),
      (try_end),
      ]),
    ]
...
def spr_bank_chest():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_bank_gold_reg2"),
...
#Inventory Chest
def spr_bank_inventory(max_item_length=1000, use_string="str_bank_inventory"):
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_count, 0),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_max_length, max_item_length),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, use_string),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_is_bank, 1),
      ]),
     (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      (call_script, "script_cf_use_bank_inventory", ":agent_id", ":instance_id"),
      #(agent_get_player_id,":player_id",":agent_id"),
     # (player_is_active,":player_id"),
      #(try_begin),
        #(player_slot_eq, ":player_id", slot_player_stored_inventory, 0),#Ensure no horse is already stabled
       # (call_script, "script_cf_player_update_inventory_url", ":agent_id", ":instance_id"),
      #(else_try),
        #(call_script, "script_cf_player_get_inventory_url", ":agent_id", ":instance_id"),
      #(try_end),
     ]),
    ]
...
def spr_bank_stable():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_bank_stable"),
      ]),
     (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      (agent_get_player_id,":player_id",":agent_id"),
      (try_begin),
        (player_slot_eq, ":player_id", slot_player_stable, 0),#Ensure no horse is already stabled
        (call_script, "script_cf_bank_horse", ":agent_id",":instance_id"),
      (else_try),
        (call_script, "script_cf_bank_retrieve_horse", ":agent_id",":instance_id"),
      (try_end),
     ]),
    ]
...
def spr_market_flags(use_time=1):
  return sokf_missiles_not_attached|spr_use_time(max(use_time, 1))

def spr_market_buy_property():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (prop_instance_get_variation_id, ":price", ":instance_id"),
      (val_mul,":price",50),#x50 for actual price
      (assign,reg3,":price"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_gold_value, ":price"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_buy_market_property_s1"),
      #(prop_instance_get_variation_id_2, ":owning_prop", ":instance_id"),# Set linked props together
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_shop_uid, -1), # Set the shops uid
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_shop_pid, -1),
      ]),
    (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      (call_script, "script_cf_buy_market_stall", ":agent_id", ":instance_id"),
      ]),
    ]

def spr_market_shop_triggers(inventory_count=6, max_item_length=100, use_string="str_access_shop", probability=100):
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_count, spr_check_inventory_count(inventory_count)),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_max_length, max_item_length),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, use_string),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_is_shop, 1),
      #(prop_instance_get_variation_id_2, ":owning_prop", ":instance_id"),# Set linked props together
      ]),
    (ti_on_scene_prop_destroy, []),
    spr_call_script_cancel_use_trigger("script_cf_pick_chest_lock", 0),
...
def spr_market_door_triggers(hit_points=1000, resource_class=item_class_wood, left=0):
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (assign, ":hit_points", spr_check_hit_points(hit_points)),
      (prop_instance_get_variation_id, ":is_weak", ":instance_id"),
      (val_and, ":is_weak", 0x8),
      (try_begin),
        (eq, ":is_weak", 0x8),
        (val_div, ":hit_points", 2),
    ...
    (ti_on_scene_prop_destroy, []),
    spr_call_script_use_trigger("script_cf_use_market_door", left),
    [init_scene_prop, "script_cf_init_market_door", left]]
    
def spr_market_door_no_hit_triggers(left=0):
  return [spr_call_script_use_trigger("script_cf_use_market_door", left),
    [init_scene_prop, "script_cf_init_market_door", left]]
...
def spr_alchemy_extract():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_alchemy_extract"),
      ]),
    (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      ...
      (call_script, "script_cf_alchemy_extract", ":agent_id", ":instance_id"),
      ]),
    ]

def spr_alchemy_mixing_bowl():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_alchemy_mixing_bowl"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_1, 0),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_2, 0),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_3, 0),
      ]),
    (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      ...
      (try_begin),
        (gt,":item",-1),
        (call_script, "script_cf_alchemy_mixing_bowl_item", ":agent_id", ":instance_id"),
      (else_try),
        (call_script, "script_cf_alchemy_mixing_bowl", ":agent_id", ":instance_id"),
      (try_end),
      ]),
    ]
...
def spr_culture_triggers(culture=culture_swadian):
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_change_culture"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_1, culture),
      ]),
    (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (agent_is_active,":agent_id"),
      (agent_is_alive,":agent_id"),
      (call_script, "script_cf_player_update_culture_url", ":agent_id", culture),
      ]),
    ]
...
def spr_sleep_triggers():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_use_string, "str_sleep"),
      ]),
    (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (call_script, "script_cf_do_custom_anims", ":agent_id", "anim_sleep",0),
...
def spr_setup_graves():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (call_script, "script_cf_setup_graves", ":instance_id"),
      ]),
    ]
...
def spr_dig_graves():
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_hit_points, ":instance_id", 10),
      ]),
    (ti_on_scene_prop_hit,
     [(set_fixed_point_multiplier, 1),
      (position_get_x,":agent_id",pos2),
      (store_trigger_param_1, ":instance_id"),
      (call_script, "script_cf_digging", ":agent_id", ":instance_id", pos1),
      ]),
    ]
...
def spr_pull_legendary_sword(item="itm_legendary_mourn_sword"):
  return [(ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":instance_id"),
      (agent_is_active,":agent_id"),
      (agent_is_alive,":agent_id"),
      (agent_get_wielded_item, ":sword_item_id", ":agent_id", 0),
      (neg|gt,":sword_item_id",0),
      (agent_get_wielded_item, ":shield_item_id", ":agent_id", 0),
      (neg|gt,":shield_item_id",0),

      (agent_get_player_id,reg2,":agent_id"),
      
      (str_store_string, s1, "str_http_server"),
      (neg|str_is_empty, s1),
    
      (assign, reg3, ":instance_id"),
      
      (prop_instance_get_scene_prop_kind, reg4, ":instance_id"),
    
      (assign, reg5, item),
    
      (assign, reg6, 0),#chancelow
      (assign, reg7, 1000),#chancehigh
    
      (str_store_string, s0, "str_http_legendary_chance"),
...
## Pull the legendary sword - end

##Siege Equipment

def spr_deploy_siege_ladder(hit_points=50,item=0):
  return [(ti_on_scene_prop_init,
     [(store_trigger_param_1, ":instance_id"),
      (scene_prop_set_hit_points, ":instance_id", 100000),
      (scene_prop_get_hit_points, ":hp", ":instance_id"),
      (val_sub,":hp",hit_points),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_next_resource_hp, ":hp"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_id, item),
      ]),
      (ti_on_scene_prop_hit,
      [(set_fixed_point_multiplier, 1),
      (position_get_x,":agent_id",pos2),
      (store_trigger_param_1, ":instance_id"),
      (call_script, "script_cf_hit_ladder", ":agent_id", ":instance_id", pos1),
      ]),
      (ti_on_scene_prop_destroy, []),
    ]
...
def spr_fire_item():
  return [(ti_on_scene_prop_init,
    ...
    (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (call_script, "script_cf_fire_items", ":agent_id"),
      ]),
    ]

##Fire props to make fire items - End
...
scene_props = [
  ...
  ("pw_stockpile_cooked_meat",spr_use_time(1),"pw_meat_cooked","bo_pw_weapon", spr_stockpile_resource_triggers("itm_cooked_meat")),
  ("pw_stockpile_wheat_sheaf",spr_use_time(1),"pw_wheat_sheaf","bo_pw_weapon", spr_stockpile_resource_triggers("itm_wheat_sheaf")),
  ("pw_stockpile_flax",spr_use_time(1),"raw_flax","bo_pw_weapon", spr_stockpile_resource_triggers("itm_flax_bundle")),
  ("pw_stockpile_carrot",spr_use_time(1),"pw_carrot","bo_pw_weapon", spr_stockpile_resource_triggers("itm_carrot")),
  ("pw_stockpile_cabbage",spr_use_time(1),"cabbage","bo_pw_weapon", spr_stockpile_resource_triggers("itm_cabbage")),
  ("pw_stockpile_apple_a",spr_use_time(1),"apple_a","bo_pw_weapon", spr_stockpile_resource_triggers("itm_apple_a")),
  ("pw_stockpile_apple_b",spr_use_time(1),"apple_b","bo_pw_weapon", spr_stockpile_resource_triggers("itm_apple_b")),
  ...
  ("pw_import_wheat_sack",spr_use_time(10),"pw_wheat_sack","bo_pw_weapon_small", spr_import_item_triggers("itm_wheat_sack", price_multiplier=base_import_percentage)),
  ("pw_import_carrot_sack",spr_use_time(10),"pw_wheat_sack","bo_pw_weapon_small", spr_import_item_triggers("itm_carrot_sack", price_multiplier=base_import_percentage)),
  ("pw_import_cabbage_sack",spr_use_time(10),"pw_wheat_sack","bo_pw_weapon_small", spr_import_item_triggers("itm_cabbage_sack", price_multiplier=base_import_percentage)),
  ("pw_import_fawn",spr_use_time(20),"sack","bo_sack_fixed", spr_import_item_triggers("itm_fawn", pos_offset=(0,50,50), price_multiplier=base_import_percentage, check_script="script_cf_can_spawn_herd_animal")),
  ("pw_import_boarlet",spr_use_time(10),"sack","bo_sack_fixed", spr_import_item_triggers("itm_boarlet", pos_offset=(0,50,50), price_multiplier=base_import_percentage, check_script="script_cf_can_spawn_herd_animal")),
  ("pw_import_calf",spr_use_time(25),"sack","bo_sack_fixed", spr_import_item_triggers("itm_calf", pos_offset=(0,50,50), price_multiplier=base_import_percentage, check_script="script_cf_can_spawn_herd_animal")),
  ("pw_import_wood_stick",spr_use_time(2),"pw_wood_box","bo_pw_wood_box", spr_import_item_triggers("itm_stick", price_multiplier=base_import_percentage)),
  ("pw_import_wood_branch",spr_use_time(5),"wood_heap_b","bo_wood_heap_b", spr_import_item_triggers("itm_branch", price_multiplier=base_import_percentage)),
  ("pw_import_wood_pole",spr_use_time(6),"pw_wood_pole","bo_pw_weapon_big", spr_import_item_triggers("itm_wood_pole", price_multiplier=base_import_percentage)),
  ("pw_import_wood_block",spr_use_time(5),"pw_wood_heap_a","bo_wood_heap_a", spr_import_item_triggers("itm_wood_block", price_multiplier=base_import_percentage)),
  ("pw_import_board",spr_use_time(6),"pw_board","bo_pw_weapon_small", spr_import_item_triggers("itm_board", price_multiplier=base_import_percentage)),
  ("pw_import_iron_ore_small",spr_use_time(10),"pw_iron_ore_small","bo_pw_weapon_small", spr_import_item_triggers("itm_iron_ore_small", price_multiplier=base_import_percentage)),
  ("pw_import_iron_ore",spr_use_time(14),"pw_iron_ore","bo_pw_weapon_small", spr_import_item_triggers("itm_iron_ore", price_multiplier=base_import_percentage)),
  ("pw_import_iron_bar_short",spr_use_time(10),"pw_iron_bar_short","bo_pw_weapon_small", spr_import_item_triggers("itm_iron_bar_short", price_multiplier=base_import_percentage)),
  ("pw_import_iron_bar",spr_use_time(13),"pw_iron_bar","bo_pw_weapon_small", spr_import_item_triggers("itm_iron_bar", price_multiplier=base_import_percentage)),
  ("pw_import_iron_bar_long",spr_use_time(16),"pw_iron_bar_long","bo_pw_weapon_small", spr_import_item_triggers("itm_iron_bar_long", price_multiplier=base_import_percentage)),
  ("pw_import_gold_nugget",spr_use_time(7),"pw_gold_nugget","bo_pw_weapon_small", spr_import_item_triggers("itm_gold_nugget", price_multiplier=base_import_percentage)),
  ("pw_import_gold_bar",spr_use_time(15),"pw_gold_bar","bo_pw_weapon_small", spr_import_item_triggers("itm_gold_bar", price_multiplier=base_import_percentage)),
  ("pw_import_silver_nugget",spr_use_time(7),"pw_silver_nugget","bo_pw_weapon_small", spr_import_item_triggers("itm_silver_nugget", price_multiplier=base_import_percentage)),
  ("pw_import_silver_bar",spr_use_time(15),"pw_silver_bar","bo_pw_weapon_small", spr_import_item_triggers("itm_silver_bar", price_multiplier=base_import_percentage)),
  ("pw_import_salt_sack",spr_use_time(8),"pw_salt_sack","bo_pw_weapon_small", spr_import_item_triggers("itm_salt_sack", price_multiplier=base_import_percentage)),
  ("pw_import_salted_fish",spr_use_time(5),"pw_fish","bo_pw_weapon_small", spr_import_item_triggers("itm_salted_fish", price_multiplier=base_import_percentage)),
  ("pw_import_salted_meat",spr_use_time(7),"pw_meat_salted","bo_pw_weapon_small", spr_import_item_triggers("itm_salted_meat", price_multiplier=base_import_percentage)),
  ("pw_import_beer_cask",spr_use_time(8),"pw_beer_cask_carry","bo_pw_beer_wine_barrel", spr_import_item_triggers("itm_beer_cask", price_multiplier=base_import_percentage)),
  ("pw_import_wine_barrel",spr_use_time(9),"pw_wine_barrel_carry","bo_pw_beer_wine_barrel", spr_import_item_triggers("itm_wine_barrel", price_multiplier=base_import_percentage)),
  ("pw_import_linen_cloth",spr_use_time(8),"pw_linen_cloth","bo_pw_weapon_small", spr_import_item_triggers("itm_linen_cloth", price_multiplier=base_import_percentage)),
  ("pw_import_leather_roll",spr_use_time(8),"pw_leather_roll","bo_pw_weapon_small", spr_import_item_triggers("itm_leather_roll", price_multiplier=base_import_percentage)),
  ("pw_import_flax",spr_use_time(13),"raw_flax","bo_pw_weapon_small", spr_import_item_triggers("itm_flax_bundle", price_multiplier=base_import_percentage)),
  ("pw_import_pitch",spr_use_time(13),"bucket_pitch","bo_pw_bucket", spr_import_item_triggers("itm_pitch_bucket", price_multiplier=base_import_percentage)),
  ...
  ("pw_buy_straw_hat",spr_buy_item_flags(1),"straw_hat_new","bo_pw_armor_head", spr_buy_item_triggers("itm_straw_hat", resources=[], tailoring=1)),
  ("pw_buy_head_wrappings",spr_buy_item_flags(1),"head_wrapping","bo_pw_armor_head", spr_buy_item_triggers("itm_head_wrappings", resources=[], tailoring=1)),
  ("pw_buy_headcloth",spr_buy_item_flags(2),"headcloth_a_new","bo_pw_armor_head", spr_buy_item_triggers("itm_headcloth", resources=[], tailoring=1, tableau="tableau_colored_helmets_new_d")),
  ("pw_buy_woolen_cap",spr_buy_item_flags(2),"woolen_cap_new","bo_pw_armor_head", spr_buy_item_triggers("itm_woolen_cap", resources=[], tailoring=1, tableau="tableau_colored_helmets_new_e")),
  ("pw_buy_sarranid_felt_hat",spr_buy_item_flags(2),"sar_helmet3","bo_pw_armor_head", spr_buy_item_triggers("itm_sarranid_felt_hat", resources=[], tailoring=1)),
  ("pw_buy_sarranid_felt_head_cloth",spr_buy_item_flags(1),"common_tulbent","bo_pw_armor_head_armature", spr_buy_item_triggers("itm_sarranid_felt_head_cloth", resources=[], tailoring=1)),
  ("pw_buy_sarranid_felt_head_cloth_b",spr_buy_item_flags(1),"common_tulbent_b","bo_pw_armor_head_armature", spr_buy_item_triggers("itm_sarranid_felt_head_cloth_b", resources=[], tailoring=1)),
  ("pw_buy_bride_crown",spr_buy_item_flags(5),"bride_crown","bo_pw_armor_head_armature", spr_buy_item_triggers("itm_bride_crown", resources=[], tailoring=2)),
  ("pw_buy_khergit_lady_hat",spr_buy_item_flags(3),"khergit_lady_hat","bo_pw_armor_head", spr_buy_item_triggers("itm_khergit_lady_hat", resources=[], tailoring=2)),
  ("pw_buy_khergit_lady_hat_b",spr_buy_item_flags(3),"khergit_lady_hat_b","bo_pw_armor_head", spr_buy_item_triggers("itm_khergit_lady_hat_b", resources=[], tailoring=2)),
  ("pw_buy_sarranid_head_cloth",spr_buy_item_flags(2),"tulbent","bo_pw_armor_head_armature", spr_buy_item_triggers("itm_sarranid_head_cloth", resources=[], tailoring=1)),
  ("pw_buy_sarranid_head_cloth_b",spr_buy_item_flags(2),"tulbent_b","bo_pw_armor_head_armature", spr_buy_item_triggers("itm_sarranid_head_cloth_b", resources=[], tailoring=1)),
  ("pw_buy_wimple_a",spr_buy_item_flags(3),"wimple_a_new","bo_pw_armor_head", spr_buy_item_triggers("itm_wimple_a", resources=[], tailoring=2)),
  ("pw_buy_wimple_b",spr_buy_item_flags(3),"wimple_b_new","bo_pw_armor_head", spr_buy_item_triggers("itm_wimple_b", resources=[], tailoring=2)),
  ("pw_buy_barbette",spr_buy_item_flags(3),"barbette_new","bo_pw_armor_head", spr_buy_item_triggers("itm_barbette", resources=[], tailoring=2)),
  ...
  ("pw_buy_ladys_hood",spr_buy_item_flags(2),"ladys_hood_new","bo_pw_armor_head", spr_buy_item_triggers("itm_ladys_hood", resources=[], tailoring=2)),
  ...
  ("pw_buy_felt_hat",spr_buy_item_flags(2),"felt_hat_a_new","bo_pw_armor_head", spr_buy_item_triggers("itm_felt_hat", resources=[], tailoring=1, tableau="tableau_colored_helmets_new_b")),
  ("pw_buy_felt_hat_b",spr_buy_item_flags(2),"felt_hat_b_new","bo_pw_armor_head", spr_buy_item_triggers("itm_felt_hat_b", resources=[], tailoring=2, tableau="tableau_colored_helmets_new_b")),
  ...
  ("pw_buy_common_hood",spr_buy_item_flags(2),"hood_new","bo_pw_armor_head", spr_buy_item_triggers("itm_common_hood", resources=[], tailoring=1, tableau="tableau_colored_helmets_new_e")),
  ("pw_buy_hood_b",spr_buy_item_flags(2),"hood_b","bo_pw_armor_head", spr_buy_item_triggers("itm_hood_b", resources=[], tailoring=1)),
  ("pw_buy_hood_c",spr_buy_item_flags(2),"hood_c","bo_pw_armor_head", spr_buy_item_triggers("itm_hood_c", resources=[], tailoring=1)),
  ("pw_buy_hood_d",spr_buy_item_flags(2),"hood_d","bo_pw_armor_head", spr_buy_item_triggers("itm_hood_d", resources=[], tailoring=1)),
  ("pw_buy_hood_brown",spr_buy_item_flags(2),"hood_brown","bo_pw_armor_head", spr_buy_item_triggers("itm_brown_hood", resources=[], tailoring=1)),
  ("pw_buy_hood_black",spr_buy_item_flags(2),"hood_black","bo_pw_armor_head", spr_buy_item_triggers("itm_black_hood", resources=[], tailoring=1)),
  ("pw_buy_hood_red",spr_buy_item_flags(2),"hood_red","bo_pw_armor_head", spr_buy_item_triggers("itm_red_hood", resources=[], tailoring=1)),
  ("pw_buy_hood_executioner",spr_buy_item_flags(2),"executioner_hood","bo_pw_armor_head", spr_buy_item_triggers("itm_execution_hood", resources=[], tailoring=1)),
  ("pw_buy_nomad_cap",spr_buy_item_flags(5),"nomad_cap_a_new","bo_pw_armor_head", spr_buy_item_triggers("itm_nomad_cap", resources=["itm_iron_piece","itm_leather_piece"], tailoring=3)),
  ...
  ("pw_buy_pilgrim_hood",spr_buy_item_flags(2),"pilgrim_hood","bo_pw_armor_head", spr_buy_item_triggers("itm_pilgrim_hood", resources=[], tailoring=1)),
  ...
  ("pw_buy_leather_steppe_cap_b",spr_buy_item_flags(5),"tattered_steppe_cap_b_new","bo_pw_armor_head", spr_buy_item_triggers("itm_leather_steppe_cap_b", resources=["itm_leather_piece","itm_iron_piece"], tailoring=2)),
  ("pw_buy_nordic_archer_helmet",spr_buy_item_flags(5),"Helmet_A_vs2","bo_pw_armor_head", spr_buy_item_triggers("itm_nordic_archer_helmet", resources=["itm_leather_piece","itm_iron_piece"], tailoring=2)),
  ("pw_buy_vaegir_fur_cap",spr_buy_item_flags(5),"vaeg_helmet3","bo_pw_armor_head", spr_buy_item_triggers("itm_vaegir_fur_cap", resources=["itm_leather_piece","itm_iron_piece"], tailoring=2)),
  ("pw_buy_steppe_cap",spr_buy_item_flags(5),"steppe_cap_a_new","bo_pw_armor_head", spr_buy_item_triggers("itm_steppe_cap", resources=["itm_leather_piece","itm_iron_piece"], tailoring=2)),
  ("pw_buy_leather_warrior_cap",spr_buy_item_flags(5),"skull_cap_new_b","bo_pw_armor_head", spr_buy_item_triggers("itm_leather_warrior_cap", resources=[("itm_leather_piece",2)], tailoring=2)),
  ("pw_buy_sarranid_warrior_cap",spr_buy_item_flags(5),"tuareg_helmet","bo_pw_armor_head", spr_buy_item_triggers("itm_sarranid_warrior_cap", resources=["itm_iron_piece","itm_linen_cloth_small"], tailoring=2)),
  ("pw_buy_nordic_veteran_archer_helmet",spr_buy_item_flags(6),"Helmet_A","bo_pw_armor_head", spr_buy_item_triggers("itm_nordic_veteran_archer_helmet", resources=["itm_iron_piece","itm_leather_piece"], tailoring=2)),
  ("pw_buy_skullcap",spr_buy_item_flags(6),"skull_cap_new_a","bo_pw_armor_head", spr_buy_item_triggers("itm_skullcap", resources=["itm_iron_piece","itm_leather_piece"], tailoring=2)),
  ("pw_buy_vaegir_fur_helmet",spr_buy_item_flags(6),"vaeg_helmet2","bo_pw_armor_head", spr_buy_item_triggers("itm_vaegir_fur_helmet", resources=["itm_iron_bar_short","itm_leather_piece"], tailoring=2)),
  ("pw_buy_bishop_mitre",spr_buy_item_flags(10),"pw_bishop_mitre","bo_pw_armor_head", spr_buy_item_triggers("itm_bishop_mitre", resources=["itm_linen_cloth_small"], tailoring=3)),
  ("pw_buy_mail_coif",spr_buy_item_flags(7),"mail_coif_new","bo_pw_armor_head", spr_buy_item_triggers("itm_mail_coif", resources=[("itm_iron_piece",2)], tailoring=3)),
  ("pw_buy_footman_helmet",spr_buy_item_flags(7),"skull_cap_new","bo_pw_armor_head", spr_buy_item_triggers("itm_footman_helmet", resources=["itm_iron_bar_short","itm_linen_cloth_small"], tailoring=2)),
  ("pw_buy_sarranid_horseman_helmet",spr_buy_item_flags(7),"sar_helmet2","bo_pw_armor_head", spr_buy_item_triggers("itm_sarranid_horseman_helmet", resources=["itm_iron_bar_short","itm_linen_cloth"], tailoring=3)),
  ("pw_buy_nasal_helmet",spr_buy_item_flags(7),"nasal_helmet_b","bo_pw_armor_head", spr_buy_item_triggers("itm_nasal_helmet", resources=["itm_iron_bar_short","itm_leather_piece"], tailoring=2)),
  ("pw_buy_norman_helmet",spr_buy_item_flags(7),"norman_helmet_a","bo_pw_armor_head", spr_buy_item_triggers("itm_norman_helmet", resources=["itm_iron_bar_short","itm_linen_cloth_small"], tailoring=2)),
  ("pw_buy_nordic_footman_helmet",spr_buy_item_flags(8),"Helmet_B_vs2","bo_pw_armor_head", spr_buy_item_triggers("itm_nordic_footman_helmet", resources=["itm_iron_bar_short","itm_leather_piece"], tailoring=3)),
  ("pw_buy_khergit_war_helmet",spr_buy_item_flags(8),"tattered_steppe_cap_a_new","bo_pw_armor_head", spr_buy_item_triggers("itm_khergit_war_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], tailoring=3)),
  ("pw_buy_segmented_helmet",spr_buy_item_flags(8),"segmented_helm_new","bo_pw_armor_head", spr_buy_item_triggers("itm_segmented_helmet", resources=["itm_iron_bar_short","itm_linen_cloth"], tailoring=3)),
  ("pw_buy_vaegir_spiked_helmet",spr_buy_item_flags(8),"vaeg_helmet1","bo_pw_armor_head", spr_buy_item_triggers("itm_vaegir_spiked_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], tailoring=4)),
  ("pw_buy_helmet_with_neckguard",spr_buy_item_flags(9),"neckguard_helm_new","bo_pw_armor_head", spr_buy_item_triggers("itm_helmet_with_neckguard", resources=["itm_iron_bar_short","itm_leather_piece"], tailoring=3)),
  ("pw_buy_flat_topped_helmet",spr_buy_item_flags(9),"flattop_helmet_new","bo_pw_armor_head", spr_buy_item_triggers("itm_flat_topped_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], tailoring=4)),
  ("pw_buy_nordic_fighter_helmet",spr_buy_item_flags(10),"Helmet_B","bo_pw_armor_head", spr_buy_item_triggers("itm_nordic_fighter_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], tailoring=4)),
  ("pw_buy_kettle_hat",spr_buy_item_flags(10),"kettle_hat_new","bo_pw_armor_head", spr_buy_item_triggers("itm_kettle_hat", resources=["itm_iron_bar_short","itm_iron_piece"], tailoring=4)),
  ("pw_buy_sarranid_helmet1",spr_buy_item_flags(10),"sar_helmet1","bo_pw_armor_head", spr_buy_item_triggers("itm_sarranid_helmet1", resources=["itm_iron_bar_short","itm_linen_cloth_small"], tailoring=4)),
  ("pw_buy_vaegir_lamellar_helmet",spr_buy_item_flags(10),"vaeg_helmet4","bo_pw_armor_head", spr_buy_item_triggers("itm_vaegir_lamellar_helmet", resources=["itm_iron_bar_short","itm_leather_piece"], tailoring=4)),
  ("pw_buy_spiked_helmet",spr_buy_item_flags(11),"spiked_helmet_new","bo_pw_armor_head", spr_buy_item_triggers("itm_spiked_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], tailoring=4)),
  ("pw_buy_sarranid_mail_coif",spr_buy_item_flags(11),"tuareg_helmet2","bo_pw_armor_head", spr_buy_item_triggers("itm_sarranid_mail_coif", resources=["itm_iron_bar_short","itm_iron_piece","itm_linen_cloth_small"], tailoring=4)),
  ("pw_buy_nordic_huscarl_helmet",spr_buy_item_flags(12),"Helmet_C_vs2","bo_pw_armor_head", spr_buy_item_triggers("itm_nordic_huscarl_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], tailoring=5)),
  ("pw_buy_bascinet",spr_buy_item_flags(13),"bascinet_avt_new","bo_pw_armor_head", spr_buy_item_triggers("itm_bascinet", resources=["itm_iron_bar_short","itm_leather_piece"], tailoring=5)),
  ("pw_buy_bascinet_2",spr_buy_item_flags(13),"bascinet_new_a","bo_pw_armor_head", spr_buy_item_triggers("itm_bascinet_2", resources=[("itm_iron_bar_short",2)], tailoring=5)),
  ("pw_buy_bascinet_3",spr_buy_item_flags(13),"bascinet_new_b","bo_pw_armor_head", spr_buy_item_triggers("itm_bascinet_3", resources=[("itm_iron_bar_short",2)], tailoring=5)),
  ("pw_buy_vaegir_noble_helmet",spr_buy_item_flags(14),"vaeg_helmet7","bo_pw_armor_head", spr_buy_item_triggers("itm_vaegir_noble_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], tailoring=5)),
  ("pw_buy_guard_helmet",spr_buy_item_flags(14),"reinf_helmet_new","bo_pw_armor_head", spr_buy_item_triggers("itm_guard_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], tailoring=5)),
  ("pw_buy_sarranid_veiled_helmet",spr_buy_item_flags(14),"sar_helmet4","bo_pw_armor_head", spr_buy_item_triggers("itm_sarranid_veiled_helmet", resources=[("itm_iron_bar_short",2)], tailoring=5)),
  ("pw_buy_vaegir_war_helmet",spr_buy_item_flags(14),"vaeg_helmet6","bo_pw_armor_head", spr_buy_item_triggers("itm_vaegir_war_helmet", resources=[("itm_iron_bar_short",2)], tailoring=5)),
  ("pw_buy_nordic_warlord_helmet",spr_buy_item_flags(15),"Helmet_C","bo_pw_armor_head", spr_buy_item_triggers("itm_nordic_warlord_helmet", resources=[("itm_iron_bar_short",2)], tailoring=5)),
  ("pw_buy_bishop_helm",spr_buy_item_flags(18),"pw_bishop_helm","bo_pw_armor_head", spr_buy_item_triggers("itm_bishop_helm", resources=[("itm_iron_bar_short",2),"itm_linen_cloth_small"], tailoring=6)),
  ("pw_buy_full_helm",spr_buy_item_flags(17),"great_helmet_new_b","bo_pw_armor_head", spr_buy_item_triggers("itm_full_helm", resources=[("itm_iron_bar_short",2),"itm_leather_piece"], tailoring=6)),
  ("pw_buy_vaegir_mask",spr_buy_item_flags(17),"vaeg_helmet8","bo_pw_armor_head", spr_buy_item_triggers("itm_vaegir_mask", resources=[("itm_iron_bar_short",2),"itm_iron_piece"], tailoring=6)),
  ("pw_buy_vaegir_mask_b",spr_buy_item_flags(18),"vaeg_helmet9","bo_pw_armor_head", spr_buy_item_triggers("itm_vaegir_mask_b", resources=[("itm_iron_bar_short",2),"itm_iron_piece"], tailoring=6)),
  ("pw_buy_great_helmet",spr_buy_item_flags(20),"great_helmet_new","bo_pw_armor_head", spr_buy_item_triggers("itm_great_helmet", resources=["itm_iron_bar","itm_linen_cloth_small"], tailoring=6)),
  ("pw_buy_winged_great_helmet",spr_buy_item_flags(21),"maciejowski_helmet_new","bo_pw_armor_head", spr_buy_item_triggers("itm_winged_great_helmet", resources=["itm_iron_bar","itm_iron_bar_short","itm_linen_cloth_small"], tailoring=6)),
  ("pw_buy_black_helmet",spr_buy_item_flags(21),"black_helm","bo_pw_armor_head", spr_buy_item_triggers("itm_black_helmet", resources=["itm_iron_bar","itm_linen_cloth_small"], tailoring=6)),

  ("pw_buy_shirt",spr_buy_item_flags(1),"shirt","bo_pw_armor_body", spr_buy_item_triggers("itm_shirt", resources=[], tailoring=1)),
  ("pw_buy_linen_tunic",spr_buy_item_flags(2),"shirt_a","bo_pw_armor_body", spr_buy_item_triggers("itm_linen_tunic", resources=[], tailoring=1)),
  ("pw_buy_black_robe",spr_buy_item_flags(3),"robes_black","bo_pw_armor_body", spr_buy_item_triggers("itm_black_robe", resources=[], tailoring=1)),
  ("pw_buy_red_robe",spr_buy_item_flags(3),"robes_red","bo_pw_armor_body", spr_buy_item_triggers("itm_red_robe", resources=[], tailoring=1)),
  ("pw_buy_brown_robe",spr_buy_item_flags(3),"robes_brown","bo_pw_armor_body", spr_buy_item_triggers("itm_brown_robe", resources=[], tailoring=1)),
  ("pw_buy_dress",spr_buy_item_flags(3),"dress","bo_pw_armor_body", spr_buy_item_triggers("itm_dress", resources=[], tailoring=1)),
  ("pw_buy_blue_dress",spr_buy_item_flags(3),"blue_dress_new","bo_pw_armor_body", spr_buy_item_triggers("itm_blue_dress", resources=[], tailoring=1)),
  ("pw_buy_heraldic_blue_dress",spr_buy_item_flags(3),"blue_dress_new","bo_pw_armor_body", spr_buy_item_triggers("itm_heraldic_blue_dress", resources=[], tailoring=1)),
  ("pw_buy_peasant_dress",spr_buy_item_flags(3),"peasant_dress_b_new","bo_pw_armor_body", spr_buy_item_triggers("itm_peasant_dress", resources=[], tailoring=1)),
  ("pw_buy_heraldic_peasant_dress",spr_buy_item_flags(3),"peasant_dress_b_new","bo_pw_armor_body", spr_buy_item_triggers("itm_heraldic_peasant_dress", resources=[], tailoring=1)),
  ("pw_buy_woolen_dress",spr_buy_item_flags(3),"woolen_dress","bo_pw_armor_body", spr_buy_item_triggers("itm_woolen_dress", resources=[], tailoring=1)),
  ("pw_buy_sarranid_common_dress",spr_buy_item_flags(3),"sarranid_common_dress","bo_pw_armor_body", spr_buy_item_triggers("itm_sarranid_common_dress", resources=[], tailoring=1)),
  ("pw_buy_sarranid_common_dress_b",spr_buy_item_flags(3),"sarranid_common_dress_b","bo_pw_armor_body", spr_buy_item_triggers("itm_sarranid_common_dress_b", resources=[], tailoring=1)),
  ("pw_buy_lady_dress_ruby",spr_buy_item_flags(5),"lady_dress_r","bo_pw_armor_body", spr_buy_item_triggers("itm_lady_dress_ruby", resources=[], tailoring=2)),
  ("pw_buy_lady_dress_green",spr_buy_item_flags(5),"lady_dress_g","bo_pw_armor_body", spr_buy_item_triggers("itm_lady_dress_green", resources=[], tailoring=2)),
  ("pw_buy_lady_dress_blue",spr_buy_item_flags(5),"lady_dress_b","bo_pw_armor_body", spr_buy_item_triggers("itm_lady_dress_blue", resources=[], tailoring=2)),
  ("pw_buy_court_dress",spr_buy_item_flags(5),"court_dress","bo_pw_armor_body", spr_buy_item_triggers("itm_court_dress", resources=[], tailoring=2)),
  ("pw_buy_red_dress",spr_buy_item_flags(5),"red_dress","bo_pw_armor_body", spr_buy_item_triggers("itm_red_dress", resources=[], tailoring=2)),
  ("pw_buy_brown_dress",spr_buy_item_flags(5),"brown_dress","bo_pw_armor_body", spr_buy_item_triggers("itm_brown_dress", resources=[], tailoring=2)),
  ("pw_buy_green_dress",spr_buy_item_flags(5),"green_dress","bo_pw_armor_body", spr_buy_item_triggers("itm_green_dress", resources=[], tailoring=2)),
  ("pw_buy_sarranid_lady_dress",spr_buy_item_flags(5),"sarranid_lady_dress","bo_pw_armor_body", spr_buy_item_triggers("itm_sarranid_lady_dress", resources=[], tailoring=2)),
  ("pw_buy_sarranid_lady_dress_b",spr_buy_item_flags(5),"sarranid_lady_dress_b","bo_pw_armor_body", spr_buy_item_triggers("itm_sarranid_lady_dress_b", resources=[], tailoring=2)),
  ("pw_buy_khergit_lady_dress",spr_buy_item_flags(5),"khergit_lady_dress","bo_pw_armor_body", spr_buy_item_triggers("itm_khergit_lady_dress", resources=[], tailoring=2)),
  ("pw_buy_khergit_lady_dress_b",spr_buy_item_flags(6),"khergit_lady_dress_b","bo_pw_armor_body", spr_buy_item_triggers("itm_khergit_lady_dress_b", resources=[], tailoring=2)),
  ("pw_buy_bride_dress",spr_buy_item_flags(7),"bride_dress","bo_pw_armor_body", spr_buy_item_triggers("itm_bride_dress", resources=[], tailoring=2)),
  ("pw_buy_tunic_with_green_cape",spr_buy_item_flags(3),"peasant_man_a","bo_pw_armor_body", spr_buy_item_triggers("itm_tunic_with_green_cape", resources=[], tailoring=1)),
  ("pw_buy_rough_tunic",spr_buy_item_flags(2),"pw_rough_tunic","bo_pw_armor_body", spr_buy_item_triggers("itm_rough_tunic", resources=[], tailoring=1)),
  ("pw_buy_red_shirt",spr_buy_item_flags(2),"rich_tunic_a","bo_pw_armor_body", spr_buy_item_triggers("itm_red_shirt", resources=[], tailoring=2)),
  ("pw_buy_heraldic_shirt",spr_buy_item_flags(2),"rich_tunic_a","bo_pw_armor_body", spr_buy_item_triggers("itm_heraldic_shirt", resources=[], tailoring=2)),
  ("pw_buy_pelt_coat",spr_buy_item_flags(2),"thick_coat_a","bo_pw_armor_body", spr_buy_item_triggers("itm_pelt_coat", resources=[], tailoring=1)),
  ("pw_buy_sarranid_cloth_robe",spr_buy_item_flags(3),"sar_robe","bo_pw_armor_body", spr_buy_item_triggers("itm_sarranid_cloth_robe", resources=[], tailoring=1)),
  ("pw_buy_sarranid_cloth_robe_b",spr_buy_item_flags(3),"sar_robe_b","bo_pw_armor_body", spr_buy_item_triggers("itm_sarranid_cloth_robe_b", resources=[], tailoring=1)),
  ...
  ("pw_buy_coarse_tunic",spr_buy_item_flags(1),"coarse_tunic_a","bo_pw_armor_body", spr_buy_item_triggers("itm_coarse_tunic", resources=[], tailoring=1)),
  ("pw_buy_heraldic_coarse_tunic",spr_buy_item_flags(1),"coarse_tunic_a","bo_pw_armor_body", spr_buy_item_triggers("itm_heraldic_coarse_tunic", resources=[], tailoring=1)),
  ("pw_buy_leather_apron",spr_buy_item_flags(2),"leather_apron","bo_pw_armor_body", spr_buy_item_triggers("itm_leather_apron", resources=[], tailoring=1)),
  ...
  ("pw_buy_rich_outfit",spr_buy_item_flags(5),"merchant_outf","bo_pw_armor_body", spr_buy_item_triggers("itm_rich_outfit", resources=[], tailoring=2)),
  ...
  ("pw_buy_steppe_armor",spr_buy_item_flags(6),"lamellar_leather","bo_pw_armor_body", spr_buy_item_triggers("itm_steppe_armor", resources=["itm_linen_cloth","itm_leather_piece"], tailoring=2, tableau="tableau_colored_lamellar_leather")),
  ("pw_buy_leather_armor",spr_buy_item_flags(6),"tattered_leather_armor_a","bo_pw_armor_body", spr_buy_item_triggers("itm_leather_armor", resources=["itm_leather_roll","itm_iron_piece"], tailoring=2)),
  ("pw_buy_pilgrim_disguise",spr_buy_item_flags(5),"pilgrim_outfit","bo_pw_armor_body", spr_buy_item_triggers("itm_pilgrim_disguise", resources=[], tailoring=1)),
  ("pw_buy_red_gambeson",spr_buy_item_flags(7),"red_gambeson_a","bo_pw_armor_body", spr_buy_item_triggers("itm_red_gambeson", resources=["itm_linen_cloth","itm_leather_piece"], tailoring=3)),
  ("pw_buy_heraldic_gambeson",spr_buy_item_flags(7),"red_gambeson_a","bo_pw_armor_body", spr_buy_item_triggers("itm_heraldic_gambeson", resources=["itm_linen_cloth","itm_leather_piece"], tailoring=3)),
  ("pw_buy_padded_cloth",spr_buy_item_flags(7),"padded_cloth_a","bo_pw_armor_body", spr_buy_item_triggers("itm_padded_cloth", resources=["itm_linen_cloth"], tailoring=3, tableau="tableau_heraldic_padded_cloth_a")),
  ("pw_buy_aketon_green",spr_buy_item_flags(7),"padded_cloth_b","bo_pw_armor_body", spr_buy_item_triggers("itm_aketon_green", resources=["itm_linen_cloth"], tailoring=3, tableau="tableau_heraldic_padded_cloth_b")),
  ("pw_buy_archers_vest",spr_buy_item_flags(7),"archers_vest","bo_pw_armor_body", spr_buy_item_triggers("itm_archers_vest", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_nomad_vest",spr_buy_item_flags(7),"nomad_vest_new","bo_pw_armor_body", spr_buy_item_triggers("itm_nomad_vest", resources=["itm_leather_roll"], tailoring=3)),
  ("pw_buy_ragged_outfit",spr_buy_item_flags(6),"ragged_outfit_a_new","bo_pw_armor_body", spr_buy_item_triggers("itm_ragged_outfit", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_surgeon_coat",spr_buy_item_flags(7),"pw_surgeon_coat","bo_pw_armor_body", spr_buy_item_triggers("itm_surgeon_coat", resources=["itm_linen_cloth","itm_board","itm_iron_piece"], tailoring=2)),
  ("pw_buy_nomad_armor",spr_buy_item_flags(7),"nomad_armor_new","bo_pw_armor_body", spr_buy_item_triggers("itm_nomad_armor", resources=["itm_leather_roll"], tailoring=2)),
  ("pw_buy_nomad_robe",spr_buy_item_flags(8),"nomad_robe_a","bo_pw_armor_body", spr_buy_item_triggers("itm_nomad_robe", resources=["itm_linen_cloth","itm_leather_piece"], tailoring=3)),
  ("pw_buy_light_leather",spr_buy_item_flags(8),"light_leather","bo_pw_armor_body", spr_buy_item_triggers("itm_light_leather", resources=["itm_leather_roll"], tailoring=3)),
  ("pw_buy_leather_jerkin",spr_buy_item_flags(8),"ragged_leather_jerkin","bo_pw_armor_body", spr_buy_item_triggers("itm_leather_jerkin", resources=["itm_leather_roll","itm_linen_cloth_small"], tailoring=3)),
  ("pw_buy_padded_leather",spr_buy_item_flags(8),"leather_armor_b","bo_pw_armor_body", spr_buy_item_triggers("itm_padded_leather", resources=["itm_leather_roll","itm_linen_cloth_small"], tailoring=3)),
  ("pw_buy_arena_armor",spr_buy_item_flags(9),"arena_armorW_new","bo_pw_armor_body", spr_buy_item_triggers("itm_arena_armor", resources=["itm_linen_cloth","itm_iron_bar_short"], tailoring=2, tableau="tableau_colored_arena_armor")),
  ("pw_buy_tribal_warrior_outfit",spr_buy_item_flags(9),"tribal_warrior_outfit_a_new","bo_pw_armor_body", spr_buy_item_triggers("itm_tribal_warrior_outfit", resources=["itm_leather_roll"], tailoring=3)),
  ("pw_buy_sarranid_leather_armor",spr_buy_item_flags(9),"sarranid_leather_armor","bo_pw_armor_body", spr_buy_item_triggers("itm_sarranid_leather_armor", resources=["itm_leather_roll"], tailoring=3)),
  ("pw_buy_courtly_outfit",spr_buy_item_flags(3),"nobleman_outf","bo_pw_armor_body", spr_buy_item_triggers("itm_courtly_outfit", resources=[], tailoring=3)),
  ("pw_buy_nobleman_outfit",spr_buy_item_flags(3),"nobleman_outfit_b_new","bo_pw_armor_body", spr_buy_item_triggers("itm_nobleman_outfit", resources=[], tailoring=3)),
  ("pw_buy_sarranid_cavalry_robe",spr_buy_item_flags(10),"arabian_armor_a","bo_pw_armor_body", spr_buy_item_triggers("itm_sarranid_cavalry_robe", resources=["itm_linen_cloth","itm_iron_bar_short"], tailoring=3)),
  ("pw_buy_studded_leather_coat",spr_buy_item_flags(10),"leather_armor_a","bo_pw_armor_body", spr_buy_item_triggers("itm_studded_leather_coat", resources=["itm_leather_roll","itm_linen_cloth_small","itm_iron_bar_short"], tailoring=3)),
  ("pw_buy_byrnie",spr_buy_item_flags(11),"byrnie_a_new","bo_pw_armor_body", spr_buy_item_triggers("itm_byrnie", resources=["itm_iron_bar_short","itm_linen_cloth"], tailoring=3)),
  ("pw_buy_haubergeon",spr_buy_item_flags(11),"haubergeon_c","bo_pw_armor_body", spr_buy_item_triggers("itm_haubergeon", resources=[("itm_iron_bar_short",2),"itm_linen_cloth_small"], tailoring=3)),
  ("pw_buy_arabian_armor_b",spr_buy_item_flags(11),"arabian_armor_b","bo_pw_armor_body", spr_buy_item_triggers("itm_arabian_armor_b", resources=[("itm_iron_bar_short",2),"itm_linen_cloth_small"], tailoring=4)),
  ("pw_buy_lamellar_vest",spr_buy_item_flags(11),"lamellar_vest_a","bo_pw_armor_body", spr_buy_item_triggers("itm_lamellar_vest", resources=["itm_iron_bar_short","itm_linen_cloth"], tailoring=4)),
  ("pw_buy_lamellar_vest_khergit",spr_buy_item_flags(11),"lamellar_vest_b","bo_pw_armor_body", spr_buy_item_triggers("itm_lamellar_vest_khergit", resources=["itm_iron_bar_short","itm_linen_cloth"], tailoring=4, tableau="tableau_colored_lamellar_vest_b")),
  ("pw_buy_mail_shirt",spr_buy_item_flags(11),"mail_shirt_a","bo_pw_armor_body", spr_buy_item_triggers("itm_mail_shirt", resources=["itm_iron_bar_short","itm_linen_cloth"], tailoring=4)),
  ("pw_buy_mail_hauberk",spr_buy_item_flags(11),"hauberk_a_new","bo_pw_armor_body", spr_buy_item_triggers("itm_mail_hauberk", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], tailoring=4)),
  ("pw_buy_sarranid_mail_shirt",spr_buy_item_flags(12),"sarranian_mail_shirt","bo_pw_armor_body", spr_buy_item_triggers("itm_sarranid_mail_shirt", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], tailoring=5)),
  ("pw_buy_bishop_armor",spr_buy_item_flags(16),"pw_bishop_armor","bo_pw_armor_body", spr_buy_item_triggers("itm_bishop_armor", resources=[("itm_iron_bar_short",2),"itm_linen_cloth","itm_gold_bar"], tailoring=6)),
  ("pw_buy_mail_with_surcoat",spr_buy_item_flags(12),"mail_long_surcoat_new","bo_pw_armor_body", spr_buy_item_triggers("itm_mail_with_surcoat", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], tailoring=5, tableau="tableau_heraldic_mail_long_surcoat")),
  ("pw_buy_surcoat_over_mail",spr_buy_item_flags(12),"surcoat_over_mail_new","bo_pw_armor_body", spr_buy_item_triggers("itm_surcoat_over_mail", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], tailoring=5, tableau="tableau_heraldic_surcoat_over_mail")),
  ("pw_buy_brigandine_red",spr_buy_item_flags(13),"brigandine_b","bo_pw_armor_body", spr_buy_item_triggers("itm_brigandine_red", resources=[("itm_iron_bar_short",2),"itm_leather_roll"], tailoring=6, tableau="tableau_heraldic_brigandine_b")),
  ("pw_buy_mamluke_mail",spr_buy_item_flags(14),"sarranid_elite_cavalary","bo_pw_armor_body", spr_buy_item_triggers("itm_mamluke_mail", resources=[("itm_iron_bar_short",2),"itm_linen_cloth","itm_linen_cloth_small"], tailoring=6)),
  ("pw_buy_lamellar_armor",spr_buy_item_flags(15),"lamellar_armor_b","bo_pw_armor_body", spr_buy_item_triggers("itm_lamellar_armor", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], tailoring=6)),
  ("pw_buy_scale_armor",spr_buy_item_flags(14),"lamellar_armor_e","bo_pw_armor_body", spr_buy_item_triggers("itm_scale_armor", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], tailoring=6)),
  ("pw_buy_banded_armor",spr_buy_item_flags(15),"banded_armor_a","bo_pw_armor_body", spr_buy_item_triggers("itm_banded_armor", resources=[("itm_iron_bar_short",2),"itm_leather_roll"], tailoring=6)),
  ("pw_buy_cuir_bouilli",spr_buy_item_flags(15),"cuir_bouilli_a","bo_pw_armor_body", spr_buy_item_triggers("itm_cuir_bouilli", resources=[("itm_iron_bar_short",2),"itm_leather_roll"], tailoring=6)),
  ("pw_buy_coat_of_plates",spr_buy_item_flags(16),"coat_of_plates_a","bo_pw_armor_body", spr_buy_item_triggers("itm_coat_of_plates", resources=[("itm_iron_bar_short",2),"itm_leather_roll"], tailoring=6)),
  ("pw_buy_coat_of_plates_red",spr_buy_item_flags(16),"coat_of_plates_red","bo_pw_armor_body", spr_buy_item_triggers("itm_coat_of_plates_red", resources=[("itm_iron_bar_short",2),"itm_leather_roll"], tailoring=6, tableau="tableau_heraldic_coat_of_plates")),
  ("pw_buy_khergit_elite_armor",spr_buy_item_flags(17),"lamellar_armor_d","bo_pw_armor_body", spr_buy_item_triggers("itm_khergit_elite_armor", resources=[("itm_iron_bar",2),"itm_leather_piece","itm_linen_cloth"], tailoring=6, tableau="tableau_heraldic_lamellar_armor_d")),
  ("pw_buy_vaegir_elite_armor",spr_buy_item_flags(17),"lamellar_armor_c","bo_pw_armor_body", spr_buy_item_triggers("itm_vaegir_elite_armor", resources=[("itm_iron_bar",2),"itm_leather_piece","itm_linen_cloth"], tailoring=6)),
  ("pw_buy_sarranid_elite_armor",spr_buy_item_flags(17),"tunic_armor_a","bo_pw_armor_body", spr_buy_item_triggers("itm_sarranid_elite_armor", resources=[("itm_iron_bar",2),"itm_leather_piece","itm_linen_cloth"], tailoring=6)),
  ("pw_buy_plate_armor",spr_buy_item_flags(23),"full_plate_armor","bo_pw_armor_body", spr_buy_item_triggers("itm_plate_armor", resources=[("itm_iron_bar_long",2),"itm_leather_piece","itm_linen_cloth"], tailoring=7)),
  ("pw_buy_heraldic_plate_armor",spr_buy_item_flags(23),"full_plate_armor","bo_pw_armor_body", spr_buy_item_triggers("itm_heraldic_plate_armor", resources=[("itm_iron_bar_long",2),"itm_leather_piece","itm_linen_cloth"], tailoring=7)),
  ("pw_buy_black_armor",spr_buy_item_flags(24),"black_armor","bo_pw_armor_body", spr_buy_item_triggers("itm_black_armor", resources=[("itm_iron_bar_long",2),"itm_leather_piece","itm_linen_cloth"], tailoring=7)),
  ("pw_buy_light_heraldic_mail",spr_buy_item_flags(10),"heraldic_armor_new_c","bo_pw_armor_body", spr_buy_item_triggers("itm_light_heraldic_mail", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], tailoring=4, tableau="tableau_heraldic_armor_c")),
  ("pw_buy_heraldic_mail_with_tunic",spr_buy_item_flags(12),"heraldic_armor_new_b","bo_pw_armor_body", spr_buy_item_triggers("itm_heraldic_mail_with_tunic", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], tailoring=4, tableau="tableau_heraldic_armor_b")),
  ("pw_buy_heraldic_mail_with_tabard",spr_buy_item_flags(14),"heraldic_armor_new_d","bo_pw_armor_body", spr_buy_item_triggers("itm_heraldic_mail_with_tabard", resources=[("itm_iron_bar_short",3),"itm_linen_cloth"], tailoring=5, tableau="tableau_heraldic_armor_d")),
  ("pw_buy_heraldic_mail_with_surcoat",spr_buy_item_flags(16),"heraldic_armor_new_a","bo_pw_armor_body", spr_buy_item_triggers("itm_heraldic_mail_with_surcoat", resources=[("itm_iron_bar_short",3),"itm_leather_piece","itm_linen_cloth"], tailoring=6, tableau="tableau_heraldic_armor_a")),

  ("pw_buy_wrapping_boots",spr_buy_item_flags(1),"wrapping_boots_a","bo_pw_armor_foot", spr_buy_item_triggers("itm_wrapping_boots", resources=[], tailoring=1)),
  ("pw_buy_woolen_hose",spr_buy_item_flags(1),"woolen_hose_a","bo_pw_armor_foot", spr_buy_item_triggers("itm_woolen_hose", resources=[], tailoring=1)),
  ...
  ("pw_buy_blue_hose",spr_buy_item_flags(1),"blue_hose_a","bo_pw_armor_foot", spr_buy_item_triggers("itm_blue_hose", resources=[], tailoring=1)),
  ("pw_buy_bride_shoes",spr_buy_item_flags(5),"bride_shoes","bo_pw_armor_foot", spr_buy_item_triggers("itm_bride_shoes", resources=[], tailoring=2)),
  ...
  ("pw_buy_leather_boots",spr_buy_item_flags(4),"leather_boots_a","bo_pw_armor_foot", spr_buy_item_triggers("itm_leather_boots", resources=[("itm_leather_piece",2)], tailoring=3)),
  ("pw_buy_sarranid_boots_b",spr_buy_item_flags(4),"sarranid_boots","bo_pw_armor_foot", spr_buy_item_triggers("itm_sarranid_boots_b", resources=[("itm_leather_piece",2)], tailoring=3)),
  ("pw_buy_khergit_leather_boots",spr_buy_item_flags(4),"khergit_leather_boots","bo_pw_armor_foot", spr_buy_item_triggers("itm_khergit_leather_boots", resources=[("itm_leather_piece",2)], tailoring=3)),
  ("pw_buy_sarranid_boots_c",spr_buy_item_flags(5),"sarranid_camel_boots","bo_pw_armor_foot", spr_buy_item_triggers("itm_sarranid_boots_c", resources=[("itm_leather_piece",2),"itm_iron_piece"], tailoring=3)),
  ("pw_buy_splinted_leather_greaves",spr_buy_item_flags(5),"leather_greaves_a","bo_pw_armor_foot", spr_buy_item_triggers("itm_splinted_leather_greaves", resources=[("itm_leather_piece",2),"itm_iron_piece"], tailoring=3)),
  ("pw_buy_bishop_chausses",spr_buy_item_flags(6),"pw_bishop_chausses","bo_pw_armor_foot", spr_buy_item_triggers("itm_bishop_chausses", resources=["itm_leather_piece",("itm_iron_piece",2)], tailoring=3)),
  ("pw_buy_mail_chausses",spr_buy_item_flags(6),"mail_chausses_a","bo_pw_armor_foot", spr_buy_item_triggers("itm_mail_chausses", resources=["itm_leather_piece",("itm_iron_piece",2)], tailoring=4)),
  ("pw_buy_splinted_greaves",spr_buy_item_flags(6),"splinted_greaves_a","bo_pw_armor_foot", spr_buy_item_triggers("itm_splinted_greaves", resources=["itm_linen_cloth_small",("itm_iron_piece",2)], tailoring=4)),
  ("pw_buy_sarranid_boots_d",spr_buy_item_flags(6),"sarranid_mail_chausses","bo_pw_armor_foot", spr_buy_item_triggers("itm_sarranid_boots_d", resources=["itm_leather_piece",("itm_iron_piece",2)], tailoring=5)),
  ("pw_buy_mail_boots",spr_buy_item_flags(7),"mail_boots_a","bo_pw_armor_foot", spr_buy_item_triggers("itm_mail_boots", resources=["itm_leather_piece",("itm_iron_bar_short",2)], tailoring=5)),
  ("pw_buy_iron_greaves",spr_buy_item_flags(8),"iron_greaves_a","bo_pw_armor_foot", spr_buy_item_triggers("itm_iron_greaves", resources=["itm_leather_piece",("itm_iron_bar_short",3)], tailoring=6)),
  ("pw_buy_plate_boots",spr_buy_item_flags(10),"plate_boots","bo_pw_armor_foot", spr_buy_item_triggers("itm_plate_boots", resources=[("itm_leather_piece",2),("itm_iron_bar",2)], tailoring=6)),
  ("pw_buy_black_greaves",spr_buy_item_flags(11),"black_greaves","bo_pw_armor_foot", spr_buy_item_triggers("itm_black_greaves", resources=[("itm_leather_piece",2),("itm_iron_bar",2)], tailoring=6)),

  ("pw_buy_leather_gloves",spr_buy_item_flags(2),"leather_gloves_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_leather_gloves", resources=["itm_leather_piece"], tailoring=2)),
  ...
  ("pw_buy_mail_mittens",spr_buy_item_flags(4),"mail_mittens_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_mail_mittens", resources=["itm_iron_piece"], tailoring=3)),
  ("pw_buy_lamellar_gauntlets",spr_buy_item_flags(5),"scale_gauntlets_a_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_lamellar_gauntlets", resources=["itm_leather_piece","itm_iron_piece"], tailoring=4)),
  ("pw_buy_scale_gauntlets",spr_buy_item_flags(5),"scale_gauntlets_b_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_scale_gauntlets", resources=["itm_leather_piece","itm_iron_piece"], tailoring=5)),
  ("pw_buy_gauntlets",spr_buy_item_flags(6),"gauntlets_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_gauntlets", resources=["itm_leather_piece",("itm_iron_bar_short",2)], tailoring=6)),
  ...
  ("pw_buy_pony_brown_paint",spr_buy_item_flags(5),"sack","bo_sack_fixed", spr_buy_item_triggers("itm_pony_brown_paint", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ("pw_buy_pony_dun_paint",spr_buy_item_flags(5),"sack","bo_sack_fixed", spr_buy_item_triggers("itm_pony_dun_paint", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ("pw_buy_pony_light_chestnut",spr_buy_item_flags(5),"sack","bo_sack_fixed", spr_buy_item_triggers("itm_pony_light_chestnut", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ("pw_buy_pony_brown_bay",spr_buy_item_flags(5),"sack","bo_sack_fixed", spr_buy_item_triggers("itm_pony_brown_bay", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ("pw_buy_pony_white_spots",spr_buy_item_flags(5),"sack","bo_sack_fixed", spr_buy_item_triggers("itm_pony_white_spots", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ("pw_buy_pony_black",spr_buy_item_flags(5),"sack","bo_sack_fixed", spr_buy_item_triggers("itm_pony_black", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ...
  ("pw_buy_cart_horse",spr_buy_item_flags(3),"sack","bo_sack_fixed", spr_buy_item_triggers("itm_cart_horse", resources=["itm_board", ("itm_wheat_sheaf", 2)], herding=1)),
  ...
  ("pw_buy_shovel",spr_buy_item_flags(3),"shovel","bo_pw_weapon_big", spr_buy_item_triggers("itm_shovel", resources=["itm_iron_bar_short", "itm_wood_pole"], engineer=2)),
  ...
  ("pw_buy_carrot_sack",spr_buy_item_flags(1),"pw_wheat_sack","bo_pw_weapon_small", spr_buy_item_triggers("itm_carrot_sack", pos_offset=(0,0,-20), resources=["itm_carrot"])),
  ("pw_buy_cabbage_sack",spr_buy_item_flags(1),"pw_wheat_sack","bo_pw_weapon_small", spr_buy_item_triggers("itm_cabbage_sack", pos_offset=(0,0,-20), resources=["itm_cabbage"])),
  ...
  ("pw_buy_throwable_stone",spr_use_time(1),"throwable_stone","bo_pw_weapon_small", spr_buy_item_triggers("itm_throwable_stone")),
  ...
  ("pw_buy_warhorn",spr_buy_item_flags(8),"warhorn","bo_pw_weapon_small", spr_buy_item_triggers("itm_warhorn", pos_offset=(0,0,15), resources=["itm_bone"], engineer=3)),
  ...
  ("pw_buy_executioner_axe",spr_buy_item_flags(8),"execution_axe","bo_pw_weapon_big", spr_buy_item_triggers("itm_executioner_axe", resources=["itm_steel_axehead", "itm_wood_pole"], engineer=7)),
  
  ("pw_buy_practice_sword",spr_buy_item_flags(1),"practice_sword","bo_pw_weapon", spr_buy_item_triggers("itm_practice_sword", resources=[])),
  ("pw_buy_heavy_practice_sword",spr_buy_item_flags(1),"pw_heavy_practice_sword","bo_pw_weapon", spr_buy_item_triggers("itm_heavy_practice_sword", resources=[])),
  ("pw_buy_practice_staff",spr_buy_item_flags(1),"wooden_staff","bo_pw_weapon_big", spr_buy_item_triggers("itm_practice_staff", resources=[])),
  ("pw_buy_jousting_lance",spr_buy_item_flags(1),"jousting_lance","bo_pw_weapon_big", spr_buy_item_triggers("itm_jousting_lance", resources=[])),
  
  ("pw_buy_ladder_6m",spr_buy_item_flags(1),"ladder_pack_hold","bo_ladder_pack_hold", spr_buy_item_triggers("itm_siege_ladder_6m", resources=[("itm_wood_pole", 2), ("itm_stick", 2),], engineer=2)),
  ("pw_buy_ladder_8m",spr_buy_item_flags(1),"ladder_pack_hold","bo_ladder_pack_hold", spr_buy_item_triggers("itm_siege_ladder_8m", resources=["itm_siege_ladder_6m", ("itm_wood_pole", 2),], engineer=2)),
  ("pw_buy_ladder_10m",spr_buy_item_flags(1),"ladder_pack_hold","bo_ladder_pack_hold", spr_buy_item_triggers("itm_siege_ladder_10m", resources=["itm_siege_ladder_8m", ("itm_wood_pole", 2),], engineer=2)),
  ("pw_buy_ladder_12m",spr_buy_item_flags(1),"ladder_pack_hold","bo_ladder_pack_hold", spr_buy_item_triggers("itm_siege_ladder_12m", resources=["itm_siege_ladder_10m", ("itm_wood_pole", 2),], engineer=2)),
  ("pw_buy_ladder_14m",spr_buy_item_flags(1),"ladder_pack_hold","bo_ladder_pack_hold", spr_buy_item_triggers("itm_siege_ladder_14m", resources=["itm_siege_ladder_12m", ("itm_wood_pole", 2),], engineer=2)),
  ...
  ("pw_change_troop_serf",spr_use_time(30),"parchment","bo_parchment", spr_change_troop_triggers("trp_serf", cost=150)),
  ("pw_change_troop_beggar",spr_use_time(30),"wooden_staff","bo_pw_weapon_big", spr_change_troop_triggers("trp_beggar", cost=150)),
  ("pw_change_troop_ministrel",spr_use_time(45),"pw_lute_carry","bo_pw_weapon_small", spr_change_troop_triggers("trp_ministrel", cost=700)),
  ...
  ("pw_change_troop_monk",spr_use_time(60),"quarter_staff","bo_pw_weapon_big", spr_change_troop_triggers("trp_monk", cost=450)),
  ("pw_change_troop_alchemist",spr_use_time(90),"package","bobaggage", spr_change_troop_triggers("trp_alchemist", cost=2400)),
  ("pw_change_troop_footman",spr_use_time(60),"parchment","bo_parchment", spr_change_troop_triggers("trp_footman", cost=1000)),
  ("pw_change_troop_archer",spr_use_time(60),"parchment","bo_parchment", spr_change_troop_triggers("trp_archer", cost=1100)),
  ("pw_change_troop_lancer",spr_use_time(70),"parchment","bo_parchment", spr_change_troop_triggers("trp_lancer", cost=1500)),
  ("pw_change_troop_man_at_arms",spr_use_time(90),"parchment","bo_parchment", spr_change_troop_triggers("trp_man_at_arms", cost=5000)),
  ("pw_change_troop_sergeant",spr_use_time(90),"parchment","bo_parchment", spr_change_troop_triggers("trp_sergeant", cost=5000)),
  ("pw_change_troop_engineer",spr_use_time(80),"parchment","bo_parchment", spr_change_troop_triggers("trp_engineer", cost=2500)),
  ("pw_change_troop_blacksmith",spr_use_time(90),"parchment","bo_parchment", spr_change_troop_triggers("trp_blacksmith", cost=4000)),
  ("pw_change_troop_armoursmith",spr_use_time(90),"parchment","bo_parchment", spr_change_troop_triggers("trp_armoursmith", cost=4000)),
  ("pw_change_troop_doctor",spr_use_time(100),"package","bobaggage", spr_change_troop_triggers("trp_doctor", cost=3500)),
  ("pw_change_troop_sailor",spr_use_time(70),"parchment","bo_parchment", spr_change_troop_triggers("trp_sailor", cost=2000)),
  ...
  ("pw_change_troop_merchant",spr_use_time(70),"parchment","bo_parchment", spr_change_troop_triggers("trp_merchant", cost=2200, use_string="str_troop_become")),
  ("pw_change_troop_herdsman",spr_use_time(40),"quarter_staff","bo_pw_weapon_big", spr_change_troop_triggers("trp_herdsman", cost=900)),
  
  ("pw_change_troop_marshal",spr_use_time(80),"parchment","bo_parchment", spr_change_troop_triggers("trp_marshal", cost=1000, use_string="str_troop_assume_role")),
  ("pw_change_troop_steward",spr_use_time(70),"parchment","bo_parchment", spr_change_troop_triggers("trp_steward", cost=1000, use_string="str_troop_assume_role")),
  
  ("pw_change_troop_lord",spr_use_time(70),"parchment","bo_parchment", spr_change_troop_triggers("trp_lord", cost=500, use_string="str_troop_assume_role")),
  ("pw_change_troop_warchief",spr_use_time(70),"sledgehammer","bo_pw_weapon", spr_change_troop_triggers("trp_warchief", cost=500, use_string="str_troop_assume_role")),
  
  ("pw_change_troop_cultist",spr_use_time(60),"quarter_staff","bo_pw_weapon_big", spr_change_troop_triggers("trp_cultist", cost=1000, use_string="str_troop_become")),
  ("pw_change_troop_ruffian",spr_use_time(40),"sledgehammer","bo_pw_weapon", spr_change_troop_triggers("trp_ruffian", cost=800, use_string="str_troop_become")),
  ("pw_change_troop_brigand",spr_use_time(50),"spiked_club","bo_pw_weapon", spr_change_troop_triggers("trp_brigand", cost=900, use_string="str_troop_become")),
  
  ("pw_change_troop_rebel",spr_use_time(50),"spiked_mace","bo_pw_weapon", spr_change_troop_triggers("trp_rebel", cost=700, mercenary=True, after_respawn=True, use_string="str_troop_become_for")),
  
  ("pw_change_troop_mercenary_crossbowman",spr_use_time(60),"parchment","bo_parchment", spr_change_troop_triggers("trp_mercenary_crossbowman", cost=1400)),
  ("pw_change_troop_mercenary_cavalry",spr_use_time(70),"parchment","bo_parchment", spr_change_troop_triggers("trp_mercenary_cavalry", cost=1900)),
  ("pw_change_troop_mercenary",spr_use_time(60),"parchment","bo_parchment", spr_change_troop_triggers("trp_mercenary_hired_blade", cost=1400)),
  
  ("code_change_troop_end",0,"0","0", []),
  ...
  ("pw_castle_subjugate_point",spr_use_time(20),"pw_castle_flag_post","bo_pw_castle_flag_post", spr_subjugate_castle_triggers()),
  ...
  #Mannequin
  ("fw_mannequin",0,"Mannequin_base","bo_Mannequin_base", spr_mannequin()),
  ("code_mannequin_head",spr_buy_item_flags(2),"Mannequin_head","bo_Mannequin_head", spr_mannequin_parts()),
  ("code_mannequin_torso",spr_buy_item_flags(2),"Mannequin_torso","bo_Mannequin_torso", spr_mannequin_parts()),
  ("code_mannequin_arms",spr_buy_item_flags(2),"Mannequin_arms","bo_Mannequin_arms", spr_mannequin_parts()),
  ("code_mannequin_legs",spr_buy_item_flags(2),"Mannequin_legs","bo_Mannequin_legs", spr_mannequin_parts()),
  ("code_mannequin_end",0,"invisible",0, []),
  
  ("fw_metalworks_coal_mine_a",spr_resource_flags(),"coal_vein_a1","bo_pw_iron_vein_a1", spr_hit_mine_triggers("itm_coal", resource_hp=10, hardness=4)),
  ("fw_metalworks_coal_mine_b",spr_resource_flags(),"coal_vein_a2","bo_pw_iron_vein_a2", spr_hit_mine_triggers("itm_coal", resource_hp=10, hardness=4)),
  ("fw_metalworks_coal_mine_c",spr_resource_flags(),"coal_vein_b","bo_pw_iron_vein_b", spr_hit_mine_triggers("itm_coal", resource_hp=10, hardness=5)),

  #Smelter
  ("fw_metalworks_smelter",spr_use_time(10),"pw_smithy_forge","bo_pw_smithy_forge", spr_process_resource_triggers("script_cf_process_iron", use_string="str_process_metal")),
  
  #Forge
  ("fw_metalworks_forge",spr_use_time(1),"mw_smithy_forge","bo_pw_smithy_forge", spr_forge_triggers()),
  ("fw_metalworks_bellows",spr_use_time(2),"smithy_forge_bellows","bo_smithy_forge_bellows", spr_bellows_triggers()),
  
  #Anvil
  ("fw_metalworks_anvil",spr_use_time(1),"smithy_anvil","bo_mw_anvil", spr_anvil_triggers()),
  
  #Water Troth
  ("fw_metalworks_water_storage",spr_use_time(2),"feeding_trough_a","bo_feeding_trough_a", spr_unheat_metal_triggers()),
  
  #Grinding Stone
  ("fw_metalworks_grindstone",spr_use_time(3),"smithy_grindstone_wheel","bo_smithy_grindstone_wheel", spr_grindstone_triggers()),
  
  #Bow tiller
  ("fw_metalworks_bow_tiller",spr_use_time(6),"bow_tiller","bo_bow_tiller", spr_bow_tiller_triggers()),
  
  #Weapon stand
  ("fw_metalworks_weapon_stand",spr_use_time(2),"Crafting_Bench","bo_Crafting_Bench", spr_weapon_stand()),
  
  #Resources
  ("code_iron_piece",0,"pw_iron_piece",0, []),
  ("code_iron_bar_short",0,"pw_iron_bar_short",0, []),
  ("code_iron_bar",0,"pw_iron_bar",0, []),
  ("code_iron_bar_long",0,"pw_iron_bar_long",0, []),
  ("code_heated_iron_piece",0,"heated_iron_piece",0, []),
  ("code_heated_iron_bar_short",0,"heated_iron_bar_short",0, []),
  ("code_heated_iron_bar",0,"heated_iron_bar",0, []),
  ("code_heated_iron_bar_long",0,"heated_iron_bar_long",0, []),
  ("code_heated_steel_piece",0,"heated_iron_piece",0, []),
  ("code_heated_steel_bar_short",0,"heated_iron_bar_short",0, []),
  ("code_heated_steel_bar",0,"heated_iron_bar",0, []),
  ("code_heated_steel_bar_long",0,"heated_iron_bar_long",0, []),
  ("code_metalworks_end",0,"invisible",0, []),
  
  #Stockpiles
  ("pw_stockpile_steel_bar",spr_use_time(1),"pw_chest_c","bo_pw_chest_c", spr_stockpile_resource_triggers("itm_steel_bar")),
  ("pw_stockpile_coal",spr_use_time(1),"coal","bo_coal", spr_stockpile_resource_triggers("itm_coal")),
  ...
  #Resources
  ("code_wood_block",0,"standing_wood_block_a",0, []),
  
  #Chop block
  ("fw_carpentry_chop_block",spr_use_time(1),"chop_block","bo_chop_block", spr_chop_block_triggers()),
  
  ##Carpentry - End
  
  ##Farming
  
  ("fw_field",spr_field_flags(),"fw_field","bo_pw_wheat_field", spr_hit_field_triggers(height=200, full_hp=2000, resource_hp=50, tool_class=item_class_grain_harvesting, regrow_interval=600)),
  ("code_wheat",0,"pw_wheat","0", spr_field_plant_triggers(seeds=4, water=2)),
  ("code_carrot",0,"pw_carrot_planted","0", spr_field_plant_triggers(seeds=4, water=3)),
  ("code_cabbage",0,"pw_cabbage_planted","0", spr_field_plant_triggers(seeds=3, water=3)),
  ...
  #Money Chest
  ("fw_bank_money_chest",0,"pw_chest_b","bo_pw_chest_b", spr_bank_chest()),
  
  #Stable
  ("fw_bank_stable",spr_use_time(3),"stable_wooden_small","bo_stable_wooden_small", spr_bank_stable()),
  
  #Inventory
  ("fw_bank_inventory",spr_use_time(1),"pw_chest_c","bo_pw_chest_c", spr_bank_inventory()),
  
  ##Banks - End
  
  ##Graves
  
  ("grave_a",0,"grave_base","bo_grave_base", spr_setup_graves()),
  
  ("code_digable_grave",0,"grave_dig","bo_grave_dig", spr_dig_graves()),
  ...
  ("wild_animal_spawn_zone",0,"grass_bush_c",0, []),
  
  ##Animal Spawn Zones
  
  #Sword in the stone
  ("fw_pull_sword",spr_use_time(60),"legendary_greatsword","bo_pw_weapon_big", spr_pull_legendary_sword()),

  ##Siege Equipment
  
  ("code_ladder_6m",0,"siege_ladder_move_6m","bo_ladder_6m_deploy", []),
  ("code_ladder_8m",0,"siege_ladder_move_8m","bo_ladder_8m_deploy", []),
  ("code_ladder_10m",0,"siege_ladder_move_10m","bo_ladder_10m_deploy", []),
  ("code_ladder_12m",0,"siege_ladder_move_12m","bo_ladder_12m_deploy", []),
  ("code_ladder_14m",0,"siege_ladder_move_14m","bo_ladder_14m_deploy", []),
  ("code_ladder_end",0,0,0, []),
  
  ("code_deployed_ladder_6m",spr_ladder_flags(),"siege_ladder_move_6m","bo_ladder_6m_deploy", spr_deploy_siege_ladder(hit_points=400,item="itm_siege_ladder_6m")),
  ("code_deployed_ladder_8m",spr_ladder_flags(),"siege_ladder_move_8m","bo_ladder_8m_deploy", spr_deploy_siege_ladder(hit_points=440,item="itm_siege_ladder_8m")),
  ("code_deployed_ladder_10m",spr_ladder_flags(),"siege_ladder_move_10m","bo_ladder_10m_deploy", spr_deploy_siege_ladder(hit_points=480,item="itm_siege_ladder_10m")),
  ("code_deployed_ladder_12m",spr_ladder_flags(),"siege_ladder_move_12m","bo_ladder_12m_deploy", spr_deploy_siege_ladder(hit_points=520,item="itm_siege_ladder_12m")),
  ("code_deployed_ladder_14m",spr_ladder_flags(),"siege_ladder_move_14m","bo_ladder_14m_deploy", spr_deploy_siege_ladder(hit_points=560,item="itm_siege_ladder_14m")),
  ("code_deployed_ladder_end",0,0,0, []),
  ...
  #Herbs
  ("fw_alchemy_herb_rosemary",spr_resource_flags(),"pw_herb_c_bush","bo_pw_herb_bush", spr_hit_plant_triggers("itm_rosemary", full_hp=400, resource_hp=40, regrow_interval=600)),
  ("fw_alchemy_herb_nightshade",spr_resource_flags(),"pw_herb_b_bush","bo_pw_herb_bush", spr_hit_plant_triggers("itm_nightshade", full_hp=600, resource_hp=30, regrow_interval=1000)),
  ("fw_alchemy_herb_mandrake",spr_resource_flags(),"pw_herb_d_bush","bo_pw_herb_bush", spr_hit_plant_triggers("itm_mandrake", full_hp=400, resource_hp=40, regrow_interval=600)),
  ("fw_alchemy_herb_sage",spr_resource_flags(),"pw_herb_a_bush","bo_pw_herb_bush", spr_hit_plant_triggers("itm_sage", full_hp=400, resource_hp=40, regrow_interval=600)),
  ("fw_alchemy_herb_saffron",spr_resource_flags(),"pw_herb_g_bush","bo_pw_herb_bush", spr_hit_plant_triggers("itm_saffron", full_hp=600, resource_hp=30, regrow_interval=1000)),
  
  #Equipment
  ("fw_alchemy_mixing_bowl",spr_use_time(4),"tripod_cauldron_a","bo_tripod_cauldron_a", spr_alchemy_mixing_bowl()),
  ("fw_alchemy_extract_bowl",spr_use_time(8),"bowl_big","bo_bowl_big", spr_alchemy_extract()),
  
  ##Alchemy - End
  
  ## Market stalls props
  
  ("fw_market_buy_property",spr_buy_item_flags(20),"pw_book_a","bo_pw_weapon_small", spr_market_buy_property()),
  
  ("fw_market_shop_box",spr_market_flags(1),"box_a","bo_box_a", spr_market_shop_triggers(inventory_count=12, max_item_length=180)),
  ("fw_market_shop_shelves_a",spr_market_flags(1),"shelves","bo_shelves", spr_market_shop_triggers(inventory_count=6, max_item_length=180)),
  ("fw_market_shop_shelves_b",spr_market_flags(1),"merchant_shelf_a","bo_merchant_shelf_a", spr_market_shop_triggers(inventory_count=6, max_item_length=250)),
  ("fw_market_shop_cupboard_a",spr_market_flags(1),"cupboard_a","bo_cupboard_a", spr_market_shop_triggers(inventory_count=18, max_item_length=250)),
  ("fw_market_shop_tavern_table_a",spr_market_flags(1),"tavern_table_a","bo_tavern_table_a", spr_market_shop_triggers(inventory_count=24, max_item_length=250)),
  ("fw_market_shop_wooden_stand",spr_market_flags(1),"wooden_stand","bowooden_stand", spr_market_shop_triggers(inventory_count=18, max_item_length=250)),
  ("fw_market_shop_wooden_stand_big",spr_market_flags(1),"market_shop_big","bo_market_shop_big", spr_market_shop_triggers(inventory_count=24, max_item_length=250)),
  ("fw_market_shop_wooden_stand_big_b",spr_market_flags(1),"market_shop_part","bo_market_shop_part", spr_market_shop_triggers(inventory_count=24, max_item_length=250)),
  
  ("fw_market_door_rotate_a",spr_rotate_door_no_hit_flags(1),"castle_f_sally_door_a","bo_castle_f_sally_door_a", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_b",spr_rotate_door_no_hit_flags(1),"castle_e_sally_door_a","bo_castle_e_sally_door_a_fixed", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_c",spr_rotate_door_no_hit_flags(1),"castle_f_door_a","bo_castle_f_door_a_fixed", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_d",spr_rotate_door_no_hit_flags(1),"pw_door_d","bo_pw_door_d", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_viking_left",spr_rotate_door_no_hit_flags(1),"viking_keep_destroy_sally_door_left","bo_viking_keep_destroy_sally_door_left_fixed", spr_market_door_no_hit_triggers(left=1)),
  ("fw_market_door_rotate_viking_right",spr_rotate_door_no_hit_flags(1),"viking_keep_destroy_sally_door_right","bo_viking_keep_destroy_sally_door_right_fixed", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_gatehouse_left",spr_rotate_door_no_hit_flags(1),"pw_gatehouse_door_left","bo_pw_gatehouse_door_left", spr_market_door_no_hit_triggers(left=1)),
  ("fw_market_door_rotate_gatehouse_right",spr_rotate_door_no_hit_flags(1),"pw_gatehouse_door_right","bo_pw_gatehouse_door_right", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_e_left",spr_rotate_door_no_hit_flags(1),"pw_door_e_left","bo_pw_door_left", spr_market_door_no_hit_triggers(left=1)),
  ("fw_market_door_rotate_e_right",spr_rotate_door_no_hit_flags(1),"pw_door_e_right","bo_pw_door_right", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_f_left",spr_rotate_door_no_hit_flags(1),"pw_door_f_left","bo_pw_door_left", spr_market_door_no_hit_triggers(left=1)),
  ("fw_market_door_rotate_f_right",spr_rotate_door_no_hit_flags(1),"pw_door_f_right","bo_pw_door_right", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_h_left",spr_rotate_door_no_hit_flags(1),"pw_door_g_left","bo_pw_door_left", spr_market_door_no_hit_triggers(left=1)),
  ("fw_market_door_rotate_h_right",spr_rotate_door_no_hit_flags(1),"pw_door_g_right","bo_pw_door_right", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_towngate_left",spr_rotate_door_no_hit_flags(2),"towngate_rectangle_door_left","bo_towngate_rectangle_door_left_fixed", spr_market_door_no_hit_triggers(left=1)),
  ("fw_market_door_rotate_towngate_right",spr_rotate_door_no_hit_flags(2),"towngate_rectangle_door_right","bo_towngate_rectangle_door_right_fixed", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_earth_left",spr_rotate_door_no_hit_flags(2),"earth_sally_gate_left","bo_earth_sally_gate_left", spr_market_door_no_hit_triggers(left=1)),
  ("fw_market_door_rotate_earth_right",spr_rotate_door_no_hit_flags(2),"earth_sally_gate_right","bo_earth_sally_gate_right", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_stable",spr_rotate_door_no_hit_flags(1),"pw_full_stable_door_a","bo_pw_full_stable_door_a", spr_market_door_no_hit_triggers(left=1)),
  ("fw_market_door_rotate_village_a",spr_rotate_door_no_hit_flags(1),"pw_village_door_a","bo_pw_village_door_a", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_village_b",spr_rotate_door_no_hit_flags(1),"pw_village_door_b","bo_pw_village_door_a", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_dungeon_cell_a",spr_rotate_door_no_hit_flags(2),"dungeon_door_cell_a","bo_dungeon_door_cell_a_fixed", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_dungeon_cell_b",spr_rotate_door_no_hit_flags(2),"dungeon_door_cell_b_fixed","bo_dungeon_door_cell_b_fixed", spr_market_door_no_hit_triggers()),
  ("fw_market_door_rotate_dungeon_cell_c",spr_rotate_door_no_hit_flags(2),"dungeon_door_cell_c","bo_dungeon_door_cell_c", spr_market_door_no_hit_triggers()),
  
  ("code_market_end",sokf_moveable,"0",0, []),
  
  ## Market stals props - End
  ...
  ("fw_sleep_bed_a",spr_use_time(1),"bed_a","bo_bed_a", spr_sleep_triggers()),
  ("fw_sleep_bed_b",spr_use_time(1),"bed_b","bo_bed_b", spr_sleep_triggers()),
  ("fw_sleep_bed_c",spr_use_time(1),"bed_c","bo_bed_c", spr_sleep_triggers()),
  ("fw_sleep_bed_e",spr_use_time(1),"bed_e","bo_bed_e", spr_sleep_triggers()),
  ("fw_sleep_bed_f",spr_use_time(1),"bed_f","bo_bed_f", spr_sleep_triggers()),
  ("fw_sleep_dungeon_bed_a",spr_use_time(1),"dungeon_bed_a","bo_bed_b", spr_sleep_triggers()),
  ("fw_sleep_dungeon_bed_b",spr_use_time(1),"dungeon_bed_b","bo_dungeon_bed_b", spr_sleep_triggers()),
  ("fw_sleep_pillow_a",spr_use_time(1),"pillow_a","bo_pillow", spr_sleep_triggers()),
  ("fw_sleep_pillow_b",spr_use_time(1),"pillow_b","bo_pillow", spr_sleep_triggers()),
  
  ##Fire Arrows
  
  ("code_pitch_pile",0,"pitch_pile",0, [(ti_on_scene_prop_init,[(store_trigger_param_1, ":instance_id"),(scene_prop_set_hit_points, ":instance_id", 100),]),]),
  ("brazier_with_fire",spr_use_time(2),"brazier","bo_brazier",spr_fire_item()),
  
  ##Fire Arrows - End
  
  ##Culture
  
  ("fw_culture_swadian",spr_use_time(30),"book_a","bo_pw_weapon_small", spr_culture_triggers(culture=culture_swadian)),
  ("fw_culture_rhodok",spr_use_time(30),"book_b","bo_pw_weapon_small", spr_culture_triggers(culture=culture_rhodok)),
  ("fw_culture_nord",spr_use_time(30),"book_c","bo_pw_weapon_small", spr_culture_triggers(culture=culture_nord)),
  ("fw_culture_sarranid",spr_use_time(30),"book_d","bo_pw_weapon_small", spr_culture_triggers(culture=culture_sarranid)),
  ("fw_culture_vaegir",spr_use_time(30),"book_e","bo_pw_weapon_small", spr_culture_triggers(culture=culture_vaegir)),
  ("fw_culture_khergit",spr_use_time(30),"book_f","bo_pw_weapon_small", spr_culture_triggers(culture=culture_khergit)),
  ...
  #New Caves
  ("cave_system_a",0,"cave_system_a","bo_cave_system_a", []),
  
  #New props
  ("church_chair",0,"church_chair","bo_church_chair", []),
  
  #New Castle Props
  ("dungeon_a_o",0,"dungeon_a_o","bo_dungeon_a_o", []),
  ("castle_bridge",0,"castle_bridge","bo_castle_bridge", []),
  ("city_wall_a",0,"city_wall_a","bo_city_wall_a", []),
  ("bridge_modular_c",0,"bridge_modular_c","bo_bridge_modular_c", []),
  ("citygate_a",0,"citygate_a","bo_citygate_a", []),
  ("citygate_b",0,"citygate_b","bo_citygate_b", []),
  ("small_wall_e_open",0,"small_wall_e_open","bo_small_wall_e_open", []),
  ("bridge_modular_d",0,"bridge_modular_d","bo_bridge_modular_d", []),
  ("stone_pier",0,"stone_pier","bo_stone_pier", []),
  
  #New Buildings
  ("blacksmith_house",0,"blacksmith_house","bo_blacksmith_house", []),
  ("church_b",0,"fw_church","bo_fw_church", []),
  ("town_house_y_open",0,"town_house_y_open","bo_town_house_y_open", []),
  ("castle_h_house_c_open",0,"castle_h_house_c_open","bo_castle_h_house_c_open", []),
  ("wood_stairs",0,"wood_stairs",0, []),
  
  ("market_shop_part",0,"market_shop_part","bo_market_shop_part", []),
  ("market_cover",0,"market_cover","bo_market_cover", []),
  ("market_shop_big",0,"market_shop_big","bo_market_shop_big", []),
  ("stable_wooden_big",0,"stable_wooden_big","bo_stable_wooden_big", []),
  ("stable_wooden_small",0,"stable_wooden_small","bo_stable_wooden_small", []),
