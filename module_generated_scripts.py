...
def generate_initialize_item_slots():
  ...
  for animal in herd_animal_list:
    adult_item_id, child_item_id, alpha_item_id, grow_age, max_in_herd, alpha_chance, attack_reaction, death_sound, meat, hide, wildness = animal
    script_body.extend([
      ...
      (item_set_slot, adult_item_id, slot_item_animal_alpha_item_id, alpha_item_id),
      (item_set_slot, child_item_id, slot_item_animal_alpha_item_id, alpha_item_id),
      ...
      (item_set_slot, adult_item_id, slot_item_animal_alpha_chance, alpha_chance),
      (item_set_slot, child_item_id, slot_item_animal_alpha_chance, alpha_chance),
