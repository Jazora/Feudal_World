...
scripts.extend([
  ...
  ("game_get_use_string", # clients: called by the game when the local player is aiming at a usable scene prop
   [(store_script_param, ":instance_id", 1),
    ...
    #Get Mannequin slots
    (prop_instance_get_scene_prop_kind, ":get_type", ":instance_id"),
    (try_begin),
      (is_between,":get_type","spr_code_mannequin_head","spr_code_mannequin_end"),
      (multiplayer_send_2_int_to_server, client_event_request_scene_prop_slot, ":instance_id", slot_scene_prop_item_id),
      (multiplayer_send_2_int_to_server, client_event_request_scene_prop_slot, ":instance_id", slot_scene_prop_average_craft_skill),
      (multiplayer_send_2_int_to_server, client_event_request_scene_prop_slot, ":instance_id", slot_scene_prop_resources_default_cost),
    (try_end),
    ...
    (try_begin), # if the targeted prop is an item stockpile
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (store_skill_level, ":trade", "skl_trade", ":my_troop_id"),
          (try_begin),
            (ge, ":trade", 1),#Increase selling price for merchants
            
            (assign,":percentage",":trade"),
            (val_mul,":percentage",trade_skill_percentage),
            
            (assign,":value",":gold_multiplier"),
            (val_mul,":value",":percentage"),
            (val_div,":value",100),
            (val_add, ":gold_multiplier",":value"),
          (try_end),
        (else_try),
          (eq, ":use_string", "str_import"),
          (player_get_troop_id, ":my_troop_id", ":my_player_id"),
          (store_skill_level, ":trade", "skl_trade", ":my_troop_id"),
          (try_begin),
            (ge, ":trade", 1),#Decrease buying price for merchants
    ...
    (else_try), # if the targeted prop is a training station, display all the stats
      ...
      #New Lord types
      (try_begin),#New lord type from the database
        (eq,":troop_id","trp_lord"),
        (player_slot_ge, ":player_id", slot_player_is_lord_type, valid_lord_type_start),
        (player_get_slot, ":new_lord_type", ":player_id", slot_player_is_lord_type),
        (assign,":troop_id",":new_lord_type"),
      (try_end),
      #New Lord types
      #Culture Troop Types
      (call_script, "script_scene_prop_get_owning_faction", ":instance_id"),
      (assign, ":faction_id", reg0),
      (multiplayer_send_2_int_to_server, client_event_request_faction_slot, ":faction_id", slot_faction_culture),
      (try_begin),
        (ge,":faction_id",castle_factions_begin),
        (faction_get_slot, ":culture", ":faction_id", slot_faction_culture),
        (try_begin),
          (eq, ":culture", culture_swadian),
          (try_begin),
            (troop_slot_ge, ":troop_id", slot_troop_has_culture_swadian, playable_troops_begin),
            (troop_get_slot, ":culture_troop_id", ":troop_id", slot_troop_has_culture_swadian),
            (assign,":troop_id",":culture_troop_id"),
          (try_end),
        (else_try),
          (eq, ":culture", culture_rhodok),
          (try_begin),
            (troop_slot_ge, ":troop_id", slot_troop_has_culture_rhodok, playable_troops_begin),
            (troop_get_slot, ":culture_troop_id", ":troop_id", slot_troop_has_culture_rhodok),
            (assign,":troop_id",":culture_troop_id"),
          (try_end),
        (else_try),
          (eq, ":culture", culture_nord),
          (try_begin),
            (troop_slot_ge, ":troop_id", slot_troop_has_culture_nord, playable_troops_begin),
            (troop_get_slot, ":culture_troop_id", ":troop_id", slot_troop_has_culture_nord),
            (assign,":troop_id",":culture_troop_id"),
          (try_end),
        (else_try),
          (eq, ":culture", culture_sarranid),
          (try_begin),
            (troop_slot_ge, ":troop_id", slot_troop_has_culture_sarranid, playable_troops_begin),
            (troop_get_slot, ":culture_troop_id", ":troop_id", slot_troop_has_culture_sarranid),
            (assign,":troop_id",":culture_troop_id"),
          (try_end),
        (else_try),
          (eq, ":culture", culture_vaegir),
          (try_begin),
            (troop_slot_ge, ":troop_id", slot_troop_has_culture_vaegir, playable_troops_begin),
            (troop_get_slot, ":culture_troop_id", ":troop_id", slot_troop_has_culture_vaegir),
            (assign,":troop_id",":culture_troop_id"),
          (try_end),
        (else_try),
          (eq, ":culture", culture_khergit),
          (try_begin),
            (troop_slot_ge, ":troop_id", slot_troop_has_culture_khergit, playable_troops_begin),
            (troop_get_slot, ":culture_troop_id", ":troop_id", slot_troop_has_culture_khergit),
            (assign,":troop_id",":culture_troop_id"),
          (try_end),
        (else_try),
          (eq, ":culture", culture_townwatch),
          (try_begin),
            (troop_slot_ge, ":troop_id", slot_troop_has_culture_townwatch, playable_troops_begin),
            (troop_get_slot, ":culture_troop_id", ":troop_id", slot_troop_has_culture_townwatch),
            (assign,":troop_id",":culture_troop_id"),
          (try_end),
        (try_end),
      (else_try),
        (player_get_slot, ":culture", ":player_id", slot_player_culture),
        (try_begin),
          (eq, ":culture", culture_swadian),
          (try_begin),
            (troop_slot_ge, ":troop_id", slot_troop_has_culture_swadian, playable_troops_begin),
    ...
    (else_try), # Bank money chests
      (eq, ":use_string", "str_bank_gold_reg2"),
      
      (multiplayer_get_my_player, ":player_id"),
      
      (player_get_slot, ":gold", ":player_id", slot_player_bank_amount),
      
      (assign,reg2,":gold"),
      
      (str_store_string, s0, ":use_string"),
      
    (else_try), # Bank stables
      (eq, ":use_string", "str_bank_stable"),
      
      (multiplayer_get_my_player, ":player_id"),
      (try_begin),
        (player_slot_ge, ":player_id", slot_player_stable, 1),
        (assign,":use_string","str_bank_stable_2"),
      (try_end),
      (str_store_string, s0, ":use_string"),
      
    (else_try), # for market stalls to update info
      (this_or_next|eq, ":use_string", "str_buy_market_property_s1"),
      (eq, ":use_string", "str_owned_market_property_s1"),
      
      (scene_prop_get_slot, ":price", ":instance_id", slot_scene_prop_gold_value),
      
      (assign,reg3,":price"),
    
      (assign,":use_string","str_buy_market_property_s1"),
      
      (call_script, "script_market_get_owner", ":instance_id"),
      (try_begin),
        (eq,reg20,1),
        (assign,":use_string","str_owned_market_property_s1"),
      (try_end),
      
      (str_store_string, s0, ":use_string"),
    
    (else_try), # for culture changing props
      (eq, ":use_string", "str_change_culture"),
      
      (multiplayer_get_my_player, ":player_id"),
      
      (scene_prop_get_slot, ":culture", ":instance_id", slot_scene_prop_item_slot_1),
      (player_get_slot, ":player_culture", ":player_id", slot_player_culture),
      ...
      (assign,reg2,culture_change_price),
      
      (str_store_string, s0, ":use_string"),
      
      (try_begin),
        (eq,":player_culture",":culture"),
        (str_store_string,s0,"str_prop_already_culture"),
      (try_end),
    
    (else_try), # for alchemy mixing bowl item names
      (eq, ":use_string", "str_alchemy_mixing_bowl"),
      
      (multiplayer_send_2_int_to_server, client_event_request_scene_prop_slot, ":instance_id", slot_scene_prop_item_slot_1),
      (multiplayer_send_2_int_to_server, client_event_request_scene_prop_slot, ":instance_id", slot_scene_prop_item_slot_2),
      (multiplayer_send_2_int_to_server, client_event_request_scene_prop_slot, ":instance_id", slot_scene_prop_item_slot_3),
      
      (scene_prop_get_slot, ":item_1", ":instance_id", slot_scene_prop_item_slot_1),
      (scene_prop_get_slot, ":item_2", ":instance_id", slot_scene_prop_item_slot_2),
      (scene_prop_get_slot, ":item_3", ":instance_id", slot_scene_prop_item_slot_3),
      
      (try_begin),
        (neq,":item_1",0),
        (str_store_item_name,s20,":item_1"),
      (else_try),
        (str_store_string,s20,"str_na"),
      (else_try),
      ...
      (try_begin),
        (neq,":item_2",0),
        (str_store_item_name,s21,":item_2"),
      (else_try),
        (str_store_string,s21,"str_na"),
      (try_end),
      
      (try_begin),
        (neq,":item_3",0),
        (str_store_item_name,s22,":item_3"),
      (else_try),
        (str_store_string,s22,"str_na"),
      (try_end),
      
      (assign,":use_string","str_alchemy_mixing_bowl"),
      
      (str_store_string, s0, ":use_string"),
      
    (else_try), # for the weapon stand prop
      (eq, ":use_string", "str_weapon_stand"),
      ...
      (assign,":use_string","str_weapon_stand"),
      
      (str_store_string, s0, ":use_string"),
      
    (else_try), # for metalworks forge
      (eq, ":use_string", "str_forge_metal"),
      ...
      (assign,":use_string","str_forge_metal"),
  ...
  ("game_receive_url_response", # called by the game when a response is received from a web server, if used
   [(store_script_param, ":integer_count", 1),
    (store_script_param, ":string_count", 2),#Currently no strings being used.
    (assign, "$g_name_server_enabled", 1),
    (try_begin),
      (eq,":string_count",0),
      (try_begin),
        (eq, ":integer_count", 1),#Receive only 1 value so must be an error message.
        (assign, ":return_code", reg0),
        (try_begin),
          (eq,":return_code",-3),#Critical Error
            (server_add_message_to_log, "str_name_server_error_code_reg0"),
        (else_try),
          (eq,":return_code",-2),#Critical Error
            (server_add_message_to_log, "str_name_server_error_code_reg0"),
        (try_end),
      (else_try),#Karma/warnings
        (eq, ":integer_count", 3),
        ...
        (try_begin),
          (ge,reg2,3), # ban player for gaining the max warnings
            (ban_player, ":player_id", 0, ":player_id"),
        (else_try),# warn the player of bad behaviour
          (multiplayer_send_4_int_to_player, ":player_id", server_event_preset_message, "str_warning_player_message", preset_message_player|preset_message_chat_log|preset_message_red, ":player_id",reg2),
        (try_end),
      (else_try),#Gold/Bank
        (eq, ":integer_count", 6),
        (assign, ":unique_id", reg1),
        ...
        (player_get_unique_id, ":player_unique_id", ":player_id"),
        (eq, ":player_unique_id", ":unique_id"),
        (player_set_slot, ":player_id", slot_player_profile_loaded, 1),# This is for not sending a update to players gold until they are ingame. Its also used for setting a players position on spawn.
        
        #Gold
        (call_script, "script_player_adjust_gold_silent", ":player_id", reg2, 0),
        
        (player_set_slot, ":player_id", slot_player_bank_amount, reg4),
        (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_bank_amount, reg4),
        (multiplayer_send_4_int_to_player, ":player_id", server_event_preset_message, "str_database_loaded", preset_message_player|preset_message_chat_log|preset_message_yellow, ":player_id",":player_unique_id"),
        (call_script, "script_cf_player_load_data_url_2", ":player_id"),
      (else_try),
        (eq, ":integer_count", 5),#legendary chance
        ...
        (prop_instance_get_scene_prop_kind, ":kind", reg1),
        (eq,":kind",reg2),
        (try_begin),
          (eq,reg4,0),
          (call_script, "script_cf_equip_wield_item", ":agent_id", reg3),
          (call_script, "script_remove_scene_prop", reg1,reg2),
          (get_max_players, ":max_players"),
          (try_for_range, ":player_id", 1, ":max_players"),
            (player_is_active, ":player_id"),
            (multiplayer_send_2_int_to_player, ":player_id", server_event_player_announce_message, reg0, "str_pulled_weapon"),
          (try_end),
        (try_end),
      (else_try),
        (eq, ":integer_count", 22),#Admin permissions
          (assign, ":unique_id", reg0),
          (assign, ":player_id", reg21),
          (player_is_active, ":player_id"),
          (player_get_unique_id, ":player_unique_id", ":player_id"),
          (eq, ":player_unique_id", ":unique_id"),
          
          (player_set_slot, ":player_id", slot_player_admin_no_panel, reg1),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_panel, reg1),
          (player_set_slot, ":player_id", slot_player_admin_no_gold, reg2),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_gold, reg2),
          (player_set_slot, ":player_id", slot_player_admin_no_kick, reg3),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_kick, reg3),
          (player_set_slot, ":player_id", slot_player_admin_no_temporary_ban, reg4),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_temporary_ban, reg4),
          (player_set_slot, ":player_id", slot_player_admin_no_permanent_ban, reg5),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_permanent_ban, reg5),
          (player_set_slot, ":player_id", slot_player_admin_no_kill_fade, reg6),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_kill_fade, reg6),
          (player_set_slot, ":player_id", slot_player_admin_no_freeze, reg7),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_freeze, reg7),
          (player_set_slot, ":player_id", slot_player_admin_no_teleport_self, reg8),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_teleport_self, reg8),
          (player_set_slot, ":player_id", slot_player_admin_no_admin_items, reg9),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_admin_items, reg9),
          (player_set_slot, ":player_id", slot_player_admin_no_heal_self, reg10),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_heal_self, reg10),
          (player_set_slot, ":player_id", slot_player_admin_no_godlike_troop, reg11),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_godlike_troop, reg11),
          (player_set_slot, ":player_id", slot_player_admin_no_event_troop, reg12),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_event_troop, reg12),
          (player_set_slot, ":player_id", slot_player_admin_no_guide_troop, reg13),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_guide_troop, reg13),
          (player_set_slot, ":player_id", slot_player_admin_no_ships, reg14),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_ships, reg14),
          (player_set_slot, ":player_id", slot_player_admin_no_announce, reg15),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_announce, reg15),
          (player_set_slot, ":player_id", slot_player_admin_no_override_poll, reg16),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_override_poll, reg16),
          (player_set_slot, ":player_id", slot_player_admin_no_all_items, reg17),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_all_items, reg17),
          (player_set_slot, ":player_id", slot_player_admin_no_mute, reg18),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_mute, reg18),
          (player_set_slot, ":player_id", slot_player_admin_no_animals, reg19),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_animals, reg19),
          (player_set_slot, ":player_id", slot_player_admin_no_factions, reg20),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_factions, reg20),
      (else_try),
        (eq, ":integer_count", 10),#Set player his stored inventory
          (assign, ":unique_id", reg0),
          ...
          (try_begin),#Head
            (gt,reg1,0),
              (item_get_type, ":item_type", reg1),
              (eq,":item_type",itp_type_head_armor),
              (call_script, "script_cf_change_armor", ":agent_id", reg1),
          (try_end),
          (try_begin),#Chest
            (gt,reg2,0),
              (item_get_type, ":item_type", reg2),
              (eq,":item_type",itp_type_body_armor),
              (call_script, "script_cf_change_armor", ":agent_id", reg2),
          (try_end),
          (try_begin),#Gloves
            (gt,reg3,0),
              (item_get_type, ":item_type", reg3),
              (eq,":item_type",itp_type_hand_armor),
              (call_script, "script_cf_change_armor", ":agent_id", reg3),
          (try_end),
          (try_begin),#Boots
            (gt,reg4,0),
              (item_get_type, ":item_type", reg4),
              (eq,":item_type",itp_type_foot_armor),
              (call_script, "script_cf_change_armor", ":agent_id", reg4),
          (try_end),
          ...
          (try_begin),#IV1
            (gt,reg5,0),
              (agent_equip_item, ":agent_id", reg5),
          (try_end),
          (try_begin),#IV2
            (gt,reg6,0),
              (agent_equip_item, ":agent_id", reg6),
          (try_end),
          (try_begin),#IV3
            (gt,reg7,0),
              (agent_equip_item, ":agent_id", reg7),
          (try_end),
          (try_begin),#IV4
            (gt,reg8,0),
              (agent_equip_item, ":agent_id", reg8),
          (try_end),
          
          #(player_set_slot, ":player_id", slot_player_stored_inventory, 0),
          #(multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_stored_inventory, 0),
      (else_try),
        (eq, ":integer_count", 4),#Random Herb Setup
          (prop_instance_is_valid, reg0),
          (prop_instance_get_scene_prop_kind, ":type", reg0),
          (is_between, ":type", "spr_pw_tree_a1", "spr_pw_tree_trunk_a"),
          
          (assign,":has_herb",reg1),

          (le,":has_herb",30),

          (prop_instance_get_position, pos0, reg0),
          (store_random_in_range, ":rotation", 0, 360),
          (position_rotate_z, pos0, ":rotation"),
          
          
          (store_mul, ":negative_range", reg3, 5),
          (store_random_in_range, ":offset", ":negative_range", reg3),
          (position_move_x, pos0, ":offset"),
          (store_random_in_range, ":offset", ":negative_range", reg3),
          (position_move_y, pos0, ":offset"),
          
          (assign,":herb_id",reg2),
          (set_spawn_position, pos0),
          (spawn_scene_prop, ":herb_id"),
      (else_try),
        (eq, ":integer_count", 7),#Mannequins data
        (prop_instance_is_valid, reg6),
        (prop_instance_get_scene_prop_kind, ":type", reg6),
        (is_between, ":type", "spr_code_mannequin_head", "spr_code_mannequin_end"),
        
        (try_begin),
          (eq,reg0,0),
            (scene_prop_set_slot, reg6, slot_scene_prop_item_id, -1),
        (else_try),
          (scene_prop_set_slot, reg6, slot_scene_prop_item_id, reg0),
          
          (scene_prop_set_slot, reg6, slot_scene_prop_average_craft_skill, reg1),
          
          (store_item_value,":ig1",reg2),
          (store_item_value,":ig2",reg3),
          (store_item_value,":ig3",reg4),
          (store_item_value,":ig4",reg5),
          (val_add,":ig1",":ig2"),
          (val_add,":ig1",":ig3"),
          (val_add,":ig1",":ig4"),
          (scene_prop_set_slot, reg6, slot_scene_prop_resources_default_cost, ":ig1"),
        (try_end),
      (else_try),#Mannequin craft data
        (eq, ":integer_count", 8),
        (prop_instance_is_valid, reg5),
        (prop_instance_get_scene_prop_kind, ":type", reg5),
        (is_between, ":type", "spr_code_mannequin_head", "spr_code_mannequin_end"),
        (player_is_active, reg6),
        (player_get_agent_id,":agent_id",reg6),
        (agent_is_active,":agent_id"),
        (call_script, "script_cf_mannequin_craft_stockpile", ":agent_id", reg5,reg0,reg1,reg2,reg3,reg4),
      (try_end),
    (else_try),
      (eq,":string_count",1),
      (try_begin),
        (eq, ":integer_count", 4),#New account
          (assign, ":unique_id", reg0),
          (assign, ":player_id", reg3),
          (player_is_active, ":player_id"),
          (player_get_unique_id, ":player_unique_id", ":player_id"),
          (eq, ":player_unique_id", ":unique_id"),
          (player_set_slot, ":player_id", slot_player_bank_amount, reg1),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_bank_amount, reg1),
          ...
          (multiplayer_send_4_int_to_player, ":player_id", server_event_preset_message, "str_database_created", preset_message_player|preset_message_chat_log|preset_message_yellow, ":player_id", ":player_unique_id"),
          (multiplayer_send_4_int_to_player, ":player_id", server_event_preset_message, "str_database_loaded", preset_message_player|preset_message_chat_log|preset_message_yellow, ":player_id",":player_unique_id"),
      (else_try),
        (eq, ":integer_count", 7),#Teleport player to last position and shackle if they was shackled
          (assign, ":unique_id", reg0),
          (assign, ":player_id", reg6),
          (player_is_active, ":player_id"),
          (player_get_unique_id, ":player_unique_id", ":player_id"),
          (eq, ":player_unique_id", ":unique_id"),
          (player_get_agent_id, ":agent_id", ":player_id"),
          (assign,":last_scene",reg1),
          (assign,":x",reg2),
          (assign,":y",reg3),
          (assign,":z",reg4),
          (assign,":shackled",reg5),
          (try_begin),
            (ge,":shackled",1),
            (agent_set_slot,":agent_id", slot_agent_shackled, ":shackled"),
            (agent_set_speed_modifier, ":agent_id", 85),
          (try_end),
          (assign,":fail",0),
          (try_begin),
            (eq,":x",0),
      ...
      (else_try),#Faction
        (eq, ":integer_count", 8),
          (assign, ":unique_id", reg0),
          (assign, ":player_id", reg7),
          (player_is_active, ":player_id"),
          (player_get_unique_id, ":player_unique_id", ":player_id"),
          (eq, ":player_unique_id", ":unique_id"),
          
          #(player_set_slot, ":player_id", slot_player_townwatch, reg1),
          #(multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_townwatch, reg1),

          #Faction
          (try_begin),
            (call_script, "script_cf_can_change_faction", ":player_id", reg3),
            (call_script, "script_change_faction", ":player_id", reg3, change_faction_type_no_respawn),
          (try_end),
          #Faction - End
          ...
          (try_begin),
            (gt,reg2,0),
            (call_script, "script_player_change_check_outlaw_rating", ":player_id", reg2, 1),
          (try_end),
          
          #Lords
          (player_set_slot, ":player_id", slot_player_is_lord_whitelisted, reg4),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_is_lord_whitelisted, reg4),
          (player_set_slot, ":player_id", slot_player_is_lord_type, reg5),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_is_lord_type, reg5),
          (player_set_slot, ":player_id", slot_player_banner_id, reg6),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_banner_id, reg6),
          (multiplayer_send_4_int_to_player, ":player_id", server_event_preset_message, "str_database_faction_loaded", preset_message_player|preset_message_chat_log|preset_message_yellow, ":player_id",":player_unique_id"),
          (call_script, "script_cf_player_load_data_url_3", ":player_id"),
      (else_try),#Misc
        (eq, ":integer_count", 5),
          (assign, ":unique_id", reg0),
          (assign, ":player_id", reg4),
          (player_is_active, ":player_id"),
          (player_get_unique_id, ":player_unique_id", ":player_id"),
          (eq, ":player_unique_id", ":unique_id"),
        
          #Inventory
          #(player_set_slot, ":player_id", slot_player_stored_inventory, reg1),
          #(multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_stored_inventory, reg1),
          
          #Culture
          (player_set_slot, ":player_id", slot_player_culture, reg2),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_culture, reg2),
          
          #Troop type
          (assign,":troop_id",reg3),
          (try_begin),
            (neg|is_between, ":troop_id", playable_troops_begin, saved_troops_end),
            (assign, ":troop_id", playable_troops_begin),
          (try_end),
          ...
          (try_begin),
            (gt,":upkeep_price",0),
            (multiplayer_send_3_int_to_player, ":player_id", server_event_preset_message, "str_upkeep_money_info", preset_message_chat_log|preset_message_red, ":upkeep_price"),
          (try_end),
          #Upkeep - End
          (multiplayer_send_4_int_to_player, ":player_id", server_event_preset_message, "str_database_misc_loaded", preset_message_player|preset_message_chat_log|preset_message_yellow, ":player_id",":player_unique_id"),
          (multiplayer_send_4_int_to_player, ":player_id", server_event_preset_message, "str_database_fully_loaded", preset_message_player|preset_message_chat_log|preset_message_yellow, ":player_id",":player_unique_id"),
      (else_try),#Horse
        (eq, ":integer_count", 6),
          (assign, ":unique_id", reg0),
          (assign, ":player_id", reg5),
          ...
          #Stable
          (player_set_slot, ":player_id", slot_player_stable, reg1),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_stable, reg1),
          (player_set_slot, ":player_id", slot_player_stable_health, reg2),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_stable_health, reg2),
      (else_try),#Crafting Recipees
        (eq, ":integer_count", 9),
          (assign, ":player_id", reg2),
          (player_is_active, ":player_id"),
          (assign, ":instance_id", reg3),
          (prop_instance_is_valid, ":instance_id"),
          (prop_instance_get_scene_prop_kind, ":prop", ":instance_id"),
          (player_get_agent_id, ":agent_id", ":player_id"),
          (try_begin),
            (eq,reg8,0), # is it weapon crafting
            (eq,":prop","spr_fw_metalworks_weapon_stand"),
            (try_begin),
              (eq,reg7,0),# did it fail
                (try_begin),
                  (call_script, "script_cf_try_produce_weapon", ":agent_id", ":instance_id", reg1, reg4, reg5, reg6),
                    (call_script, "script_cf_produce_weapon", ":instance_id", reg0),
                (else_try),
                  (call_script, "script_cf_process_weapon_fail", ":instance_id", ":agent_id"),
                (try_end),
            (else_try),
              (call_script, "script_cf_process_weapon_fail", ":instance_id", ":agent_id"),
            (try_end),
          (else_try),
            (eq,reg8,1), # is it alchemy
            (eq,":prop","spr_fw_alchemy_mixing_bowl"),
            (prop_instance_get_position, pos2, ":instance_id"),
            (try_begin),
              (eq,reg7,0),# did it fail
                (try_begin),
                  (call_script, "script_cf_alchemy_try_produce_potion", ":agent_id", ":instance_id", reg1, reg0, reg4, reg5, reg6),
                    (call_script, "script_spawn_processed_resources", ":agent_id", reg0, 1),
                    (particle_system_burst, "psys_cooking_smoke", pos2, 10),
                (else_try),
                  (particle_system_burst, "psys_cooking_fire_1", pos2, 25),
                (try_end),
            (else_try),
              (particle_system_burst, "psys_cooking_fire_1", pos2, 25),
            (try_end),
    ...
    (else_try),
      (eq,":string_count",2),
      (try_begin),#Faction Data
        (eq, ":integer_count", 4),
        (assign,":culture",reg0),
        (assign,":banner_id",reg1),
        (assign,":faction_id",reg2),
        (assign,":lord_player_id",reg3),
        
        (player_is_active,":lord_player_id"),
        (player_get_unique_id, ":unique_id", ":lord_player_id"),
        (faction_slot_eq, ":faction_id", slot_faction_lord_player_uid, ":unique_id"),
        
        (try_begin),
          (is_between, ":banner_id", banner_meshes_begin, banner_meshes_end),
          ...
          (try_for_range, ":other_faction_id", factions_begin, ":loop_end"), # ensure that the banner is not currently in use by another faction
            (neq,":faction_id",":other_faction_id"), # ensure we dont count our faction into the check
            (faction_slot_eq, ":other_faction_id", slot_faction_banner_mesh, ":banner_id"),
            (faction_slot_eq, ":other_faction_id", slot_faction_is_active, 1),
            (assign, ":loop_end", -1),
            (multiplayer_send_3_int_to_player, ":lord_player_id", server_event_preset_message, "str_banner_used_by_s1", preset_message_faction|preset_message_fail_sound, ":other_faction_id"),
          (try_end),
          (neq, ":loop_end", -1),
          (faction_set_name, ":faction_id", s1),
          (faction_set_slot, ":faction_id", slot_faction_name_is_custom, 1),
          (faction_set_slot, ":faction_id", slot_faction_banner_mesh, ":banner_id"),
          (faction_set_slot, ":faction_id", slot_faction_culture, ":culture"),
          (get_max_players, ":max_players"),
          (try_for_range, ":player_id", 1, ":max_players"),
            (player_is_active, ":player_id"),
            ...
            (multiplayer_send_string_to_player, ":player_id", server_event_faction_set_name, s1),
            (multiplayer_send_3_int_to_player, ":player_id", server_event_faction_set_slot, ":faction_id", slot_faction_banner_mesh, ":banner_id"),
            (multiplayer_send_3_int_to_player, ":player_id", server_event_faction_set_slot, ":faction_id", slot_faction_culture, ":culture"), # Doesnt seem to work this way
          (try_end),
          (call_script, "script_redraw_castle_banners", redraw_faction_banners, ":faction_id"),
          (call_script, "script_cf_update_mannequins", ":faction_id"),
        (try_end),
      (try_end),
    (try_end),
    ]),
    ...
    (try_begin), # section of events received by clients from the server
      ...
      (else_try), # set a player slot on the client, from the server
        ...
        (try_begin),
          ...
          (try_begin), # if the player's faction is changed, reset other related slots
            ...
            (player_set_slot, ":player_id", slot_player_is_steward, 0),
          ...
          (else_try),
            (eq, ":slot_no", slot_player_is_steward),
            (eq, ":value", 1),
            ...
            (try_for_range, ":other_player_id", 1, ":max_players"), # remove the status of any previous lord of the faction
              ...
              (player_set_slot, ":other_player_id", slot_player_is_steward, 0),
            (try_end),
            ...
            (try_end),
          (else_try),
            (eq, ":slot_no", slot_player_is_marshal),
            (eq, ":value", 1),
            (player_get_slot, ":faction_id", ":player_id", slot_player_faction_id),
            (get_max_players, ":max_players"),
            (try_for_range, ":other_player_id", 1, ":max_players"), # remove the status of any previous lord of the faction
              ...
              (player_is_active, ":other_player_id"),
              (player_slot_eq, ":other_player_id", slot_player_faction_id, ":faction_id"),
              (player_set_slot, ":other_player_id", slot_player_is_marshal, 0),
            (try_end),
            (try_begin), # if the local player is now lord of their faction, set various slots that have already been set on the server
              (eq, ":player_id", ":my_player_id"),
              (player_set_slot, ":my_player_id", slot_player_has_faction_door_key, 1),
      ...
      (else_try), # set a faction slot on the client, from the server
        ...
        (try_begin),
          ...
          (else_try), # this is too ensure we dont call stuff bellow
            (eq, ":slot_no", slot_faction_culture),
          (else_try),
      ...
      (else_try), # display whispering in local chat
        (eq, ":event_type", server_event_whisper_chat),
        (neg|str_is_empty, s0),
        (display_message, s0, local_chat_color_whisper),
        (call_script, "script_chat_overlay_add_to_local_buffer", local_chat_color_whisper),
      ...
      (else_try),
        ...
        (try_end),
      (else_try),
        (eq, ":event_type", server_event_update_scene_prop_update_physics),
        (store_script_param, ":instance_id", 3),
        (store_script_param, ":physics", 4),
        (try_begin),
          (prop_instance_is_valid, ":instance_id"),
          (prop_instance_enable_physics, ":instance_id", ":physics"),
        (try_end),
      (else_try),
        ...
        (try_end),
      (else_try),
        (eq, ":event_type", server_event_player_advanced_lord_announce),
        (store_script_param, ":sent_player_id", 3),
        (store_script_param, ":faction_id", 4),
        (player_is_active, ":sent_player_id"),
        (eq, "$g_preset_message_display_enabled", 1),
        (str_store_player_username, s10, ":sent_player_id"),
        (player_get_troop_id, ":new_troop_id", ":sent_player_id"),
        (str_store_troop_name,s3,":new_troop_id"),
        (multiplayer_get_my_player, ":my_player_no"),
        (try_begin),
          (eq,":player_id",":my_player_no"),
          (call_script, "script_preset_message", "str_now_s3_of_s1", preset_message_faction|preset_message_log|preset_message_big, ":faction_id", 0),
        (else_try),# Let everyone know whos boss
          (call_script, "script_preset_message", "str_s10_now_s3_of_s1_hail", preset_message_faction|preset_message_log|preset_message_big, ":faction_id", 0),
        (try_end),
      (else_try),
        (eq, ":event_type", server_event_player_announce_message),
        (store_script_param, ":sent_player_id", 3),
        (store_script_param, ":message", 4),
        (player_is_active, ":sent_player_id"),
        (eq, "$g_preset_message_display_enabled", 1),
        (call_script, "script_preset_message", ":message", preset_message_white|preset_message_log|preset_message_big|preset_message_player, ":sent_player_id", 0),
      (else_try),
        (eq, ":event_type", server_event_player_minor_lord_announce),
        (store_script_param, ":sent_player_id", 3),
        (store_script_param, ":faction_id", 4),
        (store_script_param, ":troop", 5),
        (store_script_param, ":denounce", 6),
        (player_is_active, ":sent_player_id"),
        (str_store_player_username, s10, ":sent_player_id"),
        (str_store_troop_name,s3,":troop"),
        (try_begin),
          (eq,":denounce",1),
          (call_script, "script_preset_message", "str_removed_s3_of_s1", preset_message_faction|preset_message_log|preset_message_small, ":faction_id", 0),
        (else_try),
          (multiplayer_get_my_player, ":my_player_no"),
          (try_begin),
            (eq,":player_id",":my_player_no"),
            (call_script, "script_preset_message", "str_appointed_s3_of_s1", preset_message_faction|preset_message_log|preset_message_small, ":faction_id", 0),
          (else_try),# Let everyone know whos boss
            (call_script, "script_preset_message", "str_s10_now_s3_of_s1", preset_message_faction|preset_message_log|preset_message_small, ":faction_id", 0),
          (try_end),
        (try_end),
      (else_try),
        ...
        (try_end),
      (else_try),
        (eq, ":event_type", server_event_set_skybox),
        #(set_skybox, 2, 3),
        #(scene_set_day_time, 18),
        #(set_rain, 2 , 70),
        #(set_global_haze_amount, 91),
    ...
    (else_try), # section of events received by server from the clients
      ...
      (try_begin), # handle players requesting to attach a cart to themselves or a horse
        ...
        (try_begin),
          ...
          (try_end),
        (try_end),
      (else_try), # reply with the current whitelisted lords
        (eq, ":event_type", client_event_request_player_slot),
        (store_script_param, ":player_id", 3),
        (store_script_param, ":slot", 4),
        (try_begin),
          (player_is_active, ":player_id"),
          (player_get_slot, ":slot_value", ":sender_player_id", ":slot"),
          (multiplayer_send_3_int_to_player, ":sender_player_id", server_event_player_set_slot, ":player_id", ":slot", ":slot_value"),
        (try_end),
      ...
      (else_try), # transfer money between the player and a money chest
        ...
        (try_end),
      (else_try), # transfer money between the player and a money chest
        (eq, ":event_type", client_event_transfer_bank_gold),
        (try_begin),
          (neq, "$g_game_type", "mt_no_money"),
          (store_script_param, ":instance_id", 3),
          (store_script_param, ":gold_value", 4),
          (call_script, "script_cf_use_bank_money_chest", ":sender_player_id", ":instance_id", ":gold_value"),
        (try_end),
      ...
      (else_try), # chat string received from a client, from a range of event numbers to keep them in order
        ...
        (try_begin),
          ...
          (neg|str_is_empty, s0),
          (try_begin),
            (is_between, ":chat_event_type", chat_event_type_whisper, chat_event_type_local_shout + 1),
            (player_get_agent_id, ":agent_id", ":sender_player_id"),
            (gt, ":agent_id", -1),
            (agent_is_alive, ":agent_id"),
            ...
            (try_begin),
              ...
              (str_store_string, s0, "str_chat_shout"),
              (str_store_string, s0, "str_chat_rp_format"),
            (else_try),
              (eq, ":chat_event_type", chat_event_type_local),
              (str_store_string, s0, "str_chat_local"),
              (str_store_string, s0, "str_chat_rp_format"),
            (else_try),
              (eq, ":chat_event_type", chat_event_type_whisper),
              (str_store_string, s0, "str_chat_whisper"),
              (str_store_string, s0, "str_chat_rp_format"),
            (else_try),
            ...
            (else_try),
              (eq, ":chat_event_type", chat_event_type_whisper),
              (assign, ":max_sq_distance", sq(max_distance_whisper_chat)),
              (assign, ":ambient_sq_distance", sq(ambient_distance_whisper_chat)),
              (assign, ":server_event", server_event_whisper_chat),
            (else_try),
      ...
      (else_try), # requesting a spawn point or switching spectator status
        ...
        (try_begin), # positive values are spawn points
          ...
          (try_begin),
            ...
            (try_end),
            #Female end
            (player_set_troop_id, ":sender_player_id", ":troop_id"),
      ...
      (else_try), # handle accessing armor to loot from corpses
        ...
        (try_begin),
          ...
          #Loot protection
          (scene_prop_get_slot, ":owner_player_id", ":corpse_instance_id", slot_scene_prop_corpse_owner),
          (assign,":fail",0),
          (try_begin),
            (neq,":owner_player_id",":sender_player_id"),
            (assign,":fail",1),
            (store_mission_timer_a, ":can_loot"),
            (scene_prop_get_slot, ":loot_time", ":corpse_instance_id", slot_scene_prop_corpse_loot_timer),
            (try_begin),
              (ge,":can_loot",":loot_time"),
              (assign,":fail",0),
            (else_try),
              (val_sub,":loot_time",":can_loot"),
              (multiplayer_send_3_int_to_player, ":sender_player_id", server_event_preset_message, "str_protected_loot", preset_message_error, ":loot_time"),
            (try_end),
          (try_end),
          (eq,":fail",0),
          
          (call_script, "script_cf_use_inventory", ":agent_id", ":corpse_instance_id", 0),
          (player_get_unique_id, reg1, ":sender_player_id"),
          (str_store_player_username,s1,":sender_player_id"),
      ...
      (else_try), # handle player requests to reveal their money pouch to another player
        ...
        (try_begin),
          ...
          (agent_is_active, ":agent_id"),
          (agent_is_alive, ":agent_id"),
          (agent_get_position,pos1,":target_player_id"),
          
          (try_for_agents, ":target_agent_id"),# Deal damage to agents
            (agent_is_active,":target_agent_id"),
            (agent_is_alive,":target_agent_id"),
            (agent_get_position,pos2,":target_player_id"),
            (get_distance_between_positions,":distance",pos1,pos2),
            (le,":distance",50),# Is the agent close enough to see the money pouch
      ...
      (else_try), # reply with the faction slot information
        (eq, ":event_type", client_event_request_faction_slot),
        (store_script_param, ":faction_id", 3),
        (store_script_param, ":slot", 4),
        (faction_get_slot, ":value", ":faction_id", ":slot"),
        (multiplayer_send_3_int_to_player, ":sender_player_id", server_event_faction_set_slot, ":faction_id", ":slot", ":value"),
      (else_try), # reply with the scene prop slot information
        (eq, ":event_type", client_event_request_scene_prop_slot),
        (store_script_param, ":instance_id", 3),
        (store_script_param, ":slot", 4),
        (try_begin),
          (prop_instance_is_valid, ":instance_id"),
          (scene_prop_get_slot, ":value", ":instance_id", ":slot"),
          (multiplayer_send_3_int_to_player, ":sender_player_id", server_event_scene_prop_set_slot, ":instance_id", ":slot", ":value"),
        (try_end),
      (else_try), # toggle the players abillity to walk / this should make players able to walk visually
        ...
        (assign,":walk_speed",45),
        (try_begin),
          (eq,":athletics",10),
            (val_add,":walk_speed",20),
            (assign,":speed_mod",0),
        (else_try),
          (ge,":athletics",8),
            (assign,":athletics_mod",5),
            (val_mul,":athletics_mod",":athletics"),
            (assign,":speed_mod",":walk_speed"),
            (val_mod,":speed_mod",":athletics_mod"),
        (else_try),
          (ge,":athletics",5),
            (assign,":athletics_mod",4.5),
            (val_mul,":athletics_mod",":athletics"),
            (assign,":speed_mod",":walk_speed"),
            (val_mod,":speed_mod",":athletics_mod"),
        (else_try),
          (ge,":athletics",3),
            (assign,":athletics_mod",3),
            (val_mul,":athletics_mod",":athletics"),
            (assign,":speed_mod",":walk_speed"),
            (val_mod,":speed_mod",":athletics_mod"),
        (else_try),
          (eq,":athletics",0),
          (val_sub,":walk_speed",5),
          (assign,":speed_mod",0),
        (else_try),
          (assign,":speed_mod",0),
        (try_end),
        
        (val_add,":walk_speed",":speed_mod"),
        
        (agent_get_slot, ":speed", ":player_agent", slot_agent_move_speed_modifier),
        (agent_get_slot, ":walking", ":player_agent", slot_agent_walking),
        (try_begin),
          (eq,":walking",1),
          (agent_set_slot, ":player_agent", slot_agent_walking, 0),
        (else_try),
          (try_begin),
            (agent_slot_eq, ":player_agent", slot_agent_shackled, 1),
            (val_sub,":speed",15),
          (try_end),
          (val_sub,":speed",":walk_speed"),
          (agent_set_slot, ":player_agent", slot_agent_walking, 1),
        (try_end),
        (set_fixed_point_multiplier,100),
  ...
  ("initialize_game_rules", # set module default settings before loading the server configuration
   [
    ...
    (troop_set_slot, "trp_serf_female", slot_troop_ranking, 0),
    (troop_set_slot, "trp_peasant", slot_troop_ranking, 1),
    (troop_set_slot, "trp_peasant_female", slot_troop_ranking, 1),
    (troop_set_slot, "trp_beggar", slot_troop_ranking, 2),
    (troop_set_slot, "trp_militia", slot_troop_ranking, 2),
    (troop_set_slot, "trp_huntsman", slot_troop_ranking, 4),
    (troop_set_slot, "trp_ministrel", slot_troop_ranking, 4),
    (troop_set_slot, "trp_healer", slot_troop_ranking, 8),
    (troop_set_slot, "trp_monk", slot_troop_ranking, 8),
    (troop_set_slot, "trp_alchemist", slot_troop_ranking, 22),
    ...
    (troop_set_slot, "trp_raider", slot_troop_ranking, 12),
    (troop_set_slot, "trp_sea_raider", slot_troop_ranking, 14),
    (troop_set_slot, "trp_brigand", slot_troop_ranking, 14),
    (troop_set_slot, "trp_cultist", slot_troop_ranking, 14),
    (troop_set_slot, "trp_thief", slot_troop_ranking, 14),
    (troop_set_slot, "trp_hashashin", slot_troop_ranking, 14),
    (troop_set_slot, "trp_rebel", slot_troop_ranking, 19),
    (troop_set_slot, "trp_mercenary_hired_blade", slot_troop_ranking, 20),
    (troop_set_slot, "trp_mercenary_sword_sister", slot_troop_ranking, 20),
    (troop_set_slot, "trp_footman", slot_troop_ranking, 20),
    (troop_set_slot, "trp_slave", slot_troop_ranking, 20),
    (troop_set_slot, "trp_watchman", slot_troop_ranking, 20),
    (troop_set_slot, "trp_archer", slot_troop_ranking, 21),
    (troop_set_slot, "trp_marksman", slot_troop_ranking, 21),
    (troop_set_slot, "trp_mercenary_crossbowman", slot_troop_ranking, 22),
    (troop_set_slot, "trp_crossbowman", slot_troop_ranking, 22),
    (troop_set_slot, "trp_sharpshooter", slot_troop_ranking, 22),
    (troop_set_slot, "trp_lancer", slot_troop_ranking, 23),
    (troop_set_slot, "trp_horse_archer", slot_troop_ranking, 23),
    (troop_set_slot, "trp_mercenary_cavalry", slot_troop_ranking, 23),
    ...
    (troop_set_slot, "trp_merchant", slot_troop_ranking, 35),
    (troop_set_slot, "trp_blacksmith", slot_troop_ranking, 35),
    (troop_set_slot, "trp_armoursmith", slot_troop_ranking, 35),
    (troop_set_slot, "trp_sergeant", slot_troop_ranking, 40),
    (troop_set_slot, "trp_guard", slot_troop_ranking, 40),
    (troop_set_slot, "trp_huscarl", slot_troop_ranking, 40),
    (troop_set_slot, "trp_shieldmaiden", slot_troop_ranking, 40),
    (troop_set_slot, "trp_man_at_arms", slot_troop_ranking, 41),
    (troop_set_slot, "trp_knight", slot_troop_ranking, 41),
    (troop_set_slot, "trp_mamaluke", slot_troop_ranking, 41),
    (troop_set_slot, "trp_steward", slot_troop_ranking, 99),
    (troop_set_slot, "trp_marshal", slot_troop_ranking, 99),
    (troop_set_slot, "trp_doge", slot_troop_ranking, 99),
    (troop_set_slot, "trp_lord", slot_troop_ranking, 99),
    (troop_set_slot, "trp_lady", slot_troop_ranking, 99),
    (troop_set_slot, "trp_captain", slot_troop_ranking, 99),
    (troop_set_slot, "trp_commander", slot_troop_ranking, 99),
    (troop_set_slot, "trp_grandmaster", slot_troop_ranking, 99),
    (troop_set_slot, "trp_bishop", slot_troop_ranking, 99),
    (troop_set_slot, "trp_warchief", slot_troop_ranking, 99),
    (troop_set_slot, "trp_warlord", slot_troop_ranking, 99),
    (troop_set_slot, "trp_king", slot_troop_ranking, 99),
    (troop_set_slot, "trp_queen", slot_troop_ranking, 99),
    (troop_set_slot, "trp_archbishop", slot_troop_ranking, 99),
    (troop_set_slot, "trp_patrician", slot_troop_ranking, 99),
    (troop_set_slot, "trp_guide", slot_troop_ranking, 100),
    (troop_set_slot, "trp_godlike_hero", slot_troop_ranking, 100),
    (troop_set_slot, "trp_event_hero", slot_troop_ranking, 100),
    (troop_set_slot, "trp_peasant", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_peasant_female", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_serf", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_serf_female", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_beggar", slot_troop_spawn_health_percent, 100),
    ...
    (troop_set_slot, "trp_ministrel", slot_troop_spawn_health_percent, 80),
    (troop_set_slot, "trp_healer", slot_troop_spawn_health_percent, 90),
    (troop_set_slot, "trp_monk", slot_troop_spawn_health_percent, 90),
    (troop_set_slot, "trp_alchemist", slot_troop_spawn_health_percent, 80),
    (troop_set_slot, "trp_mercenary_hired_blade", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_mercenary_sword_sister", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_footman", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_slave", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_watchman", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_archer", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_marksman", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_mercenary_crossbowman", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_crossbowman", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_sharpshooter", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_lancer", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_horse_archer", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_mercenary_cavalry", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_man_at_arms", slot_troop_spawn_health_percent, 35),
    (troop_set_slot, "trp_knight", slot_troop_spawn_health_percent, 35),
    (troop_set_slot, "trp_mamaluke", slot_troop_spawn_health_percent, 35),
    (troop_set_slot, "trp_sergeant", slot_troop_spawn_health_percent, 35),
    (troop_set_slot, "trp_guard", slot_troop_spawn_health_percent, 35),
    (troop_set_slot, "trp_huscarl", slot_troop_spawn_health_percent, 35),
    (troop_set_slot, "trp_shieldmaiden", slot_troop_spawn_health_percent, 35),
    (troop_set_slot, "trp_engineer", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_blacksmith", slot_troop_spawn_health_percent, 35),
    (troop_set_slot, "trp_armoursmith", slot_troop_spawn_health_percent, 35),
    (troop_set_slot, "trp_doctor", slot_troop_spawn_health_percent, 70),
    (troop_set_slot, "trp_merchant", slot_troop_spawn_health_percent, 70),
    ...
    (troop_set_slot, "trp_marshal", slot_troop_spawn_health_percent, 80),
    (troop_set_slot, "trp_steward", slot_troop_spawn_health_percent, 60),
    (troop_set_slot, "trp_doge", slot_troop_spawn_health_percent, 30),
    (troop_set_slot, "trp_lord", slot_troop_spawn_health_percent, 30),
    (troop_set_slot, "trp_lady", slot_troop_spawn_health_percent, 30),
    (troop_set_slot, "trp_captain", slot_troop_spawn_health_percent, 30),
    (troop_set_slot, "trp_commander", slot_troop_spawn_health_percent, 30),
    (troop_set_slot, "trp_grandmaster", slot_troop_spawn_health_percent, 30),
    (troop_set_slot, "trp_bishop", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_king", slot_troop_spawn_health_percent, 80),
    (troop_set_slot, "trp_queen", slot_troop_spawn_health_percent, 80),
    (troop_set_slot, "trp_archbishop", slot_troop_spawn_health_percent, 90),
    (troop_set_slot, "trp_patrician", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_warchief", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_warlord", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_ruffian", slot_troop_spawn_health_percent, 55),
    (troop_set_slot, "trp_raider", slot_troop_spawn_health_percent, 55),
    (troop_set_slot, "trp_sea_raider", slot_troop_spawn_health_percent, 55),
    (troop_set_slot, "trp_brigand", slot_troop_spawn_health_percent, 55),
    (troop_set_slot, "trp_cultist", slot_troop_spawn_health_percent, 55),
    (troop_set_slot, "trp_thief", slot_troop_spawn_health_percent, 55),
    (troop_set_slot, "trp_hashashin", slot_troop_spawn_health_percent, 55),
    (troop_set_slot, "trp_rebel", slot_troop_spawn_health_percent, 80),
    (troop_set_slot, "trp_guide", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_godlike_hero", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_event_hero", slot_troop_spawn_health_percent, 100),
    (assign, "$g_extra_item_details_1_string_id", -1),
    (assign, "$g_extra_item_details_2_string_id", -1),
    ]),
  ...
  ("initialize_scene_globals", # reset global values to initial values when starting a mission
   [
    ...
    (try_for_range, ":faction_id", factions_begin, factions_end),
      ...
      (faction_set_slot, ":faction_id", slot_faction_marshal_player_uid, 0),
      (faction_set_slot, ":faction_id", slot_faction_steward_player_uid, 0),
  ...
  ("initialize_banner_info", # store background colors for all the banners in an array
   [
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h01", 0xFFf4f2e0),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h02", 0xFF313557),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h03", 0xFF003178),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h04", 0xFF272727),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h05", 0xFFcecfc6),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h06", 0xFF3a0a06),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h07", 0xFF25241e),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h08", 0xFF750000),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h09", 0xFF292a25),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h10", 0xFF441e5c),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h11", 0xFFad8854),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h12", 0xFF272823),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h13", 0xFF272823),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h14", 0xFF1b224d),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l04", 0xFF23589e),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l08", 0xFF313031),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l09", 0xFFbabbb2),
  ...
  ("on_agent_spawned", # server and clients: set agent slots and attributes after spawning
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (agent_set_slot,":agent_id",slot_agent_drunkness,0),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (player_get_troop_id, ":troop_id", ":player_id"),
        (try_begin),
          (this_or_next|eq, ":troop_id", "trp_godlike_hero"),
          (eq, ":troop_id", "trp_event_hero"),
  ...
  ("setup_player_joined", # server: when a player connects, update necessary data on clients, restore data from previous play sessions in this mission, and set up other attributes
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    (try_end),
    (get_max_players, ":max_players"),
    (try_begin), # set default attributes due to the database loading them
      (assign, ":troop_id", playable_troops_begin),
      #Female troop types
      (player_get_gender, ":gender", ":player_id"),
      (try_begin),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (le, ":dead_faction_id", castle_factions_begin), # Townwatch ensure they get the same treatment as commoners and outlaws
          (le, ":killer_faction_id", castle_factions_begin),
  ...
  ("cf_check_name_server", # server: send a test message to the name server to check whether it should be enabled
   [(multiplayer_is_server),
    (try_begin),
      ...
      (neg|str_is_empty, s2),
      (assign, reg2, 0),
      (send_message_to_url, "str_http_test"),
    (try_end),
    ]),
    
  ("cf_player_load_data_url", # server: retrieve player data
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1),
    (player_set_slot, ":player_id", slot_player_admin_no_panel, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_panel, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_gold, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_gold, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_kick, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_kick, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_temporary_ban, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_temporary_ban, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_permanent_ban, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_permanent_ban, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_kill_fade, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_kill_fade, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_freeze, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_freeze, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_teleport_self, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_teleport_self, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_admin_items, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_admin_items, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_heal_self, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_heal_self, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_godlike_troop, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_godlike_troop, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_event_troop, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_event_troop, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_guide_troop, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_guide_troop, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_ships, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_ships, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_announce, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_announce, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_override_poll, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_override_poll, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_all_items, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_all_items, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_mute, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_mute, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_animals, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_animals, 1),
    (player_set_slot, ":player_id", slot_player_admin_no_factions, 1),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_factions, 1),
    (call_script, "script_cf_player_get_gold_url", ":player_id"),
    ]),
    
  ("cf_player_load_data_url_2", # server: retrieve player data
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1),
    (call_script, "script_cf_player_get_faction_url", ":player_id"),
    ]),

  ("cf_player_load_data_url_3", # server: retrieve player data
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1),
    (call_script, "script_cf_player_get_admin_url", ":player_id"),
    (call_script, "script_cf_player_get_misc_url", ":player_id"),
    (call_script, "script_cf_player_get_horse_url", ":player_id"),
    ]),
    
  ("cf_player_get_gold_url", # server: retrieve player gold url
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1),
    (try_begin),
      (eq, "$g_name_server_enabled", 1),
      (player_set_troop_id, ":player_id", -1), # ensure a player cant spawn if his data isnt loaded
      (str_store_string, s1, "str_http_server"),
      (neg|str_is_empty, s1),
      (str_store_string, s2, "str_http_server_password"),
      (neg|str_is_empty, s2),
      ...
      (str_store_string, s0, "str_http_join_gold_data"),
      (send_message_to_url, s0),
    (try_end),
    ]),
    
  ("cf_player_get_admin_url", # server: retrieve player data from the name server
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1),
    (try_begin),
      (eq, "$g_name_server_enabled", 1),
      ...
      (player_get_unique_id, reg2, ":player_id"),
      (assign, reg3, ":player_id"),
      (str_store_string, s0, "str_http_join_admin_data"),
      (send_message_to_url, s0),
    (try_end),
    ]),
    
  ("cf_player_get_faction_url", # server: retrieve player faction url
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1),
    (try_begin),
      (eq, "$g_name_server_enabled", 1),
      ...
      (str_encode_url, s3),
      (assign, reg3, ":player_id"),
      (str_store_string, s0, "str_http_join_faction_data"),
      (send_message_to_url, s0),
    (try_end),
    ]),
    
  ("cf_player_get_horse_url", # server: retrieve player horse url
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1),
    (try_begin),
      (eq, "$g_name_server_enabled", 1),
      ...
      (str_encode_url, s3),
      (assign, reg3, ":player_id"),
      (str_store_string, s0, "str_http_join_horse_data"),
      (send_message_to_url, s0),
    (try_end),
    ]),
    
  ("cf_player_get_misc_url", # server: retrieve player misc url
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1),
    (try_begin),
      (eq, "$g_name_server_enabled", 1),
      ...
      (str_encode_url, s3),
      (assign, reg3, ":player_id"),
      (str_store_string, s0, "str_http_join_misc_data"),
      (send_message_to_url, s0),
    (try_end),
    ]),
    
  ("cf_player_get_pos_url", # server: retrieve player posistion from the name server
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1),
    (try_begin),
      (eq, "$g_name_server_enabled", 1),
      ...
      (str_encode_url, s3),
      (assign, reg3, ":player_id"),
      (str_store_string, s0, "str_http_join_pos_data"),
      (send_message_to_url, s0),
    (try_end),
    ]),
    
  ("cf_player_get_inventory_url", # server: retrieve player equipment from the name server
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (str_encode_url, s3),
      (assign, reg3, ":player_id"),
      (str_store_string, s0, "str_http_inventory_data"),
      (send_message_to_url, s0),
      (call_script, "script_scene_prop_play_sound", ":instance_id", "snd_draw_shield"),
    (try_end),
    ]),
    
  ("cf_player_update_gold_url", # server: save player data from the name server
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1),
    (try_begin),
      (eq, "$g_name_server_enabled", 1),
      ...
      (str_store_string, s30, "str_http_update_gold"), # string 30 due to changing faction name bug
      (send_message_to_url, s30),
    (try_end),
    ]),
    
  ("cf_player_update_bank_url", # server: save player data from the name server
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1),
    (try_begin),
      (eq, "$g_name_server_enabled", 1),
      ...
      (player_get_slot, reg3, ":player_id", slot_player_bank_amount),

      (str_store_string, s0, "str_http_update_bank"),
      (send_message_to_url, s0),
    (try_end),
    ]),

  ("cf_player_update_troop_url", # server: save player data from the name server
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1),
    (try_begin),
      (eq, "$g_name_server_enabled", 1),
      ...
      (player_get_troop_id, ":troop_id", ":player_id"),
      (try_begin),#Check for lords and godmode
        (ge,":troop_id",valid_lord_type_start),
          (player_get_slot, reg3, ":player_id", slot_player_non_lord_troop_id),
      (else_try),
        (assign,reg3,":troop_id"),
      (try_end),
      
      (player_get_slot, reg4, ":player_id", slot_player_faction_id),
      
      (player_get_slot, reg5, ":player_id", slot_player_outlaw_rating),

      (str_store_string, s0, "str_http_update_troop"),
      (send_message_to_url, s0),
    (try_end),
    ]),
  
  ("cf_player_update_horse_url", # server: save player data from the name server
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1),
    (try_begin),
      (eq, "$g_name_server_enabled", 1),
      ...
      (player_get_slot, reg3, ":player_id", slot_player_stable),
      (player_get_slot, reg4, ":player_id", slot_player_stable_health),

      (str_store_string, s0, "str_http_update_horse"),
      (send_message_to_url, s0),
    (try_end),
    ]),

  ("cf_player_update_pos_url", # server: save player data from the name server
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1),
    (store_script_param, ":scene_change", 2),
    (try_begin),
      (eq, "$g_name_server_enabled", 1),
      (str_store_string, s1, "str_http_server"),
      (neg|str_is_empty, s1),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (position_get_z,reg5,pos2),
          (agent_get_slot,reg6,":agent_id",slot_agent_shackled),
        (else_try),
          (assign,reg3,0),
          (assign,reg4,0),
          (assign,reg5,0),
      ...
      (store_current_scene,reg7),

      (str_store_string, s0, "str_http_update_pos"),
      (send_message_to_url, s0),
    (try_end),
    ]),

  ("cf_player_update_culture_url", # server: Changing a players culture and saving it in the database
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    ...
    (try_begin),
      (eq, "$g_name_server_enabled", 1),
      (try_begin),
        (player_slot_eq, ":player_id", slot_player_culture, ":culture"),
          (multiplayer_send_2_int_to_player, ":player_id", server_event_preset_message, "str_already_culture", preset_message_error),
      (else_try),
        (call_script, "script_cf_check_enough_gold", ":player_id", culture_change_price),
        (call_script, "script_player_adjust_gold", ":player_id", culture_change_price, -1),
        
        (player_set_slot, ":player_id", slot_player_culture, ":culture"),
        (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_culture, ":culture"),
        ...
        (str_store_string, s0, "str_http_update_culture"),
        (send_message_to_url, s0),
      (try_end),
    (try_end),
    ]),

  ("cf_player_update_inventory_url", # server: handle banking inventory in a chest
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2),
    (agent_get_player_id, ":player_id", ":agent_id"),
    ...
    (try_begin),
      ...
      (agent_get_item_slot, reg4, ":agent_id", ek_head),
      (agent_get_item_slot, reg5, ":agent_id", ek_body),
      (agent_get_item_slot, reg6, ":agent_id", ek_gloves),
      (agent_get_item_slot, reg7, ":agent_id", ek_foot),
      
      (agent_get_item_slot, reg8, ":agent_id", ek_item_0),
      (agent_get_item_slot, reg9, ":agent_id", ek_item_1),
      (agent_get_item_slot, reg10, ":agent_id", ek_item_2),
      (agent_get_item_slot, reg11, ":agent_id", ek_item_3),
      ...
      (try_begin),
        (gt,reg4,0),
          (agent_unequip_item, ":agent_id", reg4),
          (call_script, "script_change_armor", ":agent_id", "itm_no_head"),
      ...
      (try_begin),
        (gt,reg5,0),
          (agent_unequip_item, ":agent_id", reg5),
          (call_script, "script_change_armor", ":agent_id", "itm_no_body"),
      ...
      (try_begin),
        (gt,reg6,0),
          (agent_unequip_item, ":agent_id", reg6),
          (call_script, "script_change_armor", ":agent_id", "itm_no_hand"),
      ...
      (try_begin),
        (gt,reg7,0),
          (agent_unequip_item, ":agent_id", reg7),
          (call_script, "script_change_armor", ":agent_id", "itm_no_foot"),
      ...
      (try_begin),
        (gt,reg8,0),
          (agent_unequip_item, ":agent_id", reg8),
      (else_try),
        (assign,reg8,0),
      (try_end),
      ...
      (try_begin),
        (gt,reg9,0),
          (agent_unequip_item, ":agent_id", reg9),
      (else_try),
        (assign,reg9,0),
      (try_end),
      ...
      (try_begin),
        (gt,reg10,0),
          (agent_unequip_item, ":agent_id", reg10),
      (else_try),
        (assign,reg10,0),
      (try_end),
      ...
      (try_begin),
        (gt,reg11,0),
          (agent_unequip_item, ":agent_id", reg11),
      (else_try),
        (assign,reg11,0),
      (try_end),
      
      (str_store_string, s0, "str_http_update_inventory"),
      (send_message_to_url, s0),
      
      #(player_set_slot, ":player_id", slot_player_stored_inventory, 1),
      #(multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_stored_inventory, 1),
      (call_script, "script_scene_prop_play_sound", ":instance_id", "snd_draw_shield"),
    (try_end),
    ]),
])
...
scripts.extend([
  ...
  ("player_adjust_gold", # server: adjust player gold, sending large values manually that would overflow in the engine code, and playing an appropriate sound
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    (try_begin),
      ...
      (try_end),
      (call_script, "script_cf_player_update_gold_url", ":player_id"),
    (try_end),
    ]),
  ...
  ("scene_setup_factions_castles", # server: at mission start, for each faction set whether active, and for each castle set owning faction, whether active, and whether it has training stations
   [
    ...
    (try_end),
    (try_for_range, ":scene_prop_id", "spr_pw_change_troop_peasant", "spr_code_change_troop_end"),
  ...
  ("redraw_castle_banners", # redraw heraldic banner tableaus using various tricks
   [(store_script_param, ":redraw_type", 1), # constants starting with redraw_
    ...
    (try_begin),
      ...
      (try_end),
      (call_script, "script_redraw_castle_banner_kind", ":redraw_type", ":value", "spr_pw_castle_subjugate_point", "itm_pw_banner_castle_fac_1a"),
  ...
  ("redraw_castle_banner_instance", # redraw heraldic banners of a certain scene prop kind
   [(store_script_param, ":redraw_type", 1), # constants starting with redraw_
    ...
    (try_begin), # move capture point banners to the top of the pole
      (this_or_next|eq, ":pole_scene_prop_id", "spr_pw_castle_capture_point"),
      (eq, ":pole_scene_prop_id", "spr_pw_castle_subjugate_point"),
  ...
  ("scene_prop_get_owning_faction", # get the current owning faction and castle number associated with a scene prop, storing in reg0 and reg1
   [(store_script_param, ":instance_id", 1), # must be valid
    ...
    #Mannequin override owner
    (prop_instance_get_scene_prop_kind, ":get_type", ":instance_id"),
    (try_begin),
      (is_between,":get_type","spr_code_mannequin_head","spr_code_mannequin_end"),
      (scene_prop_get_slot, ":instance_id", ":instance_id", slot_scene_prop_linked_scene_prop), # override the instance_id with the base prop
    (try_end),
    #Mannequin override owner - end
  ...
  ("cf_can_change_faction", # check that a player can change to the selected faction, storing the error message in reg1 if not
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    (else_try),#to become outlaws
      (eq, ":faction_id", "fac_outlaws"),
      (neq, ":player_faction_id", "fac_outlaws"),
      (assign, reg1, "str_you_must_be_outlawed"),
    (try_end),
    (eq, reg1, 0),
    ]),
   ...
   [(store_script_param, ":player_id", 1), # if valid, checked against unique_id
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (str_store_string, s2, "str_http_server_password"),
        (neg|str_is_empty, s2),
        (player_get_slot, reg2, ":player_id", slot_player_banner_id),
        (try_begin),
          (gt,reg2,0),
          (assign,reg3,":faction_id"),
          (assign,reg4,":player_id"),
          (str_store_string, s0, "str_http_faction"),
          (send_message_to_url, s0),
        (else_try),
          (call_script, "script_cf_update_mannequins", ":faction_id"),
        (try_end),
  ...
  ("cf_faction_set_marshal", # server: try set a faction's marshal, failing if the player id and unique id don't match
   [(store_script_param, ":player_id", 1), # if valid, checked against unique_id
    (store_script_param, ":unique_id", 2), # if player_id is not valid, store in a faction slot so they are set lord when reconnected
    (store_script_param, ":faction_id", 3),
    ...
    (try_begin),
      ...
      (player_get_unique_id, ":player_unique_id", ":player_id"),
      (eq, ":player_unique_id", ":unique_id"),
      (call_script, "script_player_set_marshal", ":player_id", ":faction_id"),
    (else_try),
      (assign, ":fail", 1),
    (try_end),
    (eq, ":fail", 0),
    (faction_set_slot, ":faction_id", slot_faction_marshal_player_uid, ":unique_id"),
    ]),
    
  ("player_set_marshal", # server: set a player as marshal of a faction, changing all the appropriate slots
   [(store_script_param, ":player_id", 1), # must be valid
    (store_script_param, ":faction_id", 2),
    ...
    (try_for_range, ":other_player_id", 1, ":max_players"),
      (player_is_active, ":other_player_id"),
      (multiplayer_send_3_int_to_player, ":other_player_id", server_event_player_set_slot, ":player_id", slot_player_is_marshal, 1),
      (player_slot_eq, ":other_player_id", slot_player_faction_id, ":faction_id"),
      (multiplayer_send_4_int_to_player, ":other_player_id", server_event_player_minor_lord_announce, ":player_id", ":faction_id","trp_marshal",0), 
      (neq, ":other_player_id", ":player_id"),
      (player_get_slot, ":was_marshal", ":other_player_id", slot_player_is_marshal),
      (player_set_slot, ":other_player_id", slot_player_is_marshal, 0),
      (player_set_slot, ":other_player_id", slot_player_last_faction_kicked_from, 0),
      (player_get_slot, ":has_door_key", ":other_player_id", slot_player_has_faction_door_key),
      (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":other_player_id", slot_player_has_faction_door_key, ":has_door_key"),
      ...
      (player_get_slot, ":has_item_key", ":other_player_id", slot_player_has_faction_item_key),
      (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":other_player_id", slot_player_has_faction_item_key, ":has_item_key"),
      (try_begin), # for the previous marshal, remove the announcement permission, but leave all other settings unchanged
        (eq, ":was_marshal", 1),
        (assign, ":can_announce", 0),
        (player_set_slot, ":other_player_id", slot_player_can_faction_announce, ":can_announce"),
        (multiplayer_send_4_int_to_player, ":other_player_id", server_event_player_minor_lord_announce, ":player_id", ":faction_id","trp_marshal",1),#denounce marshal
      (else_try),
        (player_get_slot, ":can_announce", ":other_player_id", slot_player_can_faction_announce),
      (try_end),
      (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":other_player_id", slot_player_can_faction_announce, ":can_announce"),
      ...
      (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":other_player_id", slot_player_faction_chat_muted, ":is_muted"),
    (try_end),
    (player_set_slot, ":player_id", slot_player_is_marshal, 1),
    (player_set_slot, ":player_id", slot_player_has_faction_door_key, 1),
    #(player_set_slot, ":player_id", slot_player_has_faction_money_key, 1),
    (player_set_slot, ":player_id", slot_player_has_faction_item_key, 1),
    (player_set_slot, ":player_id", slot_player_can_faction_announce, 1),
    ...
    (str_store_faction_name, s1, ":faction_id"),
    (str_store_player_username, s10, ":player_id"),
    (str_store_troop_name,s3,"trp_marshal"),
    (server_add_message_to_log, "str_s10_now_s3_of_s1"),
    ]),
    
  ("cf_faction_set_steward", # server: try set a faction's steward, failing if the player id and unique id don't match
   [(store_script_param, ":player_id", 1), # if valid, checked against unique_id
    (store_script_param, ":unique_id", 2), # if player_id is not valid, store in a faction slot so they are set lord when reconnected
    (store_script_param, ":faction_id", 3),
    ...
    (try_begin),
      ...
      (player_get_unique_id, ":player_unique_id", ":player_id"),
      (eq, ":player_unique_id", ":unique_id"),
      (call_script, "script_player_set_steward", ":player_id", ":faction_id"),
    (else_try),
      (assign, ":fail", 1),
    (try_end),
    (eq, ":fail", 0),
    (faction_set_slot, ":faction_id", slot_faction_steward_player_uid, ":unique_id"),
    ]),
    
  ("player_set_steward", # server: set a player as steward of a faction, changing all the appropriate slots
   [(store_script_param, ":player_id", 1), # must be valid
    (store_script_param, ":faction_id", 2),
    ...
    (try_for_range, ":other_player_id", 1, ":max_players"),
      (player_is_active, ":other_player_id"),
      (multiplayer_send_3_int_to_player, ":other_player_id", server_event_player_set_slot, ":player_id", slot_player_is_steward, 1),
      (player_slot_eq, ":other_player_id", slot_player_faction_id, ":faction_id"),
      (multiplayer_send_4_int_to_player, ":other_player_id", server_event_player_minor_lord_announce, ":player_id", ":faction_id","trp_steward",0),
      (neq, ":other_player_id", ":player_id"),
      (player_get_slot, ":was_steward", ":other_player_id", slot_player_is_steward),
      (player_set_slot, ":other_player_id", slot_player_is_steward, 0),
      (player_set_slot, ":other_player_id", slot_player_last_faction_kicked_from, 0),
      (player_get_slot, ":has_door_key", ":other_player_id", slot_player_has_faction_door_key),
      (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":other_player_id", slot_player_has_faction_door_key, ":has_door_key"),
      ...
      (player_get_slot, ":has_item_key", ":other_player_id", slot_player_has_faction_item_key),
      (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":other_player_id", slot_player_has_faction_item_key, ":has_item_key"),
      (try_begin), # for the previous steward, remove the announcement permission, but leave all other settings unchanged
        (eq, ":was_steward", 1),
        (assign, ":can_announce", 0),
        (player_set_slot, ":other_player_id", slot_player_can_faction_announce, ":can_announce"),
        (multiplayer_send_4_int_to_player, ":other_player_id", server_event_player_minor_lord_announce, ":player_id", ":faction_id","trp_steward",1),#denounce steward
      (else_try),
        (player_get_slot, ":can_announce", ":other_player_id", slot_player_can_faction_announce),
      (try_end),
      (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":other_player_id", slot_player_can_faction_announce, ":can_announce"),
      ...
      (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":other_player_id", slot_player_faction_chat_muted, ":is_muted"),
    (try_end),
    (player_set_slot, ":player_id", slot_player_is_steward, 1),
    (player_set_slot, ":player_id", slot_player_has_faction_door_key, 1),
    (player_set_slot, ":player_id", slot_player_has_faction_money_key, 1),
    (player_set_slot, ":player_id", slot_player_has_faction_item_key, 1),
    #(player_set_slot, ":player_id", slot_player_can_faction_announce, 1),
    ...
    (str_store_faction_name, s1, ":faction_id"),
    (str_store_player_username, s10, ":player_id"),
    (str_store_troop_name,s3,"trp_steward"),
    (server_add_message_to_log, "str_s10_now_s3_of_s1"),
    ]),
  ...
  ("cf_player_is_marshal",
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    (try_begin),
      ...
      (is_between, ":faction_id", factions_begin, factions_end),
      (player_get_unique_id, ":unique_id", ":player_id"),
      (faction_slot_eq, ":faction_id", slot_faction_marshal_player_uid, ":unique_id"),
  ...
  ("cf_player_is_steward",
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    (try_begin),
      ...
      (is_between, ":faction_id", factions_begin, factions_end),
      (player_get_unique_id, ":unique_id", ":player_id"),
      (faction_slot_eq, ":faction_id", slot_faction_steward_player_uid, ":unique_id"),
      (player_slot_eq, ":player_id", slot_player_is_steward, 1),
    (else_try),
      (neg|multiplayer_is_server),
      (player_slot_eq, ":player_id", slot_player_is_steward, 1),
    (else_try),
  ...
  ("cf_player_can_use_troop", # check if the player meets restrictions for certain troops
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    (else_try),  
      ...
      (try_begin),
        (player_is_admin, ":player_id"),
        (player_slot_eq, ":player_id", slot_player_admin_no_event_troop, 0),
      (else_try),
        (assign, ":fail", 1),
      (try_end),
    (else_try),  
      (eq, ":troop_id", "trp_guide"),
      (try_begin),
        (player_is_admin, ":player_id"),
        (player_slot_eq, ":player_id", slot_player_admin_no_guide_troop, 0),
      (else_try),
        (assign, ":fail", 1),
      (try_end),
    (else_try),
      (eq, ":troop_id", "trp_marshal"),
      (try_begin),
        (call_script, "script_cf_player_is_marshal", ":player_id"),
      (else_try),
        (assign, ":fail", 1),
      (try_end),
    (else_try),  
      (eq, ":troop_id", "trp_steward"),
      (try_begin),
        (call_script, "script_cf_player_is_steward", ":player_id"),
      (else_try),
        (assign, ":fail", 1),
      (try_end),
    (else_try),
  ...
  ("change_faction", # server: change a player's faction
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    (try_begin),
      ...
      (player_set_slot, ":player_id", slot_player_is_marshal, 0), # reset all faction permissions
      (player_set_slot, ":player_id", slot_player_is_steward, 0), # reset all faction permissions
      (player_get_unique_id, ":unique_id", ":player_id"),
      (try_begin),
        (faction_slot_eq, ":faction_id", slot_faction_lord_player_uid, ":unique_id"),
        (faction_set_slot, ":faction_id", slot_faction_lord_player_uid, 0),
      ...
      (else_try),
        (eq, ":change_faction_type", change_faction_type_subjugate),
        (server_add_message_to_log, "str_s0_has_been_subjugated"),
      (else_try),
        (str_store_faction_name, s1, ":faction_id"),
        (server_add_message_to_log, "str_s0_joined_the_s1"),
      (try_end),
  ...
  ("cf_change_faction", # server: check if a player can join the faction associated with a scene prop, joining if so
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (agent_get_slot,":shackled",":agent_id",slot_agent_shackled),##Agents cannot use teleporting doors if they are shackled
    (neq,":shackled",1),
  ...
  ("cf_change_troop", # server: try change a player's troop and / or faction
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (try_begin),#Advanced leader classes
      (gt, ":leadership", 0),
      (call_script, "script_cf_can_become_advanced_leader", ":player_id"),
      (troop_get_slot,":advance_class",":troop_id",slot_troop_can_advanced_leader),
      (ge,":advance_class",playable_troops_begin),
      (assign,":troop_id",":advance_class"),
    (try_end),
    ...
    (try_begin),
      ...
      (try_end),
      (try_begin),
        (this_or_next|eq,":troop_id","trp_marshal"),
        (eq,":troop_id","trp_steward"),
        (player_set_slot, ":player_id", slot_player_non_lord_troop_id, ":current_troop_id"),
      (try_end),
      ...
      (try_begin), # Announce the mighty lord
        (call_script, "script_cf_can_become_advanced_leader", ":player_id"), #Just recheck it anyway due to me being lazy
        (gt,":advance_class",-1),
        (neq,":current_troop_id",":troop_id"),
        (player_get_slot, ":faction_id", ":player_id", slot_player_faction_id),
        (call_script, "script_cf_hail_to_the_king", ":player_id", ":faction_id"),
      (try_end),
      ...
      ##Wages
      #(call_script, "script_cf_faction_issue_wages", reg0, ":gold_cost", castle_wages_percentage), # Dont do wages for training troops only for purchases
  ...
  ("cf_buy_item", # server: handle players trying to buy an item from a stockpile
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    #Poison Item
    (try_begin),
      (item_slot_eq,":item_id",slot_item_can_be_poisoned,1),
      (agent_get_wielded_item, ":wielded_item_id", ":agent_id", 0),
      (try_begin),
        (eq,":wielded_item_id","itm_potion_poison"),
        (call_script, "script_cf_agent_consume_item", ":agent_id", ":wielded_item_id", 1),
        (try_begin),
          (eq,":item_type",itp_type_arrows),
            (assign,":item_id","itm_poison_arrows"),
        (else_try),
          (val_add,":item_id",1),
        (try_end),
      (else_try),
        (eq,":wielded_item_id","itm_potion_toxin"),
        (call_script, "script_cf_agent_consume_item", ":agent_id", ":wielded_item_id", 1),
        (try_begin),
          (eq,":item_type",itp_type_arrows),
            (assign,":item_id","itm_toxin_arrows"),
        (else_try),
          (val_add,":item_id",2),
        (try_end),
      (try_end),
    ...
    (call_script, "script_scene_prop_get_owning_faction", ":instance_id"),
    ##Wages
    #(call_script, "script_cf_faction_issue_wages", reg0, ":gold_value", castle_wages_percentage),
  ...
  ("cf_export_item", # server: handle players exporting an item out of the game world
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (store_skill_level, ":trade", "skl_trade", ":troop_id"),
    (try_begin),
      (ge, ":trade", 1),#Increase selling price for merchants
      ...
      (assign,":value",":gold_value"),
      (val_mul,":value",":percentage"),
      (val_div,":value",100),
      (val_add,":gold_value",":value"),
    (try_end),
  ...
  ("remove_scene_prop", # server: move an unused scene prop to where it is unlikely to be visible
   [(store_script_param, ":instance_id", 1),
    (store_script_param, ":remove_kind", 2),
    (prop_instance_get_scene_prop_kind, ":prop_kind", ":instance_id"),
    (try_begin),
      (eq,":remove_kind",0), # For freeze props
      (try_begin),
        (this_or_next|eq,":prop_kind","spr_code_freeze_agent"),
        (eq,":prop_kind","spr_code_freeze_horse_agent"),
        (set_fixed_point_multiplier, 100),
      ...
      (try_end),
    (else_try),
      (eq,":remove_kind",":prop_kind"),#This is just to make sure it doesnt remove the wrong scene prop
      (set_fixed_point_multiplier, 100),
      (position_set_x, pos0, -5000),
      (position_set_y, pos0, -5000),
      (position_set_z, pos0, -5000),
  ...
  ("cf_drop_money_bag_item", # server: handle players dropping money bags
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    (str_store_player_username,s1,":player_id"),
    (assign,reg2,":gold_amount"),
    (server_add_message_to_log, "str_log_money_bag"),
    ]),
  ...
  ("cf_use_money_bag_item", # server: handle players retrieving the contents of equipped money bags
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (player_get_unique_id, reg1, ":player_id"),
    (str_store_player_username,s1,":player_id"),
    (assign, reg2, ":gold_value"),
    (server_add_message_to_log, "str_log_take_money_bag"),
    ]),
  ...
  ("check_on_item_picked_up", # server: extra checks when an agent picks up an item
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (else_try),
      ...
      (this_or_next|eq, ":item_id", "itm_invisible_bow"),
      (this_or_next|eq, ":item_id", "itm_invisible_arrows"),
    ...
    (else_try),
      ...
      (try_begin), # convert the total factors (additive) into modifiers (subtracting from 100)
        ...
        (try_begin), # only apply modifiers on the server: it seems to cause memory leaks on clients
          ...
          (agent_set_slot, ":agent_id", slot_agent_move_speed_modifier, ":speed_modifier"),
    ...
    (try_begin),
      ...
      (else_try),
        ...
        (try_for_range, ":unused", 0, ":resource_count"),
          ...
          (try_begin),## Apples dropping from trees!
            (eq,":resource_item_id","itm_stick"),
            (store_random_in_range,":rand",1,20),
            (try_begin),
              (le,":rand",2),# Drop a apple but which kind :P
              (try_begin),
                (eq,":rand",1), # red apple
                (spawn_item, "itm_apple_a", 0, "$g_spawn_item_prune_time"),
              (else_try),# green apple
                (eq,":rand",2),
                (spawn_item, "itm_apple_b", 0, "$g_spawn_item_prune_time"),
              (try_end),
            (try_end),
          (try_end),
        (try_end),
  ...
  ("cf_setup_field", # server: set up linked plants scene prop for a field grown resource
   [(multiplayer_is_server),
    ...
    #Setup Wheat
    (spawn_scene_prop, "spr_code_wheat"),
    (scene_prop_set_slot, ":instance_id", slot_scene_prop_linked_scene_prop_1, reg0),
    (scene_prop_set_slot, reg0, slot_scene_prop_linked_scene_prop, ":instance_id"),
    (prop_instance_set_position, reg0, pos1),
    #Setup Carrot
    (spawn_scene_prop, "spr_code_carrot"),
    (scene_prop_set_slot, ":instance_id", slot_scene_prop_linked_scene_prop_2, reg0),
    (scene_prop_set_slot, reg0, slot_scene_prop_linked_scene_prop, ":instance_id"),
    (prop_instance_set_position, reg0, pos1),
    #Setup Cabbage
    (spawn_scene_prop, "spr_code_cabbage"),
    (scene_prop_set_slot, ":instance_id", slot_scene_prop_linked_scene_prop_3, reg0),
    (scene_prop_set_slot, reg0, slot_scene_prop_linked_scene_prop, ":instance_id"),
    (prop_instance_set_position, reg0, pos1),
  ...
  ("cf_hit_field", # server: handle planting,  watering, harvesting, and spoiling a field resource; should be called from ti_on_scene_prop_hit
   [(multiplayer_is_server),
    ...
    (try_begin), # planting seeds
      (this_or_next|eq, ":wielded_item_id", "itm_wheat_sack"), # Check for seeds
      (this_or_next|eq, ":wielded_item_id", "itm_carrot_sack"),
      (eq, ":wielded_item_id", "itm_cabbage_sack"),
      (set_trigger_result, 0),
      (gt, ":skill", 0),
      (store_mission_timer_a, ":time"),
      (try_begin),
        (eq, ":state", scene_prop_state_hidden),
        (scene_prop_set_slot, ":instance_id", slot_scene_prop_state, scene_prop_state_regenerating),
        (scene_prop_set_slot, ":instance_id", slot_scene_prop_resource_item_id, ":wielded_item_id"), # Set the plant type
        ...
        (try_begin), # Get the right scene prop
          (eq,":wielded_item_id","itm_wheat_sack"),
            (scene_prop_get_slot, ":plant_instance_id", ":instance_id", slot_scene_prop_linked_scene_prop_1),
        (else_try),
          (eq,":wielded_item_id","itm_carrot_sack"),
            (scene_prop_get_slot, ":plant_instance_id", ":instance_id", slot_scene_prop_linked_scene_prop_2),
        (else_try),
          (eq,":wielded_item_id","itm_cabbage_sack"),
            (scene_prop_get_slot, ":plant_instance_id", ":instance_id", slot_scene_prop_linked_scene_prop_3),
        (try_end),
        (prop_instance_get_starting_position, pos2, ":instance_id"),
      ...
      (else_try),
        ...
        (scene_prop_get_slot, ":seed_type", ":instance_id", slot_scene_prop_resource_item_id),
        (try_begin),
          (eq,":wielded_item_id",":seed_type"), # Ensure we are using the right seeds on the right prop
    ...
    (else_try), # harvest or spoil, depending on tool and skill
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (assign, ":resource_count", reg0),
          #Get the right resource item
          (scene_prop_get_slot, ":plant_item_type", ":instance_id", slot_scene_prop_resource_item_id), # Get the seed type
          (try_begin), # Ensure we are getting the right prop for the job.
            (eq,":plant_item_type","itm_wheat_sack"),
              (assign,":resource_item_id","itm_wheat_sheaf"),
          (else_try),
            (eq,":plant_item_type","itm_carrot_sack"),
              (assign,":resource_item_id","itm_carrot"),
          (else_try),
            (eq,":plant_item_type","itm_cabbage_sack"),
              (assign,":resource_item_id","itm_cabbage"),
          (try_end),
          (try_for_range, ":unused", 0, ":resource_count"),
            (call_script, "script_set_random_spawn_position", 50),
            (spawn_item, ":resource_item_id", 0, "$g_spawn_item_prune_time"),
...
scripts.extend([
  ...
  ("cf_process_iron",
   [generate_process_init(skill="skl_engineer", level=2, resource_class=[item_class_iron, item_class_precious], get_relative_pos=True),
    ...
    (try_begin),
      ...
      (assign, ":processed_item_count", 2),
      (assign, ":processed_item_id", "itm_heated_iron_bar"),
    (else_try),
      (eq, ":resource_item_id", "itm_iron_ore_small"),
      (assign, ":processed_item_count", 2),
      (assign, ":processed_item_id", "itm_heated_iron_bar_short"),
    (else_try),
    ...
    (else_try),
      (is_between, ":resource_item_id", weapon_parts_iron_piece_start, weapon_parts_iron_piece_end),
      (assign, ":processed_item_count", 1),
      (assign, ":resource_item_count", 1),
      (assign, ":processed_item_id", "itm_heated_iron_piece"),
    (else_try),
      (is_between, ":resource_item_id", weapon_parts_steel_piece_start, weapon_parts_steel_piece_end),
      (assign, ":processed_item_count", 1),
      (assign, ":resource_item_count", 1),
      (assign, ":processed_item_id", "itm_heated_steel_piece"),
    (else_try),
      (is_between, ":resource_item_id", weapon_parts_iron_short_start, weapon_parts_iron_short_end),
      (assign, ":processed_item_count", 1),
      (assign, ":resource_item_count", 1),
      (assign, ":processed_item_id", "itm_heated_iron_bar_short"),
    (else_try),
      (is_between, ":resource_item_id", weapon_parts_steel_short_start, weapon_parts_steel_short_end),
      (assign, ":processed_item_count", 1),
      (assign, ":resource_item_count", 1),
      (assign, ":processed_item_id", "itm_heated_steel_bar_short"),
    (else_try),
      (is_between, ":resource_item_id", weapon_parts_iron_start, weapon_parts_iron_end),
      (assign, ":processed_item_count", 1),
      (assign, ":resource_item_count", 1),
      (assign, ":processed_item_id", "itm_heated_iron_bar"),
    (else_try),
      (is_between, ":resource_item_id", weapon_parts_steel_start, weapon_parts_steel_end),
      (assign, ":processed_item_count", 1),
      (assign, ":resource_item_count", 1),
      (assign, ":processed_item_id", "itm_heated_steel_bar"),
    (else_try),
      (is_between, ":resource_item_id", weapon_parts_iron_long_start, weapon_parts_iron_long_end),
      (assign, ":processed_item_count", 1),
      (assign, ":resource_item_count", 1),
      (assign, ":processed_item_id", "itm_heated_iron_bar_long"),
    (else_try),
      (is_between, ":resource_item_id", weapon_parts_steel_long_start, weapon_parts_steel_long_end),
      (assign, ":processed_item_count", 1),
      (assign, ":resource_item_count", 1),
      (assign, ":processed_item_id", "itm_heated_steel_bar_long"),
    (else_try),
      ...
      (else_try),
        ...
        (assign, ":processed_item_id", "itm_heated_iron_bar"),
      (else_try),
        (eq, ":resource_item_id", "itm_steel_bar_short"),
        (assign, ":processed_item_id", "itm_heated_steel_piece"),
      (else_try),
        (eq, ":resource_item_id", "itm_steel_bar"),
        (assign, ":processed_item_id", "itm_heated_steel_bar_short"),
      (else_try),
        (eq, ":resource_item_id", "itm_steel_bar_long"),
        (assign, ":processed_item_id", "itm_heated_steel_bar"),
      (else_try),
        (eq, ":resource_item_id", "itm_heated_iron_bar_short"),
        (assign, ":processed_item_id", "itm_heated_iron_piece"),
      (else_try),
        (eq, ":resource_item_id", "itm_heated_iron_bar"),
        (assign, ":processed_item_id", "itm_heated_iron_bar_short"),
      (else_try),
        (eq, ":resource_item_id", "itm_heated_iron_bar_long"),
        (assign, ":processed_item_id", "itm_heated_iron_bar"),
      (else_try),
        (eq, ":resource_item_id", "itm_heated_steel_bar_short"),
        (assign, ":processed_item_id", "itm_heated_steel_piece"),
      (else_try),
        (eq, ":resource_item_id", "itm_heated_steel_bar"),
        (assign, ":processed_item_id", "itm_heated_steel_bar_short"),
      (else_try),
        (eq, ":resource_item_id", "itm_heated_steel_bar_long"),
        (assign, ":processed_item_id", "itm_heated_steel_bar"),
      (try_end),
    (else_try),
    ...
    (else_try),
      ...
      (assign, ":processed_item_id", "itm_heated_iron_bar_long"),
    (else_try),
      (eq, ":resource_item_id", "itm_steel_piece"),
      (assign, ":processed_item_id", "itm_heated_steel_bar_short"),
    (else_try),
      (eq, ":resource_item_id", "itm_steel_bar_short"),
      (assign, ":processed_item_id", "itm_heated_steel_bar"),
    (else_try),
      ...
      (assign, ":processed_item_id", "itm_heated_steel_bar_long"),
    (else_try),
      (eq, ":resource_item_id", "itm_heated_iron_piece"),
      (assign, ":processed_item_id", "itm_heated_iron_bar_short"),
    (else_try),
      (eq, ":resource_item_id", "itm_heated_iron_bar_short"),
      (assign, ":processed_item_id", "itm_heated_iron_bar"),
    (else_try),
      ...
      (assign, ":processed_item_id", "itm_heated_iron_bar_long"),
    (else_try),
      (eq, ":resource_item_id", "itm_heated_steel_piece"),
      (assign, ":processed_item_id", "itm_heated_steel_bar_short"),
    (else_try),
      (eq, ":resource_item_id", "itm_heated_steel_bar_short"),
      (assign, ":processed_item_id", "itm_heated_steel_bar"),
  ...
  ("cf_process_cook",
   [generate_process_init(skill="skl_weapon_master", level=1, resource_class=[item_class_food,item_class_poison]), # changed it to weapon master as it was quick fix to allow everyone to cook
    ...
    (try_begin),
      ...
      (else_try),
        (agent_has_item_equipped, ":agent_id", "itm_poisoned_raw_meat"),
        (assign, ":resource_2_item_id", "itm_poisoned_raw_meat"),
        (assign, ":processed_item_id", "itm_poisoned_meat_pie"),
      (else_try),
        (agent_has_item_equipped, ":agent_id", "itm_toxined_raw_meat"),
        (assign, ":resource_2_item_id", "itm_toxined_raw_meat"),
        (assign, ":processed_item_id", "itm_toxined_meat_pie"),
      (else_try),
        (agent_has_item_equipped, ":agent_id", "itm_strange_meat"),
        (assign, ":resource_2_item_id", "itm_strange_meat"),
        (assign, ":processed_item_id", "itm_meat_pie"),
      (else_try),
        ...
        (assign, ":processed_item_id", "itm_meat_pie"),
      (else_try),
        (agent_has_item_equipped, ":agent_id", "itm_apple_a"),
        (assign, ":resource_2_item_id", "itm_apple_a"),
        (assign, ":processed_item_id", "itm_apple_pie"),
      (else_try),
        (agent_has_item_equipped, ":agent_id", "itm_poisoned_apple_a"),
        (assign, ":resource_2_item_id", "itm_poisoned_apple_a"),
        (assign, ":processed_item_id", "itm_poisoned_apple_pie"),
      (else_try),
        (agent_has_item_equipped, ":agent_id", "itm_toxined_apple_a"),
        (assign, ":resource_2_item_id", "itm_poisoned_apple_a"),
        (assign, ":processed_item_id", "itm_toxined_apple_pie"),
      (else_try),
        (agent_has_item_equipped, ":agent_id", "itm_apple_b"),
        (assign, ":resource_2_item_id", "itm_apple_b"),
        (assign, ":processed_item_id", "itm_apple_pie"),
      (else_try),
        (agent_has_item_equipped, ":agent_id", "itm_poisoned_apple_b"),
        (assign, ":resource_2_item_id", "itm_poisoned_apple_b"),
        (assign, ":processed_item_id", "itm_poisoned_apple_pie"),
      (else_try),
        (agent_has_item_equipped, ":agent_id", "itm_toxined_apple_b"),
        (assign, ":resource_2_item_id", "itm_poisoned_apple_b"),
        (assign, ":processed_item_id", "itm_toxined_apple_pie"),
      (else_try),
      (try_end),
      ...
      (try_begin),
        ...
        (else_try),
          (assign, ":processed_item_count", 4),
        (try_end),
        (call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_2_item_id", 1),
        (eq, ":resource_2_item_id", "itm_water_bucket"),
        (agent_equip_item, ":agent_id", "itm_bucket", reg0),
      (try_end),
    (else_try),
      (this_or_next|eq, ":resource_item_id", "itm_fish"),
      (this_or_next|eq, ":resource_item_id", "itm_poisoned_fish"),
      (this_or_next|eq, ":resource_item_id", "itm_toxined_fish"),
      (eq, ":resource_item_id", "itm_salted_fish"),
      (assign, ":processed_item_id", "itm_cooked_fish"),
    (else_try),
      (this_or_next|eq, ":resource_item_id", "itm_raw_meat"),
      (this_or_next|eq, ":resource_item_id", "itm_poisoned_raw_meat"),
      (this_or_next|eq, ":resource_item_id", "itm_toxined_raw_meat"),
      (this_or_next|eq, ":resource_item_id", "itm_strange_meat"),
  ...
  ("cf_process_press",
   [generate_process_init(skill="skl_labouring", level=1, resource_class=[item_class_food,item_class_poison]),
    ...
    (try_begin),
      ...
      (assign, ":resource_item_count", 3),
    (else_try),
      (eq, ":resource_item_id", "itm_poisoned_grapes"),
      (assign, ":processed_item_id", "itm_poisoned_must_barrel"),
      (assign, ":resource_item_count", 3),
    (else_try),
      (eq, ":resource_item_id", "itm_toxined_grapes"),
      (assign, ":processed_item_id", "itm_toxined_must_barrel"),
      (assign, ":resource_item_count", 3),
    (else_try),
      ...
      (try_end),
    (else_try),
      (eq, ":resource_item_id", "itm_poisoned_must_barrel"),
      (assign, ":processed_item_id", "itm_poisoned_wine_barrel"),
      (try_begin),
        (ge, ":skill_level", 5),
        (assign, ":resource_item_count", 2),
      (else_try),
      ...
      (try_end),
    (else_try),
      (eq, ":resource_item_id", "itm_toxined_must_barrel"),
      (assign, ":processed_item_id", "itm_toxined_wine_barrel"),
      (try_begin),
        (ge, ":skill_level", 5),
        (assign, ":resource_item_count", 2),
      (else_try),
  ...
  ("cf_process_tavern",
   [generate_process_init(resource_class=[item_class_drink,item_class_poison], start_effect=False),
    ...
    (try_begin),
      ...
      (position_rotate_x, pos1, 90),
    (else_try),
      (eq, ":resource_item_id", "itm_poisoned_wine_barrel"),
      (assign, ":processed_item_count", 4),
      (assign, ":processed_item_id", "itm_poisoned_wine_jar"),
      (position_move_z, pos1, 105),
      (position_rotate_x, pos1, 90),
    (else_try),
      (eq, ":resource_item_id", "itm_toxined_wine_barrel"),
      (assign, ":processed_item_count", 4),
      (assign, ":processed_item_id", "itm_toxined_wine_jar"),
      (position_move_z, pos1, 105),
      (position_rotate_x, pos1, 90),
    (else_try),
    ...
    (else_try),
      (eq, ":resource_item_id", "itm_poisoned_wine_jar"),
      (assign, ":resource_item_count", 4),
      (assign, ":processed_item_id", "itm_poisoned_wine_barrel"),
      (position_move_z, pos1, 114),
    (else_try),
      (eq, ":resource_item_id", "itm_toxined_wine_jar"),
      (assign, ":resource_item_count", 4),
      (assign, ":processed_item_id", "itm_toxined_wine_barrel"),
      (position_move_z, pos1, 114),
    (else_try),
      ...
      (position_rotate_x, pos1, 90),
    (else_try),
      (eq, ":resource_item_id", "itm_poisoned_beer_cask"),
      (assign, ":processed_item_count", 4),
      (assign, ":processed_item_id", "itm_poisoned_beer_jug"),
      (position_move_z, pos1, 120),
      (position_rotate_x, pos1, 90),
    (else_try),
      (eq, ":resource_item_id", "itm_toxined_beer_cask"),
      (assign, ":processed_item_count", 4),
      (assign, ":processed_item_id", "itm_toxined_beer_jug"),
      (position_move_z, pos1, 120),
      (position_rotate_x, pos1, 90),
    (else_try),
    ...
    (else_try),
      (eq, ":resource_item_id", "itm_poisoned_beer_jug"),
      (assign, ":resource_item_count", 4),
      (assign, ":processed_item_id", "itm_poisoned_beer_cask"),
      (position_move_z, pos1, 116),
    (else_try),
      (eq, ":resource_item_id", "itm_toxined_beer_jug"),
      (assign, ":resource_item_count", 4),
      (assign, ":processed_item_id", "itm_toxined_beer_cask"),
      (position_move_z, pos1, 116),
    (try_end),
    (neq, ":processed_item_id", -1),
    (call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", ":resource_item_count"),
  ...
  ("cf_process_preserve",
   [generate_process_init(skill="skl_labouring", level=1, resource_class=[item_class_food,item_class_poison], start_effect=False),
    ...
    (else_try),
      (eq, ":resource_item_id", "itm_poisoned_fish"),
      (assign, ":processed_item_id", "itm_salted_fish"),
    (else_try),
      (eq, ":resource_item_id", "itm_toxined_fish"),
      (assign, ":processed_item_id", "itm_salted_fish"),
    (else_try),
      (eq, ":resource_item_id", "itm_raw_meat"),
      (assign, ":processed_item_id", "itm_salted_meat"),
    (else_try),
      (eq, ":resource_item_id", "itm_poisoned_raw_meat"),
      (assign, ":processed_item_id", "itm_salted_meat"),
    (else_try),
      (eq, ":resource_item_id", "itm_toxined_raw_meat"),
      (assign, ":processed_item_id", "itm_salted_meat"),
    (else_try),
      (eq, ":resource_item_id", "itm_strange_meat"),
      (assign, ":processed_item_id", "itm_salted_meat"),
    (else_try),
  ...
  ##New Crafting starts here
  
  ("owner_get_owned_prop",
   [(store_script_param, ":scene_prop_id", 1), # the desired scene prop kind
    (store_script_param, ":owner", 2), # the desired owner prop

    (scene_prop_get_num_instances, ":instance_num", ":scene_prop_id"),
    (try_for_range, ":instance_no", 0, ":instance_num"),
      (scene_prop_get_instance, ":instance_id", ":scene_prop_id", ":instance_no"),
      (scene_prop_slot_eq, ":instance_id", slot_scene_prop_linked_scene_prop, ":owner"),
      (scene_prop_slot_eq, ":instance_id", slot_scene_prop_state, scene_prop_state_hidden),
      (assign, ":instance_num", -1),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_state, scene_prop_state_active),
      #(prop_instance_enable_physics, ":instance_id", 1),
  ...
  ("cf_create_new_item",
   [
    (store_script_param, ":anvil", 1), # must be valid
    (store_script_param, ":scene_prop", 2), # must be valid
    (store_script_param, ":height", 3),
    
      (prop_instance_get_position, pos1, ":anvil"),
      (position_get_z,":scene_z",pos1),
      (val_add,":scene_z",":height"),
      (position_set_z,pos1,":scene_z"),
      (call_script, "script_owner_get_owned_prop", ":scene_prop", ":anvil"),
      (prop_instance_set_position, reg0, pos1),
      (scene_prop_set_slot, reg0, slot_scene_prop_linked_scene_prop, ":anvil"),
    ]),
    
  ##Carpentry starts here
  
  ("cf_process_chop_block",
   [
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    
    (scene_prop_get_slot,":scene_item_id", ":instance_id", slot_scene_prop_item_id),
    (eq,":scene_item_id",0),
    (agent_get_wielded_item,":item_id",":agent_id",0),
    ...
    (try_begin),
      (eq,":item_id","itm_wood_block"),
        (assign,":scene_prop","spr_code_wood_block"),
        (assign,":hitamount",4),
    (try_end),
    ...
    (call_script, "script_cf_agent_consume_item", ":agent_id", ":item_id", 1),
    (call_script, "script_cf_create_new_item", ":instance_id", ":scene_prop", 93),
    
    (scene_prop_set_slot, ":instance_id", slot_scene_prop_next_resource_hp, 0),
    (scene_prop_set_slot, ":instance_id", slot_scene_prop_full_hit_points, ":hitamount"),
      
    ]),
    
  ("cf_process_hit_chop_block",
   [
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    ...
    (assign,":hit_item_id",0),
    
    (try_begin),
      (eq,":scene_item_id","itm_wood_block"),
      (assign,":hit_item_id","itm_board"),
      (assign,":scene_prop_kind","spr_code_wood_block"),
    (try_end),
    ...
    (scene_prop_get_slot,":hits",":instance_id",slot_scene_prop_next_resource_hp),
    (scene_prop_get_slot,":hitamount",":instance_id",slot_scene_prop_full_hit_points),

    (prop_instance_get_position, pos1, ":instance_id"),
    (call_script, "script_set_random_spawn_position", 50),
    (spawn_item, ":hit_item_id", 0, "$g_spawn_item_prune_time"),
    
    (val_add,":hits",1),
    (scene_prop_set_slot, ":instance_id", slot_scene_prop_next_resource_hp, ":hits"),
    (try_begin),
      (ge,":hits",":hitamount"),

      (scene_prop_get_num_instances, ":removed_instance_num", ":scene_prop_kind"),
      (try_for_range, ":instance_no", 0, ":removed_instance_num"),
        (prop_instance_is_valid, ":instance_no"),
        (scene_prop_get_instance, ":removed_instance_id", ":scene_prop_kind", ":instance_no"),
        (scene_prop_slot_eq, ":removed_instance_id", slot_scene_prop_linked_scene_prop, ":instance_id"),
        (call_script, "script_remove_scene_prop", ":removed_instance_id",":scene_prop_kind"),
      (try_end),
  ...
  ##Metalworks starts here
  
  ("cf_process_weapon_stand_item", # server: Using the weapon stand with a item in hand
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    ...
    (try_begin),
      ...
      (item_get_slot,":item_type",":item",slot_item_class),
      (this_or_next|eq, ":item_type", item_class_wood),
      (this_or_next|eq, ":item_type", item_class_iron),
      (this_or_next|eq, ":item_type", item_class_leather),
      (eq,":item_type",item_class_cloth),
      
      (try_begin),
        (eq,":slotfree",1),
        (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_1, ":item"),
        (call_script, "script_cf_agent_consume_item", ":agent_id", ":item", 1),
      (else_try),
        (eq,":slotfree",2),
        (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_2, ":item"),
        (call_script, "script_cf_agent_consume_item", ":agent_id", ":item", 1),
      (else_try),
        (eq,":slotfree",3),
        (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_3, ":item"),
        (call_script, "script_cf_agent_consume_item", ":agent_id", ":item", 1),
      (try_end),
    (else_try),#Recover third material
      (eq,":fail",1),
      (neq,":item_3",0),
      (call_script, "script_spawn_processed_resources", ":agent_id", ":item_3", 1),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_3, 0),
    (try_end),
    ]),
    
  ("cf_process_weapon_stand", # server: Do the initial check to see if they have already made an ingredient if not them give back materials
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    (try_begin),
      ...
      (scene_prop_get_slot,reg4,":instance_id",slot_scene_prop_item_slot_1),
      (scene_prop_get_slot,reg5,":instance_id",slot_scene_prop_item_slot_2),
      (scene_prop_get_slot,reg6,":instance_id",slot_scene_prop_item_slot_3),
      
      (player_get_slot, ":culture", ":player_id", slot_player_culture),
      (try_begin),
        (eq, ":culture", culture_swadian),
          (str_store_string, s4, "@swadian"),
      (else_try),
        (eq, ":culture", culture_rhodok),
          (str_store_string, s4, "@rhodok"),
      (else_try),
        (eq, ":culture", culture_nord),
          (str_store_string, s4, "@nord"),
      (else_try),
        (eq, ":culture", culture_vaegir),
          (str_store_string, s4, "@vaegir"),
      (else_try),
        (eq, ":culture", culture_khergit),
          (str_store_string, s4, "@khergit"),
      (else_try),
        (eq, ":culture", culture_sarranid),
          (str_store_string, s4, "@sarranid"),
      (try_end),
      (neg|str_is_empty, s4),
      (str_store_string, s3, "str_http_weapon_culture"),
      (neg|str_is_empty, s3),
      (str_encode_url, s3),
      
      (assign,reg7,0),

      (str_store_string, s0, "str_http_crafting"),
      
      (send_message_to_url, s0),
    (try_end),
    ]),
    
  ("cf_process_weapon_fail", # server: Seeing as no valid recipees proc'd we will give back the resoucres
   [(multiplayer_is_server),
    (store_script_param, ":instance_id", 1), # must be valid
    ...
    (try_begin), # Do it in reverse order cos so
      (gt,":item_3",0),
      (call_script, "script_spawn_processed_resources", ":agent_id", ":item_3", 1),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_3, 0),
    (try_end),
    (try_begin),
      (gt,":item_2",0),
      (call_script, "script_spawn_processed_resources", ":agent_id", ":item_2", 1),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_2, 0),
    (try_end),
    (try_begin),
      (gt,":item_1",0),
      (call_script, "script_spawn_processed_resources", ":agent_id", ":item_1", 1),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_1, 0),
    (try_end),

    ]),
    
  ("cf_produce_weapon", # server: Produce the specific weapon and use up the resources
  [(multiplayer_is_server),
    (store_script_param, ":instance_id", 1), # must be valid
    (store_script_param, ":weapon", 2), # must be valid
  
    (try_begin), # if produced a weapon use the resources
      (gt,":weapon",0),
        (prop_instance_get_position, pos1, ":instance_id"),
        ...
        (set_fixed_point_multiplier, 1),
        (position_rotate_y_floating,pos1,270),
        (position_rotate_x_floating,pos1,90),
        (set_spawn_position, pos1),
        (spawn_item, ":weapon", 0, "$g_spawn_item_prune_time"),
        (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_1, 0),
        (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_2, 0),
        (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_3, 0),
        #(particle_system_burst, "psys_dummy_smoke", pos1, 6), #do effects
        (call_script, "script_scene_prop_play_sound", ":instance_id", "snd_draw_spear"),
    (try_end),
  ]),
  
  ("cf_try_produce_weapon", # server: Try to produce the specific weapon
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    (store_script_param, ":skill_level", 3), # must be valid
    (store_script_param, ":ingredient_1", 4), # must be valid
    (store_script_param, ":ingredient_2", 5), # must be valid
    (store_script_param, ":ingredient_3", 6), # must be valid
    ...
    (try_begin),
      (eq,":ingredient_1",":item_1"),
      (val_add,":Checklist",1),
      (assign,":item_1",-1),
    (else_try),
      (eq,":ingredient_1",":item_2"),
      (val_add,":Checklist",1),
      (assign,":item_2",-1),
    (else_try),
      (eq,":ingredient_1",":item_3"),
      (val_add,":Checklist",1),
      (assign,":item_3",-1),
    (try_end),
    
    (eq,":Checklist",1),#If we dont even have the first ingredient there is no need to check for the next two.
    
    (try_begin),
      (eq,":ingredient_2",":item_1"),
      (val_add,":Checklist",1),
      (assign,":item_1",-1),
    (else_try),
      (eq,":ingredient_2",":item_2"),
      (val_add,":Checklist",1),
      (assign,":item_2",-1),
    (else_try),
      (eq,":ingredient_2",":item_3"),
      (val_add,":Checklist",1),
      (assign,":item_3",-1),
    (try_end),
    
    (eq,":Checklist",2),#If we dont even have the second ingredient there is no need to check for the last ingredient.
    
    (try_begin),
      (eq,":ingredient_3",":item_1"),
      (val_add,":Checklist",1),
      (assign,":item_1",-1),
    (else_try),
      (eq,":ingredient_3",":item_2"),
      (val_add,":Checklist",1),
      (assign,":item_2",-1),
    (else_try),
      (eq,":ingredient_3",":item_3"),
      (val_add,":Checklist",1),
      (assign,":item_3",-1),
    (try_end),
    
    (eq,":Checklist",3),#Check for last ingredient on the list
    
    #(call_script, "script_cf_has_enough_skill_level", ":agent_id", ":skill", ":skill_level"), # For some reason the skill doesnt load from the database lol
    (agent_get_troop_id,":troop_id",":agent_id"),
    (store_skill_level, ":troop_skill_level", "skl_engineer", ":troop_id"),
    
    (try_begin),#if the player has the required skill level then proceed.
      (ge,":troop_skill_level",":skill_level"),
      (assign,":crafted",1),
    (else_try),#Otherwise send a message that they dont
      (agent_get_player_id,":player_id",":agent_id"),
  ...
  ("cf_mannequin_craft_stockpile", # server: handle players crafting items at a stockpile
   [(store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    (store_script_param, ":required_level", 3),
    ...
    (assign, ":error_string_id", 0),
    (try_begin),
      (assign, ":average_level", ":required_level"),
      (try_begin),
        (le, ":average_level", -1),
      (else_try),
        (agent_get_troop_id, ":troop_id", ":agent_id"),
        (store_skill_level, ":skill_level", "skl_tailoring", ":troop_id"),
        (ge, ":skill_level", ":required_level"),
      (else_try),
  ...
  ("cf_process_anvil",
   [generate_process_init(skill="skl_engineer", level=2, resource_class=item_class_iron),
    ...
    (try_begin),
      ...
      (assign,":hitamount",0),
      (try_begin),
        (eq,":item_id","itm_heated_iron_piece"),
          (assign,":scene_prop","spr_code_heated_iron_piece"),
          (assign,":hitamount",5),
      (else_try),
        (eq,":item_id","itm_heated_iron_bar_short"),
          (assign,":scene_prop","spr_code_heated_iron_bar_short"),
          (assign,":hitamount",10),
      (else_try),
        (eq,":item_id","itm_heated_iron_bar"),
          (assign,":scene_prop","spr_code_heated_iron_bar"),
          (assign,":hitamount",15),
      (else_try),
        (eq,":item_id","itm_heated_iron_bar_long"),
          (assign,":scene_prop","spr_code_heated_iron_bar_long"),
          (assign,":hitamount",25),
      (else_try),  
        (eq,":item_id","itm_heated_steel_piece"),
          (assign,":scene_prop","spr_code_heated_steel_piece"),
          (assign,":hitamount",10),
      (else_try),
        (eq,":item_id","itm_heated_steel_bar_short"),
          (assign,":scene_prop","spr_code_heated_steel_bar_short"),
          (assign,":hitamount",20),
      (else_try),
        (eq,":item_id","itm_heated_steel_bar"),
          (assign,":scene_prop","spr_code_heated_steel_bar"),
          (assign,":hitamount",30),
      (else_try),
        (eq,":item_id","itm_heated_steel_bar_long"),
          (assign,":scene_prop","spr_code_heated_steel_bar_long"),
          (assign,":hitamount",50),
      (try_end),
  ...
  ("cf_process_hit_anvil",
   [(multiplayer_is_server),
    ...
    (call_script, "script_scene_prop_play_sound", ":instance_id", "snd_hit_metal_metal"),
    ...
    (try_begin),
      ...
      (try_begin),
          (eq,":scene_item_id","itm_heated_iron_piece"),
          (assign,":finish_item_id","itm_finished_heated_iron_piece"),
          (assign,":scene_prop_kind","spr_code_heated_iron_piece"),
      (else_try),
        (eq,":scene_item_id","itm_heated_iron_bar_short"),
          (assign,":finish_item_id","itm_finished_heated_iron_bar_short"),
          (assign,":scene_prop_kind","spr_code_heated_iron_bar_short"),
      (else_try),
        (eq,":scene_item_id","itm_heated_iron_bar"),
          (assign,":finish_item_id","itm_finished_heated_iron_bar"),
          (assign,":scene_prop_kind","spr_code_heated_iron_bar"),
      (else_try),
        (eq,":scene_item_id","itm_heated_iron_bar_long"),
          (assign,":finish_item_id","itm_finished_heated_iron_bar_long"),
          (assign,":scene_prop_kind","spr_code_heated_iron_bar_long"),
      (else_try),
        (eq,":scene_item_id","itm_heated_steel_piece"),
          (assign,":finish_item_id","itm_finished_heated_steel_piece"),
          (assign,":scene_prop_kind","spr_code_heated_steel_piece"),
      (else_try),
        (eq,":scene_item_id","itm_heated_steel_bar_short"),
          (assign,":finish_item_id","itm_finished_heated_steel_bar_short"),
          (assign,":scene_prop_kind","spr_code_heated_steel_bar_short"),
      (else_try),
        (eq,":scene_item_id","itm_heated_steel_bar"),
          (assign,":finish_item_id","itm_finished_heated_steel_bar"),
          (assign,":scene_prop_kind","spr_code_heated_steel_bar"),
      (else_try),
        (eq,":scene_item_id","itm_heated_steel_bar_long"),
          (assign,":finish_item_id","itm_finished_heated_steel_bar_long"),
          (assign,":scene_prop_kind","spr_code_heated_steel_bar_long"),
      (try_end),
      ...
      (position_set_z,pos1,":scene_z"),
      (set_spawn_position, pos1),
      (spawn_item, ":finish_item_id", 0, "$g_spawn_item_prune_time"),
  ...
  ("cf_create_forge_item",
   [
    (store_script_param, ":forge", 1), # must be valid
    (store_script_param, ":scene_prop", 2), # must be valid
      (prop_instance_get_position, pos1, ":forge"),
      (position_get_z,":scene_z",pos1),
      (val_add,":scene_z",120),
      (position_set_z,pos1,":scene_z"),
      (call_script, "script_owner_get_owned_prop", ":scene_prop", ":forge"),
      (prop_instance_set_position, reg0, pos1),
      (scene_prop_set_slot, reg0, slot_scene_prop_linked_scene_prop, ":forge"),
    ]),
    
  ("cf_forge_process_metal",
   [
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    (store_script_param, ":item_id", 3), # must be valid
    (store_script_param, ":metal", 4), # must be valid
    (try_begin),
      (eq,":metal",-1),#No item so add
      (gt,":item_id",-1),#ensure holding something
      (item_slot_eq, ":item_id", slot_item_class, item_class_iron),
      (assign,":scene_prop",0),
      
      (try_begin),
        (eq,":item_id","itm_iron_piece"),
          (assign,":scene_prop","spr_code_iron_piece"),
      (else_try),
        (eq,":item_id","itm_iron_bar_short"),
          (assign,":scene_prop","spr_code_iron_bar_short"),
      (else_try),
        (eq,":item_id","itm_iron_bar"),
          (assign,":scene_prop","spr_code_iron_bar"),
      (else_try),
        (eq,":item_id","itm_iron_bar_long"),
          (assign,":scene_prop","spr_code_iron_bar_long"),
      (try_end),
      
      (try_begin),
        (gt,":scene_prop",0),
        (call_script, "script_cf_agent_consume_item", ":agent_id", ":item_id", 1),
        (call_script, "script_cf_create_forge_item", ":instance_id", ":scene_prop"),
        (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_1, ":item_id"),
      (try_end),
    
    (else_try),#item already inside so take out
      (assign,":scene_prop_kind",0),
      
      (try_begin), # Check for scene props
        (eq,":metal","itm_heated_steel_piece"),
          (assign,":scene_prop_kind","spr_code_heated_steel_piece"),  
      (else_try),
        (eq,":metal","itm_heated_steel_bar_short"),
          (assign,":scene_prop_kind","spr_code_heated_steel_bar_short"),
      (else_try),
        (eq,":metal","itm_heated_steel_bar"),
          (assign,":scene_prop_kind","spr_code_heated_steel_bar"),
      (else_try),
        (eq,":metal","itm_heated_steel_bar_long"),
          (assign,":scene_prop_kind","spr_code_heated_steel_bar_long"),
      (else_try),
        (eq,":metal","itm_iron_piece"),
           (assign,":scene_prop_kind","spr_code_iron_piece"),
      (else_try),
        (eq,":metal","itm_iron_bar_short"),
          (assign,":scene_prop_kind","spr_code_iron_bar_short"),
      (else_try),
        (eq,":metal","itm_iron_bar"),
          (assign,":scene_prop_kind","spr_code_iron_bar"),
      (else_try),
        (eq,":metal","itm_iron_bar_long"),
          (assign,":scene_prop_kind","spr_code_iron_bar_long"),
      (try_end),
      
      (try_begin),
        (gt,":scene_prop_kind",0),
        (scene_prop_get_num_instances, ":removed_instance_num", ":scene_prop_kind"),
        (try_for_range, ":instance_no", 0, ":removed_instance_num"),
          (prop_instance_is_valid, ":instance_no"),
          (scene_prop_get_instance, ":removed_instance_id", ":scene_prop_kind", ":instance_no"),
          (prop_instance_is_valid, ":removed_instance_id"),
          (scene_prop_slot_eq, ":removed_instance_id", slot_scene_prop_linked_scene_prop, ":instance_id"),
          (call_script, "script_remove_scene_prop", ":removed_instance_id",":scene_prop_kind"),
          (call_script, "script_spawn_processed_resources", ":agent_id", ":metal", 1),
  ...
  ("cf_forge_process_fuel",
   [
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    (store_script_param, ":item_id", 3), # must be valid
    (store_script_param, ":fuel", 4), # must be valid
    
    (try_begin),
      (eq,":fuel",-1),#No item so add
      (gt,":item_id",-1),#ensure holding something
      (item_slot_eq, ":item_id", slot_item_class, item_class_fuel),
      
      (try_begin),
        (eq,":item_id","itm_coal"),
          (call_script, "script_cf_agent_consume_item", ":agent_id", ":item_id", 1),
          (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_2, ":item_id"),
      (else_try),
        (eq,":item_id","itm_potion_dragon_fire"),
          (call_script, "script_cf_agent_consume_item", ":agent_id", ":item_id", 1),
          (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_2, ":item_id"),
      (try_end),
    ...
    (else_try),#item already inside so take out
      ...
      (try_begin), # Check for scene props
        (eq,":fuel","itm_coal"),
          (call_script, "script_spawn_processed_resources", ":agent_id", ":fuel", 1),
          (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_2, -1),
      (else_try),
        (eq,":fuel","itm_potion_dragon_fire"),
          (call_script, "script_spawn_processed_resources", ":agent_id", ":fuel", 1),
          (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_2, -1),
      (try_end),
  ...
  ("cf_process_forge",
   [
    ...
    (ge, ":engineer", 2),
    (agent_get_wielded_item,":item_id",":agent_id",0),
    (scene_prop_get_slot,":metal",":instance_id",slot_scene_prop_item_slot_1),
    (scene_prop_get_slot,":fuel",":instance_id",slot_scene_prop_item_slot_2),
    
    (try_begin),
      (gt,":item_id",-1),
      (try_begin),
        (item_slot_eq, ":item_id", slot_item_class, item_class_iron),
        (call_script, "script_cf_forge_process_metal", ":agent_id", ":instance_id", ":item_id", ":metal"),
      (else_try),
        (item_slot_eq, ":item_id", slot_item_class, item_class_fuel),
        (call_script, "script_cf_forge_process_fuel", ":agent_id", ":instance_id", ":item_id", ":fuel"),
      (try_end),
    (else_try),
      (call_script, "script_cf_forge_process_metal", ":agent_id", ":instance_id", ":item_id", ":metal"),
      (call_script, "script_cf_forge_process_fuel", ":agent_id", ":instance_id", ":item_id", ":fuel"),
  ...
  ("cf_forge_heat_item",
   [
    ...
    ##Ensure there is fuel and metal to heat
    (scene_prop_get_slot,":metal", ":forge", slot_scene_prop_item_slot_1),
    (scene_prop_get_slot,":fuel", ":forge", slot_scene_prop_item_slot_2),
    (gt,":metal",0),
    (gt,":fuel",0),
    
    (assign,":finish_scene_prop_kind",0),
    (assign,":new_item",0),
    (try_begin),
      (eq,":fuel","itm_coal"),
      (try_begin),
        (eq,":metal","itm_iron_piece"),
         (assign,":metal_scene_prop_kind","spr_code_iron_piece"),
         (assign,":finish_scene_prop_kind","spr_code_heated_steel_piece"),
         (assign,":new_item","itm_heated_steel_piece"),
      (else_try),
        (eq,":metal","itm_iron_bar_short"),
          (assign,":metal_scene_prop_kind","spr_code_iron_bar_short"),
          (assign,":finish_scene_prop_kind","spr_code_heated_steel_bar_short"),
          (assign,":new_item","itm_heated_steel_bar_short"),
      (else_try),
        (eq,":metal","itm_iron_bar"),
          (assign,":metal_scene_prop_kind","spr_code_iron_bar"),
          (assign,":finish_scene_prop_kind","spr_code_heated_steel_bar"),
          (assign,":new_item","itm_heated_steel_bar"),
      (else_try),
        (eq,":metal","itm_iron_bar_long"),
          (assign,":metal_scene_prop_kind","spr_code_iron_bar_long"),
          (assign,":finish_scene_prop_kind","spr_code_heated_steel_bar_long"),
          (assign,":new_item","itm_heated_steel_bar_long"),
      (try_end),
    (try_end),
    ...
    (try_begin),
      ...
      #Remove metal
      (scene_prop_get_num_instances, ":removed_instance_num", ":metal_scene_prop_kind"),
      (try_for_range, ":instance_no", 0, ":removed_instance_num"),
        (prop_instance_is_valid, ":instance_no"),
        (scene_prop_get_instance, ":removed_id", ":metal_scene_prop_kind", ":instance_no"),
        (scene_prop_slot_eq, ":removed_id", slot_scene_prop_linked_scene_prop, ":forge"),
        (call_script, "script_remove_scene_prop", ":removed_id",":metal_scene_prop_kind"),
        (scene_prop_set_slot, ":forge", slot_scene_prop_item_slot_1, ":new_item"),
      (try_end),
      
      (scene_prop_set_slot, ":forge", slot_scene_prop_item_slot_2, -1),
      
      (try_begin),
        (gt,":finish_scene_prop_kind",0), # Ensure we have a new prop
          (call_script, "script_cf_create_forge_item", ":forge", ":finish_scene_prop_kind"),
          (prop_instance_play_sound, ":forge", "snd_melting_metal"),
      (try_end),
    (try_end),
    ]),
    
  ("cf_forge_fail_heat_item",
   [
    (store_script_param, ":forge", 1), # must be valid
    ...
    (assign,":metal_scene_prop_kind",0),
    (try_begin),
      (eq,":fuel","itm_coal"),
      (try_begin),
        (eq,":metal","itm_iron_piece"),
    ...
    (try_begin),
      ...
      (try_for_range, ":instance_no", 0, ":removed_instance_num"),
        ...
        (scene_prop_slot_eq, ":removed_id", slot_scene_prop_linked_scene_prop, ":forge"),
        (call_script, "script_remove_scene_prop", ":removed_id",":metal_scene_prop_kind"),
        (scene_prop_set_slot, ":forge", slot_scene_prop_item_slot_1, -1),
      (try_end),
      
      (scene_prop_set_slot, ":forge", slot_scene_prop_item_slot_2, -1),
      
      (call_script, "script_scene_prop_play_sound", ":forge", "snd_shield_broken"),
    (try_end),
  ...
  ("cf_process_bellows",
   [
    ...
    (call_script, "script_cf_has_enough_skill_level", ":agent_id", "skl_engineer", 2), 
    
    (eq,reg4,0),# Ensure no trolls
    
    (prop_instance_get_variation_id, ":var", ":instance_id"),
    (scene_prop_get_num_instances, ":removed_instance_num", "spr_fw_metalworks_forge"),
      (try_for_range, ":instance_no", 0, ":removed_instance_num"),
        (scene_prop_get_instance, ":forge_instance_id", "spr_fw_metalworks_forge", ":instance_no"),
        (prop_instance_get_variation_id, ":var2", ":forge_instance_id"),
        (eq,":var",":var2"),
        (scene_prop_get_slot,":fuel", ":forge_instance_id", slot_scene_prop_item_slot_2),
        (gt,":fuel",0),
        
        (prop_instance_get_position, pos1, ":forge_instance_id"),
        (position_move_z, pos1, 100),
        
        (try_begin),
          (eq,":fuel","itm_potion_dragon_fire"),
          (particle_system_burst, "psys_forge_dragon_fire_big", pos1, 100),
        (else_try),
          (particle_system_burst, "psys_fireplace_fire_big", pos1, 100),
        (try_end),

        (store_random_in_range,":breakchance",1,10),
        (assign,":percentage",0),
        ...
        (try_begin),
          (eq,":fuel","itm_coal"),
          (try_begin),
            (ge, ":troop_skill_level", 7), # Master Smith
              (assign,":percentage",8),
          (else_try),
            (ge, ":troop_skill_level", "skl_engineer", 5), # Blacksmith
              (assign,":percentage",6),
          (else_try),
            (ge, ":troop_skill_level", "skl_engineer", 2), # Engineer
              (assign,":percentage",2),
          (try_end),
        (else_try),
          (eq,":fuel","itm_potion_dragon_fire"),
          (try_begin),
            (ge, ":troop_skill_level", "skl_engineer", 7), # Master Smith
              (assign,":percentage",5),
          (else_try),
            (ge, ":troop_skill_level", "skl_engineer", 5), # Blacksmith
              (assign,":percentage",1),
        ...
        (try_begin),
          (le,":breakchance",":percentage"),
          (call_script, "script_cf_forge_heat_item", ":forge_instance_id"),
        (else_try),
          (call_script, "script_cf_forge_fail_heat_item", ":forge_instance_id"),
        (try_end),
      (try_end),
      
    ]),
    
  ("cf_process_unheat_metal",
   [generate_process_init(skill="skl_engineer", level=2, resource_class=item_class_iron),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    ...
    (assign,":valid_heated_item",0),
    
    (try_begin),
      (eq,":item_id","itm_finished_heated_iron_piece"),
        (assign,":valid_heated_item","itm_iron_piece"),
    (else_try),
      (eq,":item_id","itm_finished_heated_iron_bar_short"),
        (assign,":valid_heated_item","itm_iron_bar_short"),
    (else_try),
      (eq,":item_id","itm_finished_heated_iron_bar"),
        (assign,":valid_heated_item","itm_iron_bar"),
    (else_try),
      (eq,":item_id","itm_finished_heated_iron_bar_long"),
        (assign,":valid_heated_item","itm_iron_bar_long"),
    (else_try),
      (eq,":item_id","itm_finished_heated_steel_piece"),
        (assign,":valid_heated_item","itm_steel_piece"),
    (else_try),
      (eq,":item_id","itm_finished_heated_steel_bar_short"),
        (assign,":valid_heated_item","itm_steel_bar_short"),
    (else_try),
      (eq,":item_id","itm_finished_heated_steel_bar"),
        (assign,":valid_heated_item","itm_steel_bar"),
    (else_try),
      (eq,":item_id","itm_finished_heated_steel_bar_long"),
        (assign,":valid_heated_item","itm_steel_bar_long"),
    (else_try),
      (eq,":item_id","itm_heated_iron_spearhead"),
        (assign,":valid_heated_item","itm_iron_spearhead"),
    (else_try),
      (eq,":item_id","itm_heated_iron_small_blade"),
        (assign,":valid_heated_item","itm_iron_small_blade"),
    (else_try),
      (eq,":item_id","itm_heated_iron_macehead"),
        (assign,":valid_heated_item","itm_iron_macehead"),
    (else_try),
      (eq,":item_id","itm_heated_iron_axehead"),
        (assign,":valid_heated_item","itm_iron_axehead"),
    (else_try),
      (eq,":item_id","itm_heated_iron_blade"),
        (assign,":valid_heated_item","itm_iron_blade"),
    (else_try),
      (eq,":item_id","itm_heated_iron_short_blade"),
        (assign,":valid_heated_item","itm_iron_short_blade"),
    (else_try),
      (eq,":item_id","itm_heated_iron_crossbowhead"),
        (assign,":valid_heated_item","itm_iron_crossbowhead"),
    (else_try),
      (eq,":item_id","itm_heated_iron_giant_blade"),
        (assign,":valid_heated_item","itm_iron_giant_blade"),
    (else_try),
      (eq,":item_id","itm_heated_iron_long_blade"),
        (assign,":valid_heated_item","itm_iron_long_blade"),
    (else_try),
      (eq,":item_id","itm_heated_steel_spearhead"),
        (assign,":valid_heated_item","itm_steel_spearhead"),
    (else_try),
      (eq,":item_id","itm_heated_steel_small_blade"),
        (assign,":valid_heated_item","itm_steel_small_blade"),
    (else_try),
      (eq,":item_id","itm_heated_steel_macehead"),
        (assign,":valid_heated_item","itm_steel_macehead"),
    (else_try),
      (eq,":item_id","itm_heated_steel_axehead"),
        (assign,":valid_heated_item","itm_steel_axehead"),
    (else_try),
      (eq,":item_id","itm_heated_steel_blade"),
        (assign,":valid_heated_item","itm_steel_blade"),
    (else_try),
      (eq,":item_id","itm_heated_steel_short_blade"),
        (assign,":valid_heated_item","itm_steel_short_blade"),
    (else_try),
      (eq,":item_id","itm_heated_steel_crossbowhead"),
        (assign,":valid_heated_item","itm_steel_crossbowhead"),
    (else_try),
      (eq,":item_id","itm_heated_steel_giant_blade"),
        (assign,":valid_heated_item","itm_steel_giant_blade"),
    (else_try),
      (eq,":item_id","itm_heated_steel_long_blade"),
        (assign,":valid_heated_item","itm_steel_long_blade"),
    (try_end),
    
    (try_begin),
      (gt,":valid_heated_item",0),
      (call_script, "script_cf_agent_consume_item", ":agent_id", ":item_id", 1),
      (agent_equip_item, ":agent_id", ":valid_heated_item"),
      (agent_set_wielded_item, ":agent_id", ":valid_heated_item"),
      (call_script, "script_scene_prop_play_sound", ":instance_id", "snd_heated_metal_quenched"),
    (try_end),
    
    ]),
    
  ("cf_process_grindstone",
   [generate_process_init(skill="skl_engineer", level=2, resource_class=item_class_iron),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    ...
    (assign,":valid_processed_item",0),
    
    (try_begin),
      (eq,":item_id","itm_finished_heated_iron_piece"),
        (assign,":valid_processed_item","itm_heated_iron_spearhead"),
    (else_try),
      (eq,":item_id","itm_heated_iron_spearhead"),
        (assign,":valid_processed_item","itm_heated_iron_small_blade"),
    (else_try),
      (eq,":item_id","itm_finished_heated_steel_piece"),
        (assign,":valid_processed_item","itm_heated_steel_spearhead"),
    (else_try),
      (eq,":item_id","itm_heated_steel_spearhead"),
        (assign,":valid_processed_item","itm_heated_steel_small_blade"),
    (else_try),
      (eq,":item_id","itm_finished_heated_iron_bar_short"),
        (assign,":valid_processed_item","itm_heated_iron_macehead"),
    (else_try),
      (eq,":item_id","itm_heated_iron_macehead"),
        (assign,":valid_processed_item","itm_heated_iron_axehead"),
    (else_try),
      (eq,":item_id","itm_finished_heated_steel_bar_short"),
        (assign,":valid_processed_item","itm_heated_steel_macehead"),
    (else_try),
      (eq,":item_id","itm_heated_steel_macehead"),
        (assign,":valid_processed_item","itm_heated_steel_axehead"),
    (else_try),
      (eq,":item_id","itm_finished_heated_iron_bar"),
        (assign,":valid_processed_item","itm_heated_iron_blade"),
    (else_try),
      (eq,":item_id","itm_heated_iron_blade"),
        (assign,":valid_processed_item","itm_heated_iron_short_blade"),
    (else_try),
      (eq,":item_id","itm_heated_iron_short_blade"),
        (assign,":valid_processed_item","itm_heated_iron_crossbowhead"),
    (else_try),
      (eq,":item_id","itm_finished_heated_steel_bar"),
        (assign,":valid_processed_item","itm_heated_steel_blade"),
    (else_try),
      (eq,":item_id","itm_heated_steel_blade"),
        (assign,":valid_processed_item","itm_heated_steel_short_blade"),
    (else_try),
      (eq,":item_id","itm_heated_steel_short_blade"),
        (assign,":valid_processed_item","itm_heated_steel_crossbowhead"),
    (else_try),
      (eq,":item_id","itm_finished_heated_iron_bar_long"),
        (assign,":valid_processed_item","itm_heated_iron_giant_blade"),
    (else_try),
      (eq,":item_id","itm_heated_iron_giant_blade"),
        (assign,":valid_processed_item","itm_heated_iron_long_blade"),
    (else_try),
      (eq,":item_id","itm_finished_heated_steel_bar_long"),
        (assign,":valid_processed_item","itm_heated_steel_giant_blade"),
    (else_try),
      (eq,":item_id","itm_heated_steel_giant_blade"),
        (assign,":valid_processed_item","itm_heated_steel_long_blade"),
    (try_end),

    (try_begin),
      (gt,":valid_processed_item",0),
      (call_script, "script_cf_agent_consume_item", ":agent_id", ":item_id", 1),
      (agent_equip_item, ":agent_id", ":valid_processed_item"),
      (agent_set_wielded_item, ":agent_id", ":valid_processed_item"),
      (call_script, "script_scene_prop_play_sound", ":instance_id", "snd_grindstone_use"),
    (try_end),
    
    ]),
    
  ("cf_process_bow_tiller",
   [generate_process_init(skill="skl_engineer", level=2, resource_class=item_class_wood),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    ...
    (try_begin),
      (eq,":item_id","itm_wood_pole"),
        (assign,":valid_processed_item","itm_wooden_long_bow_shape"),
    (else_try),
      (eq,":item_id","itm_wood_pole_short"),
        (assign,":valid_processed_item","itm_wooden_short_bow_shape"),
    (try_end),
    ...
    (try_begin),
      ...
      (agent_equip_item, ":agent_id", ":valid_processed_item"),
      (agent_set_wielded_item, ":agent_id", ":valid_processed_item"),
      (call_script, "script_scene_prop_play_sound", ":instance_id", "snd_draw_bow"),
    (try_end),
    
    ]),
    
  ##Metalworks ends here
   ...
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (call_script, "script_scene_prop_get_owning_faction", ":instance_id"),
        ##Wages
        (call_script, "script_cf_faction_issue_wages", reg0, 200, castle_wages_percentage),#give 2 gold to each faction member when resources are deposited
      (else_try),
        (eq, ":add_or_subtract", -1),
        (assign, ":tax_value", reg1),
        (call_script, "script_scene_prop_get_owning_faction", ":instance_id"),
        ##Wages
        (call_script, "script_cf_faction_issue_wages", reg0, ":tax_value", castle_wages_percentage),
  ...
  ("cf_buy_sell_item_stockpile", # server: handle players using an item or horse stockpile for buying and selling
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (else_try), # if the horse selling didn't respond with a failure message and the weapon hand is empty, try buy
      ...
      (this_or_next|gt, ":stock_count", 0),
      (eq, "$g_game_type", "mt_quick_battle"),
      (this_or_next|eq, ":weapon_item_id", "itm_potion_poison"),
      (this_or_next|eq, ":weapon_item_id", "itm_potion_toxin"),
      (eq, ":weapon_item_id", -1),
  ...
  ("scene_prop_get_item_crafting_refund_reward", # reg0 = the total money given, reg1 = the default cost of all resources, reg2 = the variable extra reward
   [(store_script_param, ":instance_id", 1), # must be valid
    ...
    (assign,":design_target_stock_count",10),
    (scene_prop_get_slot, ":stock_count", ":instance_id", slot_scene_prop_stock_count),
  ...
  ("cf_use_rotate_door", # server: handle opening and closing a rotating door
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (agent_get_slot,":shackled",":agent_id",slot_agent_shackled),##Agents cannot use rotating doors if they are shackled
    (neq,":shackled",1),
  ...
  ("cf_use_inventory", # server: reply with inventory contents of a scene prop when requested by a player
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (call_script, "script_agent_remove_empty_ammo_stacks", ":agent_id"),
    (assign, ":fail", 0),
    (scene_prop_get_slot,":shop",":instance_id", slot_scene_prop_inventory_is_shop), # Check for market stalls
    (try_begin),
      (scene_prop_slot_eq, ":instance_id", slot_scene_prop_full_hit_points, 0),
    (else_try),
      (eq,":shop",1), # Market stalls overide the keys so any player can access to buy
    (else_try),
      (scene_prop_slot_eq, ":instance_id", slot_scene_prop_unlocked, 1),
    (else_try),
      (call_script, "script_scene_prop_get_owning_faction", ":instance_id"),
      ...
      (try_begin), # for failures after this point, stay connected with the scene prop, to receive updates
        ...
        (try_begin), # checks for equipping items on the agent
          ...
          (else_try),
            (assign, ":item_id", -1),
          (try_end),
          (try_begin),# Market Stalls - Begin check
            (eq,":shop",1), # is a shop so check if player has enough cash to buy the item
            (ge,":item_id",0),
            (try_begin),
              (call_script, "script_cf_market_stall_get_owner_player", ":instance_id"),
              (store_item_value, ":gold_value", ":item_id"),
              (agent_get_wielded_item, ":wielded_item_id", ":agent_id", 0),
              (try_begin),
                (eq,reg20,":player_id"),# if its the owner of the shop dont check
              (else_try),#Check for picklock
                (try_begin),
                  (gt, ":wielded_item_id", -1),
                  (try_begin),
                    (item_slot_eq, ":wielded_item_id", slot_item_class, item_class_lock_pick),
                    (try_begin),
                      (call_script, "script_cf_agent_pick_lock", ":agent_id", 100),#Picklock through buy
                      (assign,":shopunlocked",1),
                      #(display_message,"@Unlocked"),#debug
                    (else_try),
                      (assign, ":item_id", -1),# failed to picklock
                    (try_end),
                  (else_try), # No picklock so check for gold
                    (call_script, "script_cf_check_enough_gold", ":player_id", ":gold_value"),
                  (else_try),
                    (assign, ":item_id", -1),# failed to have picklock and have cash
                  (try_end),
                (else_try),
                  (call_script, "script_cf_check_enough_gold", ":player_id", ":gold_value"),
                (else_try),
                  (assign, ":item_id", -1),# Doesnt have enough cash so ensure it fails
                (try_end),
              (try_end),
            (try_end),
          (try_end),# Market Stalls - End check
        ...
        (else_try),
          ...
          (try_begin),
            ...
            (try_end),
          (try_end),
          (try_begin),# Market stalls take the money off customers
            (eq,":shop",1),
            (store_item_value,":gold_cost",":item_id"),
            (call_script, "script_cf_market_stall_get_owner_player", ":instance_id"),#Make sure someone owns it
            (agent_get_wielded_item, ":wielded_item_id", ":agent_id", 0),
            (try_begin),
              (eq,reg20,":player_id"),# If its the owner taking out his stuff then dont take the gold
            (else_try),
              (try_begin),
                (gt, ":wielded_item_id", -1),
                (try_begin),
                  (item_slot_eq, ":wielded_item_id", slot_item_class, item_class_lock_pick),# No harm checking twice
                  (eq,":shopunlocked",1),
                  #(display_message,"@Stolen"),#debug
                (else_try),
                  (call_script, "script_player_adjust_gold", ":player_id", ":gold_cost", -1), # We already check if the agent has enough gold so just take the money
                  (call_script, "script_player_adjust_gold", reg20, ":gold_cost", 1), # give the owner the gold
                  (call_script, "script_scene_prop_get_owning_faction", ":instance_id"), # Had to call it again, Fuck knows
                  (try_begin),
                    (gt, reg1, -1), # ensure there is a owning faction before applying wages and castle money
                    (call_script, "script_cf_faction_issue_wages", reg0, 500, castle_wages_percentage),
                    (call_script, "script_castle_receive_gold", reg1, ":gold_cost", castle_tax_gold_percentage),
                  (try_end),
                (try_end),
              (else_try),
                (call_script, "script_player_adjust_gold", ":player_id", ":gold_cost", -1), # We already check if the agent has enough gold so just take the money
        ...
        (try_end),
      (try_end),
      (call_script, "script_cf_update_bank_inventory", ":player_id",0), # update the players inventory bank
    (else_try),
      (player_set_slot, ":player_id", slot_player_accessing_instance_id, 0),
      (call_script, "script_cf_update_bank_inventory", ":player_id",1), # clear the content for another player if its the bank
    (try_end),
    ]),
   ...
   [(store_script_param, ":attacked_agent_id", 1), # must be valid
    ...
    (else_try),
      ...
      (try_begin),
        (agent_get_troop_id, ":attacker_troop_id", ":attacker_agent_id"),
        (try_begin),
          (this_or_next|eq, ":attacker_troop_id", "trp_godlike_hero"),
          (this_or_next|eq, ":attacker_troop_id", "trp_event_hero"),
          (eq, ":attacker_troop_id", "trp_guide"),
    ...
    (else_try),
      ...
      (try_end),
    (else_try),
      (eq, ":weapon_item_id", "itm_toxin_dagger"),
      (try_begin),
        (gt, ":damage_dealt", 5),
        (call_script, "script_cf_agent_consume_item", ":attacker_agent_id", "itm_toxin_dagger", 1),
        (agent_equip_item, ":attacker_agent_id", "itm_dagger"),
        (agent_set_wielded_item, ":attacker_agent_id", "itm_dagger"),
        (agent_get_slot, ":poison", ":attacked_agent_id", slot_agent_poison_amount),
        (val_add, ":poison", 2),
      ...
      (try_end),
    (else_try),
      (eq,":weapon_item_id","itm_shackle"),
      (agent_get_animation, ":anim", ":attacked_agent_id", 1),
      (agent_get_slot,":shackled",":attacked_agent_id",slot_agent_shackled),
        (try_begin),
          (eq,":anim","anim_surrender"),
          (neq,":shackled",1),
            (agent_set_slot,":attacked_agent_id", slot_agent_shackled, 1),
            (agent_set_speed_modifier, ":attacked_agent_id", 85),
            (call_script, "script_cf_agent_drop_all_weapons", ":attacked_agent_id"),
        (else_try),
          (eq,":anim","anim_arrested"),
          (eq,":shackled",1),
          (agent_set_slot,":attacked_agent_id", slot_agent_shackled, 0),
          (agent_set_speed_modifier, ":attacked_agent_id", 100),
          (call_script, "script_cf_agent_drop_all_weapons", ":attacked_agent_id"),
        (try_end),
        (assign, ":damage_result", 0),
    (else_try),
      (is_between, ":weapon_item_id", "itm_lock_pick", "itm_admin_lock_pick"),
      (agent_get_animation, ":anim", ":attacked_agent_id", 1),
      (agent_get_slot,":shackled",":attacked_agent_id",slot_agent_shackled),
        (try_begin),
          (eq,":anim","anim_arrested"),
        ...
        (try_end),
        (assign, ":damage_result", 0),
    (else_try),#Training/Duels without death
      (is_between, ":weapon_item_id", "itm_practice_sword", "itm_training_weapons_end"),
        (agent_is_human, ":attacked_agent_id"),
        (agent_is_human, ":attacker_agent_id"),
        (agent_get_wielded_item, ":attacked_weapon_item_id", ":attacked_agent_id", 0),
        (try_begin),
          (is_between, ":attacked_weapon_item_id", "itm_practice_sword", "itm_training_weapons_end"),
          (call_script, "script_cf_do_custom_anims", ":attacked_agent_id", "anim_fall_down",0),
          (call_script, "script_cf_do_custom_anims", ":attacked_agent_id", "anim_fall_down",1),
          (agent_set_wielded_item,":attacked_agent_id",-1),
          (assign, ":damage_result", 0),
        (try_end),
    (try_end),
   ...
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (try_end),
      (try_end),
      (call_script, "script_cf_sleeping_tick", ":agent_id"),
      (agent_get_slot, ":food_amount", ":agent_id", slot_agent_food_amount),
      (try_begin),
        (gt, ":food_amount", 1),
        (store_agent_hit_points, ":hit_points", ":agent_id", 0),
  ...
  ("cf_use_butchering_knife", # server: check for nearby animal carcasses for the agent to butcher
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (try_begin), # first check the last carcass used, to save time
      ...
      (agent_get_slot, ":meat_type", ":agent_id", slot_agent_hunting_last_meat_type),
    ...
    (else_try), # otherwise check all other carcasses
      ...
      (try_for_range, ":other_carcass_no", 0, ":carcass_count"),
        ...
        (assign, ":meat_type", "itm_raw_meat"),
        (agent_set_slot, ":agent_id", slot_agent_hunting_last_carcass, ":other_carcass_instance_id"),
        (agent_set_slot, ":agent_id", slot_agent_hunting_last_meat_type, "itm_raw_meat"),
      (try_end),
      
      (scene_spawned_item_get_num_instances, ":human_count", "itm_human_carcass"),
      (try_for_range, ":human_carcass_no", 0, ":human_count"),
        (scene_spawned_item_get_instance, ":human_carcass_instance_id", "itm_human_carcass", ":human_carcass_no"),
        (scene_prop_slot_ge, ":human_carcass_instance_id", slot_animal_carcass_meat_count, 1),
        (prop_instance_get_position, pos2, ":human_carcass_instance_id"),
        (get_sq_distance_between_positions, ":h_sq_distance", pos1, pos2),
        (lt, ":h_sq_distance", sq(max_distance_to_use)),
        (assign, ":human_count", -1),
        (assign, ":found", 1),
        (assign, ":carcass_instance_id", ":human_carcass_instance_id"),
        (assign, ":meat_type", "itm_strange_meat"),
        (agent_set_slot, ":agent_id", slot_agent_hunting_last_carcass, ":human_carcass_instance_id"),
        (agent_set_slot, ":agent_id", slot_agent_hunting_last_meat_type, "itm_strange_meat"),
      (try_end),
    ...
    (else_try),
      ...
      (call_script, "script_set_random_spawn_position", 50),
      (spawn_item, ":meat_type", 0, "$g_spawn_item_prune_time"),
    (try_end),
    (try_begin),
      (le, ":hide_count", 0),
      (le, ":meat_count", 0),
  ...
  ("animal_check_grow", # server: check if the animal should grow into an adult or birth a child; reg0 = the animal agent id
   [(store_script_param, ":animal_agent_id", 1), # must be valid
    ...
    (try_begin),
      ...
      (item_get_slot, ":adult_item_id", ":animal_item_id", slot_item_animal_adult_item_id),
      #Check for alpha
      (item_get_slot, ":alpha_item_id", ":animal_item_id", slot_item_animal_alpha_item_id),
      (try_begin),
        (neq,":alpha_item_id",-1),
        (store_random_in_range,":alphachance",1,100),
        (item_get_slot, ":can_alpha", ":animal_item_id", slot_item_animal_alpha_chance),
        (le,":alphachance",":can_alpha"),
        (assign,":adult_item_id",":alpha_item_id"),
      (try_end),
      #Check for alpha
      (agent_get_position, pos1, ":animal_agent_id"),
      (set_spawn_position, pos1),
    ...
    (else_try),
      ...
      (try_begin), # wait one cycle after growing to adult before reproducing
        ...
        (try_begin),
          ...
          #No more children for a max herd
          (assign,":herd_size",0),
          (item_get_slot, ":loop_end", ":animal_item_id", slot_item_animal_max_in_herd),
          (try_for_range, ":herd_slot", 0, ":loop_end"),
            (scene_prop_get_slot, ":other_animal_agent_id", ":herd_manager", ":herd_slot"),
            ...
            (agent_get_item_id, ":other_animal_item_id", ":other_animal_agent_id"),
            (eq, ":other_animal_item_id", ":animal_item_id"),
            (eq, ":other_animal_item_id", ":child_item_id"),
            (val_add,":herd_size",1),
          (try_end),
          (neq,":herd_size",":loop_end"),
          #No more children for a max herd
  ...
  ("animal_move", # server: move animals, trying to avoid drowning and running into walls, following the herd leader; failing to reproduce and starving if the leader couldn't move far enough
   [(store_script_param, ":animal_agent_id", 1), # must be valid
    ...
    (try_begin),
      ...
      (val_mul, ":starvation_meat_loss", -2),
    ...
    (try_begin),
      ...
      #Remove Horse from herd if riding
      (agent_get_rider,":rider_id",":animal_agent_id"),
      (try_begin),
        (agent_is_active,":rider_id"),# If there is a rider remove the horse from the herd
        (call_script, "script_animal_remove_from_herd", ":animal_agent_id", ":herd_manager"),
  ...
  ("animal_hit", # server: handle animal reactions to being hit by various tools and weapons; the damage result is set for ti_on_agent_hit
   [(store_script_param, ":animal_agent_id", 1), # must be valid
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (call_script, "script_animal_add_to_nearby_herd", ":animal_agent_id", ":herd_manager"),
          (else_try),
            (call_script, "script_animal_add_to_nearby_herd", ":animal_agent_id", -1),
          (try_end),
    ...
    (else_try),
      ...
      (val_add, ":food", 1),
      (agent_get_item_id, ":animal_item_id", ":animal_agent_id"),
      (item_get_slot, ":meat_count", ":animal_item_id", slot_item_animal_meat_count),
  ...
  ("check_agent_drowning", # server: check whether the agent's mouth is below water level, dealing damage after a length of time
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (try_begin),
      (agent_is_alive, ":agent_id"),
      (call_script, "script_cf_drunk_tick", ":agent_id"), # Drunkness at its best
      (agent_get_troop_id, ":troop_id", ":agent_id"),
      (neq, ":troop_id", "trp_godlike_hero"),
      (neq, ":troop_id", "trp_event_hero"),
   ...
   [(store_script_param, ":poll_type", 1), # constants starting with poll_type_
    ...
    (try_begin),
      ...
      (else_try),
        ...
        (assign, ":poll_error", 0),
        (is_between, ":poll_faction_id", warlords_begin, factions_end),
  ...
  ("poll_vote", # server: handle player votes for polls
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    (try_begin),
      ...
      (ge, ":poll_faction_id", warlords_begin),
  ...
  ("check_polls_ended", # server: check all factions for polls that have ended
   [
    ...
    (try_for_range, ":poll_faction_id", warlords_begin, ":factions_end"),
  ...
  ("select_target_agent", # clients: find the agent projected closest to the center of the view, highlighting them and storing in $g_target_agent_id and $g_target_player_id
   [
    ...
    (try_for_agents, ":agent_id"),
      ...
      (agent_get_item_slot, ":body_item_id", ":agent_id", ek_body),
      (neq, ":body_item_id", "itm_invisible_head"),
      (agent_get_position, pos2, ":agent_id"),
      (position_move_z, pos2, 160),
  ...
  ("cf_admin_action", # server: check player requests to use admin tools, applying if successful
   [(store_script_param, ":admin_action", 1), # constants starting with admin_action_
    ...
    (else_try),
      ...
      (else_try),
        (eq, ":admin_action", admin_action_outlaw_player),
        (player_slot_eq, ":admin_player_id", slot_player_admin_no_factions, 0),
        (call_script, "script_player_change_check_outlaw_rating", ":target_player_id", outlaw_rating_for_lord_outlawed, 1),
      (else_try),
        (eq, ":admin_action", admin_action_warn_player),
        (player_slot_eq, ":admin_player_id", slot_player_admin_no_permanent_ban, 0),
        (multiplayer_send_3_int_to_player, ":admin_player_id", server_event_preset_message, "str_warning_admin_message", preset_message_player|preset_message_chat_log|preset_message_red, ":target_player_id"),
        (try_begin),
          (eq, "$g_name_server_enabled", 1),
          (str_store_string, s10, "str_http_server"),
          (neg|str_is_empty, s10),
          (str_store_string, s12, "str_http_server_password"),
          (neg|str_is_empty, s12),
          (player_get_unique_id, reg2, ":target_player_id"),
          (assign, reg3, ":target_player_id"),
          (str_store_string, s0, "str_http_warn_player"),
          (send_message_to_url, s0),
        (try_end),
      (else_try),
        (eq, ":admin_action", admin_action_karma_player),
        (player_slot_eq, ":admin_player_id", slot_player_admin_no_permanent_ban, 0),
        (multiplayer_send_3_int_to_player, ":admin_player_id", server_event_preset_message, "str_karma_admin_message", preset_message_player|preset_message_chat_log|preset_message_red, ":target_player_id"),
        (try_begin),
          (eq, "$g_name_server_enabled", 1),
          (str_store_string, s10, "str_http_server"),
          (neg|str_is_empty, s10),
          ...
          (player_get_unique_id, reg2, ":target_player_id"),
          (assign, reg3, ":target_player_id"),
          (str_store_string, s0, "str_http_karma_player"),
          (send_message_to_url, s0),
        (try_end),
      (else_try),
      ...
      (else_try),
        ...
        (try_begin),
          (player_slot_eq, ":admin_player_id", slot_player_admin_no_teleport_self, 0), # ensure we got the power to do that
            (player_get_agent_id, ":admin_agent_id", ":admin_player_id"),
            (agent_get_horse, ":horse_agent_id", ":agent_id"),
            (neg|gt,":horse_agent_id",-1),#if the agent is riding a horse we cant teleport him normally
            (agent_get_position, pos1, ":admin_agent_id"),
            (position_move_y, pos1, 100),
            (agent_set_position, ":agent_id", pos1),
        (try_end),
      ...
      (else_try),
        ...
        (this_or_next|player_slot_eq, ":admin_player_id", slot_player_admin_no_godlike_troop, 0),
        (this_or_next|player_slot_eq, ":admin_player_id", slot_player_admin_no_event_troop, 0),
        (player_slot_eq, ":admin_player_id", slot_player_admin_no_guide_troop, 0),
        ...
        (try_begin), # if the admin is already using the godlike hero, return to the previous troop
          (this_or_next|eq, ":troop_id", "trp_godlike_hero"),
          (this_or_next|eq, ":troop_id", "trp_event_hero"),
          (eq, ":troop_id", "trp_guide"),
        ...
        (else_try),
          ...
          (else_try),
            (player_slot_eq, ":admin_player_id", slot_player_admin_no_event_troop, 0),
              (assign, ":new_troop_id", "trp_event_hero"),
          (else_try),
            (player_slot_eq, ":admin_player_id", slot_player_admin_no_guide_troop, 0),
              (assign, ":new_troop_id", "trp_guide"), 
          (try_end),
        (try_end),
    ...
    (else_try),
      ...
      (try_for_agents, ":horse_agent_id"),
        (agent_get_item_id, ":horse_item_id", ":horse_agent_id"),
        (is_between,":horse_item_id","itm_stag","itm_cart_horse"),
    ...
    (else_try),
      ...
      (try_for_range, ":weapon_item_id", "itm_club", "itm_weapons_end"),
    ...
    (else_try),
      ...
      (try_for_range, ":cart_prop", "spr_pw_cart_a", "spr_code_carts_end"),
  ...
  ("cf_faction_admin_action", # server: check player requests to use faction lord tools, applying if successful
   [(store_script_param, ":action", 1), # constants starting with faction_admin_action_
    ...
    (try_begin),
      ...
      (call_script, "script_redraw_castle_banners", redraw_faction_banners, ":faction_id"),
    #(else_try),
    #  (eq, ":action", faction_admin_action_lock_faction),
    #  (is_between, ":faction_id", castle_factions_begin, factions_end),
    #  (faction_get_slot, ":locked", ":faction_id", slot_faction_is_locked),
    #  (try_begin),
    #    (eq, ":locked", 0),
    ...
    ##  (try_for_range, ":other_player_id", 1, ":max_players"),
     ...
     # (try_end),
    (else_try),
      (eq, ":action", faction_admin_action_set_marshal),
      (player_is_active, ":value_1"),
      (player_slot_eq, ":value_1", slot_player_faction_id, ":faction_id"),
      (player_get_slot, ":marshal", ":value_1", slot_player_is_marshal),
      (player_get_slot, ":steward", ":value_1", slot_player_is_steward),
      (neq,":marshal",1),
      (neq,":steward",1),
      (call_script, "script_cf_check_enough_gold", ":sender_player_id", faction_cost_assign_marshal),
      (call_script, "script_player_adjust_gold", ":sender_player_id", faction_cost_assign_marshal, -1),
      (player_get_unique_id, ":value_1_unique_id", ":value_1"),
      (call_script, "script_cf_faction_set_marshal", ":value_1", ":value_1_unique_id", ":faction_id"),
    (else_try),
      (eq, ":action", faction_admin_action_set_steward),
      (player_is_active, ":value_1"),
      (player_slot_eq, ":value_1", slot_player_faction_id, ":faction_id"),
      (player_get_slot, ":marshal", ":value_1", slot_player_is_marshal),
      (player_get_slot, ":steward", ":value_1", slot_player_is_steward),
      (neq,":marshal",1),
      (neq,":steward",1),
      (call_script, "script_cf_check_enough_gold", ":sender_player_id", faction_cost_assign_steward),
      (call_script, "script_player_adjust_gold", ":sender_player_id", faction_cost_assign_steward, -1),
      (player_get_unique_id, ":value_1_unique_id", ":value_1"),
      (call_script, "script_cf_faction_set_steward", ":value_1", ":value_1_unique_id", ":faction_id"),
    (else_try),
      (this_or_next|eq, ":action", faction_admin_action_kick_player),
      (eq, ":action", faction_admin_action_outlaw_player),
      (player_is_active, ":value_1"),
      (assign,":correct_fac",0),
      (try_begin),
        (player_slot_eq, ":value_1", slot_player_faction_id, ":faction_id"),
        (assign,":correct_fac",1),
      (else_try),
        (player_slot_eq, ":value_1", slot_player_faction_id, factions_begin),
        (player_slot_eq, ":sender_player_id", slot_player_faction_id, ":faction_id"),
        (assign,":correct_fac",1),
      (try_end),
      (eq,":correct_fac",1),
      ...
      (eq, ":continue", 1),
      (player_is_active,":value_1"),
      (player_get_troop_id, ":value_1_troop", ":value_1"),
      (try_begin),#If mercenary keep job
        (is_between,":value_1_troop",mercenarys_begin,mercenarys_end),
        (assign,":troop_id",":value_1_troop"),
      (else_try),#Else make peasant
        (try_begin),
          (eq, ":action", faction_admin_action_kick_player),
          (assign,":troop_id",playable_troops_begin),
          #Female troop types
          (player_get_gender, ":gender", ":value_1"),
          (try_begin),
            (eq,":gender",tf_female),
            (troop_get_slot, ":female_troop", ":troop_id", slot_troop_has_female),
            (try_begin),
          ...
          #Female end
        (else_try),
          (player_get_troop_id, ":troop_id", ":value_1"),
        (try_end),
      (try_end),
      (player_set_troop_id, ":value_1", ":troop_id"),
  ...
  ##Feudal World Scripts
  
  ("client_get_my_agent", # Remove when done
   [
     (assign, reg0, -1),
     (try_begin),
  ...
  ("setup_special_attributes", # server: Setup special slots
   [
    (try_for_range, ":faction_id", factions_begin, factions_end),
      (faction_set_slot, ":faction_id", slot_faction_culture, culture_none),
    (try_end),
   
    #Has female Troops
    (troop_set_slot,"trp_peasant",slot_troop_has_female,"trp_peasant_female"),
    (troop_set_slot,"trp_serf",slot_troop_has_female,"trp_serf_female"),
    (troop_set_slot,"trp_lord",slot_troop_has_female,"trp_lady"),
    (troop_set_slot,"trp_king",slot_troop_has_female,"trp_queen"),
    (troop_set_slot,"trp_mercenary_hired_blade",slot_troop_has_female,"trp_mercenary_sword_sister"),
    (troop_set_slot,"trp_huscarl",slot_troop_has_female,"trp_shieldmaiden"),
   
    #Female Troops
    (troop_set_slot,"trp_peasant_female",slot_troop_female,"trp_peasant"),
    (troop_set_slot,"trp_serf_female",slot_troop_female,"trp_serf"),
    (troop_set_slot,"trp_lady",slot_troop_female,"trp_lord"),
    (troop_set_slot,"trp_queen",slot_troop_female,"trp_king"),
    (troop_set_slot,"trp_mercenary_sword_sister",slot_troop_female,"trp_mercenary_hired_blade"),
    (troop_set_slot,"trp_shieldmaiden",slot_troop_female,"trp_huscarl"),
    
    ##Culture Troops
    #Swadian
    (troop_set_slot,"trp_man_at_arms",slot_troop_has_culture_swadian,"trp_knight"),
    (troop_set_slot,"trp_archer",slot_troop_has_culture_swadian,"trp_crossbowman"),
    
    #Rhodok
    (troop_set_slot,"trp_brigand",slot_troop_has_culture_rhodok,"trp_thief"),
    (troop_set_slot,"trp_archer",slot_troop_has_culture_rhodok,"trp_sharpshooter"),
    
    #Nord
    (troop_set_slot,"trp_ruffian",slot_troop_has_culture_nord,"trp_sea_raider"),
    (troop_set_slot,"trp_sergeant",slot_troop_has_culture_nord,"trp_huscarl"),
    
    #Sarranid
    (troop_set_slot,"trp_brigand",slot_troop_has_culture_sarranid,"trp_hashashin"),
    (troop_set_slot,"trp_man_at_arms",slot_troop_has_culture_sarranid,"trp_mamaluke"),
    (troop_set_slot,"trp_footman",slot_troop_has_culture_sarranid,"trp_slave"),
    (troop_set_slot,"trp_sergeant",slot_troop_has_culture_sarranid,"trp_guard"),
    
    #Vaegir
    (troop_set_slot,"trp_archer",slot_troop_has_culture_vaegir,"trp_marksman"),
    (troop_set_slot,"trp_sergeant",slot_troop_has_culture_vaegir,"trp_guard"),
    
    #Khergit
    (troop_set_slot,"trp_ruffian",slot_troop_has_culture_khergit,"trp_raider"),
    (troop_set_slot,"trp_lancer",slot_troop_has_culture_khergit,"trp_horse_archer"),
    (troop_set_slot,"trp_footman",slot_troop_has_culture_khergit,"trp_militia"),
    (troop_set_slot,"trp_sergeant",slot_troop_has_culture_khergit,"trp_footman"),
    
    #Townwatch
    (troop_set_slot,"trp_footman",slot_troop_has_culture_townwatch,"trp_watchman"),
    (troop_set_slot,"trp_archer",slot_troop_has_culture_townwatch,"trp_ranger"),
   
    #Special Names
    (troop_set_slot,"trp_peasant",slot_troop_special_name,1),
    (troop_set_slot,"trp_peasant_female",slot_troop_special_name,1),
    (troop_set_slot,"trp_serf",slot_troop_special_name,1),
    (troop_set_slot,"trp_serf_female",slot_troop_special_name,1),
    (troop_set_slot,"trp_ministrel",slot_troop_special_name,1),
    (troop_set_slot,"trp_traveler",slot_troop_special_name,1),
    (troop_set_slot,"trp_herdsman",slot_troop_special_name,1),
    (troop_set_slot,"trp_healer",slot_troop_special_name,1),
    (troop_set_slot,"trp_monk",slot_troop_special_name,1),
    (troop_set_slot,"trp_huntsman",slot_troop_special_name,1),
    (troop_set_slot,"trp_godlike_hero",slot_troop_special_name,1),
    (troop_set_slot,"trp_guide",slot_troop_special_name,1),
    (troop_set_slot,"trp_cultist",slot_troop_special_name,1),
    (troop_set_slot,"trp_beggar",slot_troop_special_name,1),
    
    #Advanced Classes
    (troop_set_slot,"trp_lord",slot_troop_can_advanced_leader,"trp_king"),
    (troop_set_slot,"trp_lady",slot_troop_can_advanced_leader,"trp_queen"),
    (troop_set_slot,"trp_bishop",slot_troop_can_advanced_leader,"trp_archbishop"),
    (troop_set_slot,"trp_doge",slot_troop_can_advanced_leader,"trp_patrician"),
    (troop_set_slot,"trp_warchief",slot_troop_can_advanced_leader,"trp_warlord"),
    (troop_set_slot,"trp_captain",slot_troop_can_advanced_leader,"trp_commander"),
    
    #Upkeep
    (troop_set_slot,"trp_footman",slot_troop_upkeep_price,200),
    (troop_set_slot,"trp_slave",slot_troop_upkeep_price,200),
    (troop_set_slot,"trp_archer",slot_troop_upkeep_price,200),
    (troop_set_slot,"trp_marksman",slot_troop_upkeep_price,300),
    (troop_set_slot,"trp_crossbowman",slot_troop_upkeep_price,200),
    (troop_set_slot,"trp_sharpshooter",slot_troop_upkeep_price,300),
    
    (troop_set_slot,"trp_lancer",slot_troop_upkeep_price,300),
    (troop_set_slot,"trp_horse_archer",slot_troop_upkeep_price,300),
    
    (troop_set_slot,"trp_sergeant",slot_troop_upkeep_price,400),
    (troop_set_slot,"trp_huscarl",slot_troop_upkeep_price,400),
    (troop_set_slot,"trp_shieldmaiden",slot_troop_upkeep_price,400),
    (troop_set_slot,"trp_guard",slot_troop_upkeep_price,400),
    
    (troop_set_slot,"trp_sailor",slot_troop_upkeep_price,200),
    
    (troop_set_slot,"trp_knight",slot_troop_upkeep_price,400),
    (troop_set_slot,"trp_man_at_arms",slot_troop_upkeep_price,400),
    (troop_set_slot,"trp_mamaluke",slot_troop_upkeep_price,400),

    (troop_set_slot,"trp_watchman",slot_troop_upkeep_price,200),
    (troop_set_slot,"trp_ranger",slot_troop_upkeep_price,200),
    
    (troop_set_slot,"trp_mercenary_crossbowman",slot_troop_upkeep_price,200),
    (troop_set_slot,"trp_mercenary_cavalry",slot_troop_upkeep_price,300),
    (troop_set_slot,"trp_mercenary_hired_blade",slot_troop_upkeep_price,200),
    (troop_set_slot,"trp_mercenary_sword_sister",slot_troop_upkeep_price,200),
    
    #Can be poisoned items
    (item_set_slot,"itm_dagger",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_arrows",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_barbed_arrows",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_khergit_arrows",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_bodkin_arrows",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_apple_a",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_apple_b",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_carrot",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_cabbage",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_fish",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_cooked_fish",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_bread",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_beer_cask",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_beer_jug",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_grapes",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_must_barrel",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_wine_barrel",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_wine_jar",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_raw_meat",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_cooked_meat",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_meat_pie",slot_item_can_be_poisoned,1),
    (item_set_slot,"itm_apple_pie",slot_item_can_be_poisoned,1),
    
    #Item types set
    (item_set_slot,"itm_potion_fire",slot_item_class,item_class_alchemy),
    (item_set_slot,"itm_potion_dragon_fire",slot_item_class,item_class_fuel),
    ]),
    
  ("cf_spawn_random_herb", # server: Handle randomized herb locations and herb type
   [(multiplayer_is_server),
    (store_script_param, ":scene_prop", 1), # must be valid

    (str_store_string, s1, "str_http_server"),
    (neg|str_is_empty, s1),
    
    (assign, reg2, ":scene_prop"),
    
    (assign, reg3, 0),#chancelow
    (assign, reg4, 100),#chancehigh
    (assign, reg5, "spr_fw_alchemy_herb_rosemary"),#herblow
    (assign, reg6, "spr_fw_alchemy_herb_saffron"),#herbhigh
    (assign, reg7, 8),#minrange
    (assign, reg8, 15),#maxrange
    
    (str_store_string, s0, "str_http_get_herbs"),
  ...
  ("cf_sleeping_tick", # server: Handle sleeping
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (agent_is_active,":agent_id"),
    (agent_is_alive,":agent_id"),
    ...
    (try_begin),
      (eq,":anim", "anim_sleep"),
        #(call_script, "script_cf_play_global_agent_sound", ":agent_id", "snd_sleeping", 0),
        (agent_play_sound, ":agent_id", "snd_sleeping"),
        (call_script, "script_cf_rest", ":agent_id", 0, 15, 10),
    (try_end),
    ]),
    
  ("cf_drink", # server: Handle drinking
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":item_id", 2), # must be valid
    (agent_is_alive, ":agent_id"),
    (agent_get_action_dir, ":direction", ":agent_id"),
    (eq, ":direction", 0),
    (item_get_slot, ":drunk_add", ":item_id", slot_item_resource_amount),
    (gt, ":drunk_add", 0),
    (agent_get_slot, ":drunk_amount", ":agent_id", slot_agent_drunkness),
    (val_add, ":drunk_amount", ":drunk_add"),
    (val_min, ":drunk_amount", max_food_amount),
    (agent_set_slot, ":agent_id", slot_agent_drunkness, ":drunk_amount"),
    (call_script, "script_cf_eat_food", ":agent_id", ":item_id"),
  ]),
    
  ("cf_drunk_tick", # server: Handle drunkness
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (agent_is_active,":agent_id"),
    (agent_is_alive,":agent_id"),
    ...
    (try_begin),
      ...
      (try_begin),
        (eq,":random",1),
        (call_script, "script_cf_do_custom_anims", ":agent_id", "anim_strike_chest_right",1),
      (else_try),
        (eq,":random",2),
        (call_script, "script_cf_do_custom_anims", ":agent_id", "anim_strike_chest_left",1),
      (else_try),
        (eq,":random",3),
        (call_script, "script_cf_do_custom_anims", ":agent_id", "anim_strike_head_back",1),
      (else_try),
        (eq,":random",4),
        (call_script, "script_cf_do_custom_anims", ":agent_id", "anim_strike_legs_front",1),
      (try_end),
      (val_sub, ":drunk_amount", 1),
      (agent_set_slot, ":agent_id", slot_agent_drunkness, ":drunk_amount"),
    (try_end),
    ]),
  ...
  ("cf_use_bank_money_chest", # server and clients: handle depositing to and withdrawing from a bank chest. the client version just does the checks, the server version also applies changes
   [(store_script_param, ":player_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    (store_script_param, ":gold_value", 3), # positive values to deposit, negative to withdraw
    ...
    (try_begin),
      ...
      (neq, ":gold_value", 0),
      (assign, ":fail_message", "str_no_money_chest_nearby"),
      (call_script, "script_cf_can_use_scene_prop", ":player_id", ":instance_id", "spr_fw_bank_money_chest"),
      (player_get_slot, ":chest_gold", ":player_id", slot_player_bank_amount),
    ...
    (try_begin),
      ...
      (try_begin),
        (multiplayer_is_server),
        (player_set_slot, ":player_id", slot_player_bank_amount, ":chest_gold"),
        (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_bank_amount, ":chest_gold"),
        (call_script, "script_cf_player_update_bank_url", ":player_id"),
      (else_try),
        (multiplayer_send_3_int_to_server, client_event_transfer_bank_gold, ":instance_id", ":gold_value"),
      (try_end),
    (else_try),
      (multiplayer_is_server),
      (gt, ":fail_message", 0),
  ...
  ("cf_bank_horse", # server: handle banking horses in a stable
   [(store_script_param, ":agent_id", 1), # must be valid
   (store_script_param, ":instance_id", 2), # must be valid
    ...
    (agent_is_alive, ":horse_agent_id"),
    (agent_get_item_id, ":horse_item_id", ":horse_agent_id"),
    (is_between, ":horse_item_id", all_items_begin, all_items_end),
    (agent_slot_eq, ":horse_agent_id", slot_agent_horse_last_rider, ":agent_id"),
    (agent_get_rider, ":rider_agent_id", ":horse_agent_id"),
    (assign, ":error_string_id", "str_dismount_to_bank"),
    (try_begin), # only allow selling horses that were last ridden by the player, are not badly wounded, and are close enough to the stockpile
      (neq, ":rider_agent_id", ":agent_id"),
      (assign, ":error_string_id", -1),
      (eq, ":rider_agent_id", -1),
      (assign, ":error_string_id", "str_horse_too_wounded_to_bank"),
      (store_agent_hit_points, ":horse_hit_points", ":horse_agent_id", 0),
      (gt, ":horse_hit_points", 25),
      (assign, ":error_string_id", -1),
      (store_mission_timer_a, ":time"),
      (player_get_slot, ":last_action_time", ":player_id", slot_player_last_action_time),
      (store_sub, ":interval", ":time", ":last_action_time"),
    ...
    (try_end),
    (eq, ":error_string_id", 0),
    (player_set_slot, ":player_id", slot_player_stable, ":horse_item_id"),
    (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_stable, ":horse_item_id"),
    (player_set_slot, ":player_id", slot_player_stable_health, ":horse_hit_points"),
    (agent_fade_out, ":horse_agent_id"),
    (call_script, "script_scene_prop_play_sound", ":instance_id", "snd_horse_low_whinny"),
    (call_script, "script_cf_player_update_horse_url", ":player_id"),
    ]),
    
  ("cf_bank_retrieve_horse", # server: handle retrieving horses in a stable
   [(store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    (agent_get_player_id, ":player_id", ":agent_id"),
    (player_is_active, ":player_id"),
    
    (player_get_slot, ":horse_id", ":player_id", slot_player_stable),
    (player_get_slot, ":hp", ":player_id", slot_player_stable_health),
    (item_get_type, ":item_type", ":horse_id"),
    (try_begin),
      (eq, ":item_type", itp_type_horse),
      (prop_instance_get_position, pos1, ":instance_id"),
      (position_rotate_y_floating,pos1,180),
      (try_begin),
        (neg|item_slot_eq, ":horse_id", slot_item_animal_adult_item_id, 0),
        (item_get_slot, ":adult_item_id", ":horse_id", slot_item_animal_adult_item_id),
        (gt, ":adult_item_id", 0),
        (val_add, "$g_herd_animal_count", 1),
        (set_spawn_position, pos1),
        (spawn_horse, ":horse_id"),
        (assign, ":horse_agent_id", reg0),
        (agent_set_slot, ":horse_agent_id", slot_agent_animal_herd_manager, -1),
        (agent_set_slot, ":horse_agent_id", slot_agent_animal_carcass_instance_id, -1),
        (call_script, "script_animal_add_to_nearby_herd", ":horse_agent_id", -1),
        (store_mission_timer_a, ":time"),
        (try_begin),
          (eq, ":horse_id", ":adult_item_id"),
          (item_get_slot, ":grow_time", ":horse_id", slot_item_animal_grow_time),
          (val_sub, ":time", ":grow_time"),
        (try_end),
        (val_max, ":time", 1),
        (agent_set_slot, ":horse_agent_id", slot_agent_animal_birth_time, ":time"),
      (else_try),
        (set_spawn_position, pos1),
        (spawn_horse, ":horse_id"),
        (assign, ":horse_agent_id", reg0),
      (try_end),
      (call_script, "script_scene_prop_play_sound", ":instance_id", "snd_horse_low_whinny"),
      (player_set_slot, ":player_id", slot_player_stable, 0),
      (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_stable, 0),
      (agent_is_active,":horse_agent_id"),
      (agent_set_hit_points, ":horse_agent_id", ":hp", 0),
      (call_script, "script_cf_player_update_horse_url", ":player_id"),
    (else_try),
      (player_set_slot, ":player_id", slot_player_stable, 0),
      (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_stable, 0),
  ...
  ("cf_use_bank_inventory", # server: Setup the props inside the scene prop
   [(store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    ...
    (agent_get_player_id, ":player_id", ":agent_id"),
    (player_is_active, ":player_id"),
    #(player_slot_ge, ":player_id", slot_player_bank_instance_id, 0),
    
    (agent_get_slot,":shackled",":agent_id",slot_agent_shackled),##Agents cannot use teleporting doors if they are shackled
    (neq,":shackled",1),

    (try_begin),
      (scene_prop_slot_eq, ":instance_id", slot_scene_prop_in_use, 0), #ensure the prop isnt in use
      
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_count, 20),# make this players slot
      (multiplayer_send_3_int_to_player, ":player_id", server_event_scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_count, 20),# make this players slot
      
      (scene_prop_get_slot, ":inventory_slot_end", ":instance_id", slot_scene_prop_inventory_count),
      (gt, ":inventory_slot_end", 0),
      (store_add,":slot_end",slot_scene_prop_inventory_begin,":inventory_slot_end"),
      
      (assign,":bank_slot",slot_player_bank_instance_id), # use this constant due to us adding 1 on each check
      
      (try_for_range, ":inventory_slot", slot_scene_prop_inventory_begin, ":slot_end"),
        (val_add,":bank_slot",1),
        (player_get_slot, ":bank_item", ":player_id", ":bank_slot"),
        (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":bank_item"),
      (try_end),

      (player_set_slot, ":player_id", slot_player_bank_instance_id, ":instance_id"),
      (scene_prop_set_slot,":instance_id", slot_scene_prop_in_use, 1),
      (call_script, "script_cf_use_inventory", ":agent_id", ":instance_id", 0),
    (try_end),
    ]),
  
  ("cf_update_bank_inventory", # server: handle the update to players slots
   [(store_script_param, ":player_id", 1), # must be valid
    (store_script_param, ":finish", 2), # must be valid
    (player_get_slot, ":last_instance_id", ":player_id", slot_player_bank_instance_id),
    (prop_instance_is_valid, ":last_instance_id"),
    
    (scene_prop_slot_eq, ":last_instance_id", slot_scene_prop_inventory_is_bank, 1),

    (scene_prop_get_slot, ":inventory_slot_end", ":last_instance_id", slot_scene_prop_inventory_count),
    (gt, ":inventory_slot_end", 0),
    (store_add,":slot_end",slot_scene_prop_inventory_begin,":inventory_slot_end"),
    ...
    (try_for_range, ":inventory_slot", slot_scene_prop_inventory_begin, ":slot_end"),
      (val_add,":bank_slot",1),
      (scene_prop_get_slot, ":scene_item_id", ":last_instance_id", ":inventory_slot"),
      (player_set_slot, ":player_id", ":bank_slot", ":scene_item_id"),
    (try_end),
    
    (try_begin),
      (eq,":finish",1),
      (call_script, "script_cf_finish_bank_inventory", ":player_id"), 
    (try_end),
    ]),
    
  ("cf_finish_bank_inventory", # server: this will clear the bank inventory and send the update to the url
   [(store_script_param, ":player_id", 1), # must be valid
    (player_get_slot, ":last_instance_id", ":player_id", slot_player_bank_instance_id),
    (prop_instance_is_valid, ":last_instance_id"),
    (scene_prop_slot_eq, ":last_instance_id", slot_scene_prop_inventory_is_bank, 1),
    ...
    (val_add, ":inventory_slot_end", slot_scene_prop_inventory_begin),
    (try_for_range, ":inventory_slot", slot_scene_prop_inventory_begin, ":inventory_slot_end"),
      (scene_prop_set_slot, ":last_instance_id", ":inventory_slot", 0),
    (try_end),
    (scene_prop_set_slot,":last_instance_id", slot_scene_prop_in_use, 0),
    (scene_prop_set_slot, ":last_instance_id", slot_scene_prop_inventory_count, 0),
    (player_set_slot, ":player_id", slot_player_bank_instance_id, -1),
    ]),
  
  ("cf_admin_arrows", # server: Do admin arrow effects
   [(multiplayer_is_server),
    (store_script_param, ":victim", 1), # must be valid
    (store_script_param, ":pos", 2), # must be valid
    (assign,":agent_id",-1),
    (try_begin),
      (eq,":victim",1),# ensure its a agent that was hit
      (assign,":distance",250),# Set max distance away
      (try_for_agents,":target"),
        (agent_is_active,":target"),
        (agent_get_position,pos2,":target"),
        (get_distance_between_positions,":get_dist",":pos",pos2),
          (try_begin),
              (le,":get_dist",":distance"),#Compare values and keep going until the closest target is the agent that was hit
              (assign,":distance",":get_dist"),#Keep lowering the distance value to see if other agents are closer
              (assign,":agent_id",":target"),#Set target
          (try_end),
      (try_end),
  ...
  ("cf_poison_arrows", # server: Do poison arrow effects
   [(multiplayer_is_server),
    (store_script_param, ":attacker_id", 1), # must be valid
    (store_script_param, ":victim", 2), # must be valid
    (store_script_param, ":pos", 3), # must be valid
    ...
    (try_begin),
      ...
      (agent_get_slot, ":poison", ":agent_id", slot_agent_poison_amount),
      (val_add, ":poison", ":amount"),
      (agent_set_slot, ":agent_id", slot_agent_poison_amount, ":poison"),
      (agent_set_slot, ":agent_id", slot_agent_poisoner_agent_id, ":attacker_id"),
      (try_begin),
        (agent_get_player_id, ":attacker_player_id", ":attacker_id"),
        (player_is_active, ":attacker_player_id"),
        (player_get_unique_id, ":attacker_player_uid", ":attacker_player_id"),
      (else_try),
        (assign, ":attacker_player_uid", -1),
      (try_end),
      (agent_set_slot, ":agent_id", slot_agent_poisoner_player_uid, ":attacker_player_uid"),
    (try_end),
    ]),
    
  ("cf_pitch_setup", # server: Setup spawnable pitch
  [(multiplayer_is_server),
    (store_script_param, ":attacker_id", 1), # must be valid
    (store_script_param, ":pos", 2), # must be valid
    
    (agent_get_position,pos2,":attacker_id"),
    (position_copy_rotation,":pos",pos2),
    (call_script, "script_reuse_or_spawn_scene_prop", "spr_code_pitch_pile"), 
    (prop_instance_set_position, reg0, ":pos"),
    (prop_instance_refill_hit_points, reg0),
  ]),
  
  ("cf_pitch_tick", # server: Pitch tick
  [(multiplayer_is_server),
    (scene_prop_get_num_instances, ":max_pitch", "spr_code_pitch_pile"),
    (try_for_range, ":pitch_no", 0, ":max_pitch"),
      (scene_prop_get_instance, ":pitch", "spr_code_pitch_pile", ":pitch_no"), # Validity check
      (prop_instance_is_valid, ":pitch"), # Check again to make sure its valid
      (scene_prop_slot_ge,":pitch",slot_scene_prop_on_fire,1),# Is the prop on fire
      (scene_prop_get_hit_points, ":health", ":pitch"),
      (try_begin),
        (ge,":health",0),
          (prop_instance_get_position, pos1, ":pitch"),
          (try_begin),#Normal fire
            (scene_prop_slot_eq,":pitch",slot_scene_prop_on_fire,1),
            (store_random_in_range,":damage",8,20),
            (particle_system_burst, "psys_pitch_fire", pos1, 50),
            (call_script, "script_cf_burn_position", 1, pos1, 10), # Set other props on fire around this object
          (else_try),#Dragon fire
            (scene_prop_slot_eq,":pitch",slot_scene_prop_on_fire,2),
            (store_random_in_range,":damage",8,40),
            (particle_system_burst, "psys_pitch_dragon_fire", pos1, 50),
            (call_script, "script_cf_burn_position", 2, pos1, 10), # Set other props on fire around this object
          (try_end),
          
          (val_sub,":health",1),
          (scene_prop_set_cur_hit_points, ":pitch", ":health"),

          (try_for_agents, ":agent_id"),# Deal damage to agents
            (agent_is_active,":agent_id"),
            (agent_is_alive,":agent_id"),
            (agent_get_position,pos2,":agent_id"),
            (get_distance_between_positions,":distance",pos1,pos2),
            (le,":distance",225),# Is the agent close enough to get damaged
            (store_agent_hit_points, ":hit_points", ":agent_id", 1),
            (val_sub, ":hit_points", ":damage"),
            (agent_set_hit_points, ":agent_id", ":hit_points", 1),
            (try_begin),
              (agent_is_human,":agent_id"),
              (store_random_in_range,":anim",1,2),
              (try_begin),
                (eq,":anim",1),
                (call_script, "script_cf_do_custom_anims", ":agent_id", "anim_strike_legs_right",1),
              (else_try),
                (call_script, "script_cf_do_custom_anims", ":agent_id", "anim_strike_legs_left",1),
              (try_end),
              (le,":hit_points",0),
          ...
          (try_end),
      (else_try),
        (call_script, "script_remove_scene_prop", ":pitch","spr_code_pitch_pile"),
        (scene_prop_set_slot,":pitch",slot_scene_prop_on_fire,0),
      (try_end),
    (try_end),
  ]),
  
  ("cf_burn_position", # server: Do burning at position
   [(multiplayer_is_server),
    (store_script_param, ":fire_type", 1),
    (store_script_param, ":pos", 2), # must be valid
    (store_script_param, ":radius", 3), # must be valid
    (try_begin),#Pitch
      (scene_prop_get_num_instances, ":max_pitch", "spr_code_pitch_pile"),
      (assign,":maxdistance",230),# Set max distance away
      (try_for_range, ":pitch_no", 0, ":max_pitch"),
        (scene_prop_get_instance, ":pitch", "spr_code_pitch_pile", ":pitch_no"), # Validity check
        (prop_instance_is_valid, ":pitch"), # Check again to make sure its valid
        (scene_prop_slot_eq,":pitch",slot_scene_prop_on_fire,0),# is the scene prop not on fire
        (prop_instance_get_position, pos3, ":pitch"),
        (get_distance_between_positions,":distance",":pos",pos3),
        (val_add,":maxdistance",":radius"),
        (le,":distance",":maxdistance"),
        (scene_prop_set_slot,":pitch",slot_scene_prop_on_fire,":fire_type"),
      (try_end),
    (try_end),
    ]),
  
  ("cf_extinguish", # server: Used for chucking water buckets and extinguishing flames
   [(multiplayer_is_server),
    (store_script_param, ":pos", 1), # must be valid
    (particle_system_burst, "psys_water_bucket_splash", ":pos", 100),
    (set_spawn_position, ":pos"),
    (spawn_item, "itm_bucket", 0, "$g_spawn_item_prune_time"),
    (scene_prop_get_num_instances, ":max_pitch", "spr_code_pitch_pile"),
    (assign,":maxdistance",400),# Set max distance away
    (try_for_range, ":pitch_no", 0, ":max_pitch"),
      (scene_prop_get_instance, ":pitch", "spr_code_pitch_pile", ":pitch_no"), # Validity check
      (prop_instance_is_valid, ":pitch"), # Check again to make sure its valid
      (prop_instance_get_position, pos3, ":pitch"),
      (get_distance_between_positions,":distance",":pos",pos3),
      (le,":distance",":maxdistance"),
      (scene_prop_slot_eq,":pitch",slot_scene_prop_on_fire,1),#Only normal fire can be extinguished
      (scene_prop_set_cur_hit_points, ":pitch", 1),
      (particle_system_burst, "psys_game_water_splash_2", pos3, 100),
    (try_end),
    ]),
    
  ("cf_siege_ladder", # server: Deploy ladder
  [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":item_id", 2), # must be valid
    (store_script_param, ":ladder_prop", 3), # must be valid
    (call_script, "script_cf_agent_consume_item", ":agent_id", ":item_id", 1),
    (agent_get_position,pos2,":agent_id"),
    (position_move_z,pos2,15),
    (position_move_y, pos2, 100),
    (call_script, "script_reuse_or_spawn_scene_prop", ":ladder_prop"),
    (assign,":instance_id",reg0),
    (scene_prop_set_slot,":instance_id", slot_scene_prop_in_use, 0),
    (scene_prop_set_slot,":instance_id", slot_scene_prop_item_id, ":item_id"),
    (prop_instance_set_position, ":instance_id", pos2),
    (prop_instance_get_position, pos1, ":instance_id"),
    (position_rotate_x,pos1,-88),
    (set_fixed_point_multiplier, 1),
    (prop_instance_animate_to_position, ":instance_id", pos1, 200),
  ]),
  
  ("cf_ladder_collision", # server: Ladder check for impact
  [(multiplayer_is_server),
  (try_for_range, ":ladder_type", ladders_start, ladders_end),
    (scene_prop_get_num_instances, ":max_prop", ":ladder_type"),
    (try_for_range, ":ladder_no", 0, ":max_prop"),
      (scene_prop_get_instance, ":instance_id", ":ladder_type", ":ladder_no"), # Validity check
      ...
      (try_begin),
        ...
        (scene_prop_set_slot,":instance_id", slot_scene_prop_in_use, 1),
        (prop_instance_get_position, pos2, ":instance_id"),
        (call_script, "script_remove_scene_prop", ":instance_id",":ladder_type"),
        (val_add,":ladder_type",ladders_amount),
        (call_script, "script_reuse_or_spawn_scene_prop", ":ladder_type"),
        ...
        (try_for_range, ":player_id", 1, ":max_players"),
          (player_is_active, ":player_id"),
          (multiplayer_send_2_int_to_player, ":player_id", server_event_update_scene_prop_update_physics, reg0, 1),
        (try_end),
      (try_end),
    (try_end),
  (try_end),
  ...
  ("cf_ladder_collision_death", # server: Ladder check for death
  [(multiplayer_is_server),
  (try_for_range, ":ladder_type", ladders_start, ladders_end),
    (scene_prop_get_num_instances, ":max_prop", ":ladder_type"),
    (try_for_range, ":ladder_no", 0, ":max_prop"),
      ...
      (try_begin),
        ...
        (assign,":remove",0),
        (try_begin),
          (scene_prop_slot_eq,":instance_id",slot_scene_prop_in_use,0),
          (assign,":remove",1),
        (try_end),
        (eq,":remove",1),
        (set_spawn_position, pos2),
        (scene_prop_get_slot,":item_id",":instance_id",slot_scene_prop_item_id),
        (spawn_item, ":item_id", 0, "$g_spawn_item_prune_time"),
        (call_script, "script_scene_prop_play_sound", ":instance_id", "snd_dummy_hit"),
        (call_script, "script_remove_scene_prop", ":instance_id",":ladder_type"),
        (prop_instance_enable_physics, ":instance_id", 1),
        (get_max_players, ":max_players"),
        (try_for_range, ":player_id", 1, ":max_players"),
          (player_is_active, ":player_id"),
          (multiplayer_send_2_int_to_player, ":player_id", server_event_update_scene_prop_update_physics, ":instance_id", 1),
        (try_end),
        (scene_prop_set_slot,":instance_id", slot_scene_prop_in_use, 1),
      (try_end),
    (try_end),
  ...
  ("cf_hit_ladder", # server: Handles digging of props
  [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    (store_script_param, ":attack_pos", 3), # must be valid
    (scene_prop_get_slot,":hidden",":instance_id",slot_scene_prop_state),
    (neq,":hidden",scene_prop_state_hidden), # Ensure the prop isnt dead
    (particle_system_burst, "psys_dummy_straw", ":attack_pos", 30),
    (particle_system_burst, "psys_gourd_piece_2", ":attack_pos", 2),
    (call_script, "script_hit_scene_prop_play_sound", ":agent_id", ":instance_id", "snd_dummy_hit"),
    (scene_prop_get_hit_points, ":hp", ":instance_id"),
    (scene_prop_get_slot,":break_hp",":instance_id",slot_scene_prop_next_resource_hp),
    (try_begin),
      (le,":hp",":break_hp"),
      (prop_instance_get_position, pos2, ":instance_id"),
      (position_set_z_to_ground_level, pos2),
  ...
  ("cf_ladder_death", # server: Ladder check for impact
  [(multiplayer_is_server),
  (try_for_range, ":ladder_type", deployed_ladders_start, deployed_ladders_end),
    (scene_prop_get_num_instances, ":max_prop", ":ladder_type"),
    (try_for_range, ":ladder_no", 0, ":max_prop"),
      (scene_prop_get_instance, ":instance_id", ":ladder_type", ":ladder_no"), # Validity check
      (prop_instance_is_valid, ":instance_id"), # Check again to make sure its valid
      ...
      (try_begin),
        ...
        (assign,":remove",0),
        (try_begin),
          (scene_prop_slot_eq,":instance_id",slot_scene_prop_in_use,1),
          (assign,":remove",1),
        (else_try),
          (this_or_next|eq,":rotation",0),
          (this_or_next|is_between, ":rotation", 0, 10),
          (is_between, ":rotation", 355, 360),
          (set_spawn_position, pos2),
          (scene_prop_get_slot,":item_id",":instance_id",slot_scene_prop_item_id),
          (spawn_item, ":item_id", 0, "$g_spawn_item_prune_time"),
          (call_script, "script_scene_prop_play_sound", ":instance_id", "snd_dummy_hit"),
        ...
        (scene_prop_set_slot, ":instance_id", slot_scene_prop_state, scene_prop_state_hidden),
        (scene_prop_set_slot,":instance_id", slot_scene_prop_in_use, 0),
        (scene_prop_get_max_hit_points, ":maxhp", ":instance_id"),
        (scene_prop_set_hit_points, ":instance_id", ":maxhp"),
        (prop_instance_enable_physics, ":instance_id", 1),
        (get_max_players, ":max_players"),
        (try_for_range, ":player_id", 1, ":max_players"), # remove the status of any previous lord of the faction
          (player_is_active, ":player_id"),
          (multiplayer_send_2_int_to_player, ":player_id", server_event_update_scene_prop_hit_points, ":instance_id", ":maxhp"),
          (multiplayer_send_2_int_to_player, ":player_id", server_event_update_scene_prop_update_physics, ":instance_id", 1),
        (try_end),
      (try_end),
    (try_end),
  ...
  ("cf_update_mannequins", # server: This is called whenever an update is required of the mannequins
  [(multiplayer_is_server),
    (store_script_param, ":faction_id", 1), # must be valid

    (try_for_range, ":mannequin", "spr_code_mannequin_head", "spr_code_mannequin_end"),
      (scene_prop_get_num_instances, ":parts_amount", ":mannequin"),
      (try_for_range, ":manak_no", 0, ":parts_amount"),
        (scene_prop_get_instance, ":manak_id", ":mannequin", ":manak_no"),
        (prop_instance_is_valid, ":manak_id"),
        (call_script, "script_scene_prop_get_owning_faction", ":manak_id"),
        
        (eq,reg0,":faction_id"), # if the mannequin is owned by the faction whos updated retrieve the data
        (scene_prop_get_slot, ":base_id", ":manak_id", slot_scene_prop_linked_scene_prop),
        (prop_instance_is_valid, ":base_id"),
        (prop_instance_get_scene_prop_kind, ":base_type", ":base_id"),
        (eq,":base_type","spr_fw_mannequin"), #Ensure we have the right base prop
        (faction_get_slot, ":banner_id", ":faction_id", slot_faction_banner_mesh),
        (try_begin),
          (eq, "$g_name_server_enabled", 1),
          (str_store_string, s1, "str_http_server"),
          (neg|str_is_empty, s1),
          ...
          (assign,reg2,":manak_id"),
          (assign,reg3,":banner_id"),
          
          (str_store_string, s0, "str_http_get_mannequin_data"),
          
          (prop_instance_get_variation_id_2, ":armour_type", ":base_id"),
          (try_begin),
            (eq,":armour_type",0),
            (str_store_string, s0, "str_http_s0_light"),
          (else_try),
            (eq,":armour_type",1),
            (str_store_string, s0, "str_http_s0_medium"),
          (else_try),
            (eq,":armour_type",2),
            (str_store_string, s0, "str_http_s0_heavy"),
          (try_end),
          
          (prop_instance_get_scene_prop_kind, ":type", ":manak_id"),
          (try_begin),
            (eq,":type","spr_code_mannequin_head"),
            (str_store_string, s0, "str_http_s0_head"),
          (else_try),
            (eq,":type","spr_code_mannequin_torso"),
            (str_store_string, s0, "str_http_s0_chest"),
          (else_try),
            (eq,":type","spr_code_mannequin_arms"),
            (str_store_string, s0, "str_http_s0_gloves"),
          (else_try),
            (eq,":type","spr_code_mannequin_legs"),
            (str_store_string, s0, "str_http_s0_boots"),
          (try_end),
  ...
  ("cf_setup_graves", # server: Setup graves
  [(multiplayer_is_server),
    (store_script_param, ":instance_id", 1), # must be valid
    
    (prop_instance_get_position, pos1, ":instance_id"),
    (set_spawn_position, pos1),
    (spawn_scene_prop, "spr_code_digable_grave"),
  ]),
  
  ("cf_graves_loot", # server: Setup graves
  [(multiplayer_is_server),
    (store_script_param, ":pos", 1), # must be valid
    (store_random_in_range,":random_item",1,100),
    
    (try_begin),
      (is_between,":random_item",1,10),
      (assign,":item_id","itm_rusty_sword"),
    (else_try),
      (is_between,":random_item",11,20),
      (assign,":item_id","itm_old_knife"),
    (else_try),
      (is_between,":random_item",21,30),
      (assign,":item_id","itm_crude_spear"),
    (else_try),
      (assign,":item_id","itm_bone"),
    (try_end),
  ...
  ("cf_digging", # server: Handles digging of props
  [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    (store_script_param, ":attack_pos", 3), # must be valid
    ...
    (neq,":hidden",scene_prop_state_hidden), # Ensure the prop isnt dead
    (agent_get_wielded_item,":weapon",":agent_id",0),
    (eq,":weapon","itm_shovel"),#Ensure they are digging with a spade
    (agent_get_action_dir, ":direction", ":agent_id"),
    (eq, ":direction", 0),
    (particle_system_burst, "psys_dummy_smoke", ":attack_pos", 6), #do effects
    (scene_prop_get_hit_points, ":health", ":instance_id"),
    (try_begin),
      (gt,":health",1),
      (val_sub,":health",1),
      (scene_prop_set_cur_hit_points, ":instance_id", ":health"),
      (prop_instance_get_position, pos2, ":instance_id"),
      (position_move_z, pos2, -4, 1),
      (prop_instance_animate_to_position, ":instance_id", pos2, 10),
    (else_try),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_state, scene_prop_state_hidden),
      (prop_instance_get_starting_position, pos2, ":instance_id"),
      (init_position,pos3),
      (copy_position,pos3,pos2),
      (position_move_z, pos3, 300, 1),
      (call_script, "script_cf_graves_loot", pos3),
      (position_move_z, pos2, -900, 1),
      (prop_instance_animate_to_position, ":instance_id", pos2, 500),
      (call_script, "script_add_resource_to_regrow_list", ":instance_id", 300),
      (prop_instance_refill_hit_points, ":instance_id"),
    (try_end),
  ]),
  
  ("market_get_owner", # client: Return the market stalls owner
   [(store_script_param, ":instance_id", 1), # must be valid
    (str_store_string, s1, "str_na"),
    (multiplayer_send_2_int_to_server, client_event_request_scene_prop_slot, ":instance_id", slot_scene_prop_inventory_shop_pid),
    (assign,reg20,0),#Didnt find
    (scene_prop_get_slot,":owner_player_id",":instance_id",slot_scene_prop_inventory_shop_pid),
    (try_begin),
      (gt,":owner_player_id",0),
      (str_store_player_username,s1,":owner_player_id"),
      (assign,reg20,1),#Found
    (try_end),
    ]),
  
  ("cf_market_update_children", # server: Update the owners of the doors
   [(multiplayer_is_server),
    (store_script_param, ":player_unique_id", 1), # must be valid
    (store_script_param, ":link_id", 2), # must be valid
    (assign,":last_prop",market_props_end),
    (try_for_range, ":scene_prop_kind", market_props_start, ":last_prop"),
      (scene_prop_get_num_instances, ":num_instances", ":scene_prop_kind"),
      (try_for_range, ":instance_no", 0, ":num_instances"),
        (scene_prop_get_instance, ":child_instance_id", ":scene_prop_kind", ":instance_no"),
        (prop_instance_get_variation_id_2, ":child", ":child_instance_id"),
        (eq,":link_id",":child"),
        (scene_prop_set_slot, ":child_instance_id", slot_scene_prop_inventory_shop_uid, ":player_unique_id"),
      (try_end),
    (try_end),
    ]),
    
  ("cf_market_stall_get_owner_player", # server: Return the market stalls owner
   [(multiplayer_is_server),
    (store_script_param, ":instance_id", 1), # must be valid
    (scene_prop_get_slot,":owner_player_id",":instance_id",slot_scene_prop_inventory_shop_uid),
    (get_max_players, ":max_players"),
    (assign,reg20,0),
    (try_for_range, ":player_id", 1, ":max_players"),
      (player_is_active, ":player_id"),
      (player_get_unique_id, ":player_unique_id", ":player_id"),
      (eq,":player_unique_id",":owner_player_id"),#Found owner
      (assign,reg20,":player_id"),
    (try_end),
    (gt,reg20,0),
    ]),
    
  ("cf_check_player_has_market_stall", # server: Check for player owning a market stall
   [(multiplayer_is_server),
    (store_script_param, ":player_unique_id", 1), # must be valid
    (assign,reg10,-1),#Instance ID
    (scene_prop_get_num_instances, ":num_instances", "spr_fw_market_buy_property"),
    (try_for_range, ":instance_no", 0, ":num_instances"),
      (eq,reg10,-1), # ensure we dont go over props when we already found it
      (scene_prop_get_instance, ":instance_id", "spr_fw_market_buy_property", ":instance_no"),
      (scene_prop_get_slot,":owner_player_id",":instance_id",slot_scene_prop_inventory_shop_uid),
      (eq,":owner_player_id",":player_unique_id"),# Check if prop has owner
      (assign,reg10,":instance_id"),#Owns a property
    (try_end),
    (gt,reg10,-1),
    ]),
    
  ("cf_buy_market_stall", # server: Buy your own market stall and sell item inside its contents, If already owned then its used to sell market stalls
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    (agent_is_active,":agent_id"),
    ...
    (gt,":price",0), # ensure there is a price for it
    
    (player_get_unique_id, ":player_unique_id", ":player_id"),
    (scene_prop_get_slot,":owner_player_id",":instance_id",slot_scene_prop_inventory_shop_uid),
    (try_begin), # checking if we want to sell
      (call_script, "script_cf_check_player_has_market_stall", ":player_unique_id"),
      (eq,reg10,":instance_id"), # ensure we do all the checks of ownership
      (eq,":owner_player_id",":player_unique_id"),# Is the owner so now he wants to sell
      (call_script, "script_player_adjust_gold", ":player_id", ":price", 1),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_shop_uid, -1),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_shop_pid, -1),
      (prop_instance_get_variation_id_2, ":owner_link", ":instance_id"),
      (call_script, "script_cf_market_update_children", -1, ":owner_link"),
    (else_try),#Checking if we want to buy
      (eq,":owner_player_id",-1),
        (assign,":fail",0),
        (try_begin), # if the player already owns a prop then fail the buying
          (call_script, "script_cf_check_player_has_market_stall", ":player_unique_id"),
          (assign,":fail",1),
        (try_end),
        (eq,":fail",0),
        (call_script, "script_cf_check_enough_gold", ":player_id", ":price"),
        (call_script, "script_player_adjust_gold", ":player_id", ":price", -1),
        (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_shop_uid, ":player_unique_id"),
        (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_shop_pid, ":player_id"),
        (prop_instance_get_variation_id_2, ":owner_link", ":instance_id"),
        (call_script, "script_cf_market_update_children", ":player_unique_id", ":owner_link"),
    (try_end),
    ]),
    
  ("cf_player_leave_market", # server: Selling the market stall for no gold
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1), # must be valid
    (player_is_active,":player_id"),
    (player_get_unique_id, ":player_unique_id", ":player_id"),
    (call_script, "script_cf_check_player_has_market_stall", ":player_unique_id"),
    (assign,":instance_id",reg10),
    (player_get_agent_id, ":agent_id", ":player_id"),
    (agent_is_active,":agent_id"),
    (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_shop_uid, -1),
    (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_shop_pid, -1),
  ...
  ("cf_init_market_door", # server: set the inital position of a market door
   [(store_script_param, ":instance_id", 1), # must be valid
    (store_script_param, ":left", 2),
    (scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_shop_uid, -1),
    (prop_instance_get_variation_id, ":bit_field", ":instance_id"),
    (store_and, ":start_destroyed", ":bit_field", 0x10),
    (try_begin),
      (eq, ":start_destroyed", 0x10),
      (call_script, "script_destroy_door", -1, ":instance_id"),
  ...
  ("cf_use_market_door", # server: handle market property doors
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    (store_script_param, ":left", 3), # 1 makes the door rotate the other way, for matching left and right doors
    ...
    (try_begin),
      (scene_prop_slot_eq, ":instance_id", slot_scene_prop_rotation, 1),
    (else_try),
      (eq, ":owner_player_id", ":player_unique_id"),
    (else_try),
      (eq,":owner_player_id",-1),
    (else_try),
      (assign, ":fail_string_id", "str_market_door_not_owner"),
    (try_end),
    (try_begin),
      (gt, ":fail_string_id", 0),
      (prop_instance_get_variation_id, ":not_pickable", ":instance_id"),
      (val_and, ":not_pickable", 0x4),
      (neq, ":not_pickable", 0x4),
      (try_begin),
        (call_script, "script_cf_agent_pick_lock", ":agent_id", 100),
    ...
    (try_end),
    (try_begin),
      (eq, ":fail_string_id", "str_market_door_not_owner"),
      (multiplayer_send_2_int_to_player, ":player_id", server_event_preset_message, ":fail_string_id", preset_message_error),
    (try_end),
    (eq, ":fail_string_id", 0),
    (call_script, "script_cf_rotate_door", ":instance_id", ":left"),
  ...
  ("cf_hail_to_the_king", # server: Hail the new king
   [(multiplayer_is_server),
    (store_script_param, ":send_player_id", 1), # must be valid
    (store_script_param, ":faction_id", 2), # faction id
    (get_max_players, ":max_players"),
    (try_for_range, ":player_id", 1, ":max_players"),
      (player_is_active, ":player_id"),
      (multiplayer_send_2_int_to_player, ":player_id", server_event_player_advanced_lord_announce, ":send_player_id", ":faction_id"),
    (try_end),
    ]),
    
  ("cf_can_become_advanced_leader", # server: Check if a faction has conquered all the factions
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1), # must be valid
    (player_is_active,":player_id"),
    (call_script, "script_cf_player_is_lord", ":player_id"), # Ensure that the player is a lord before declaring them king
    (player_get_slot, ":faction_id", ":player_id", slot_player_faction_id),
    (is_between, ":faction_id", castle_factions_begin, factions_end), #Ensure its a castle faction
    (assign,":OwnedCastles",0),
    (scene_prop_get_num_instances, ":num_instances", "spr_pw_castle_capture_point"),
    (try_for_range, ":instance_no", 0, ":num_instances"),
      (scene_prop_get_instance, ":instance_id", "spr_pw_castle_capture_point", ":instance_no"),
      (call_script, "script_scene_prop_get_owning_faction", ":instance_id"),
      (eq,":faction_id",reg0),#They own this so add it up
      (val_add,":OwnedCastles",1),
    (try_end),
    (eq,":OwnedCastles",":num_instances"),
    ]),
    
  ("cf_faction_owned_castles", # server: return the amount of castles owned by a faction
   [(multiplayer_is_server),
    (store_script_param, ":player_id", 1), # must be valid
    (player_is_active,":player_id"),
    (call_script, "script_cf_player_is_lord", ":player_id"), # Ensure that the player is a lord before declaring them king
  ...
  ("cf_subjugate_members", # server: change the conquered_faction members into the victor_faction
   [(multiplayer_is_server),
    (store_script_param, ":conquered_faction", 1), # must be valid
    (store_script_param, ":victor_faction", 2), # must be valid
    ...
    (try_for_range, ":player_id", 1, ":max_players"),
      ...
      (player_get_slot, ":player_faction_id", ":player_id", slot_player_faction_id),
      (try_begin),
        (eq,":conquered_faction",":player_faction_id"),
        (try_begin),
          (player_slot_eq, ":player_id", slot_player_is_lord, 1),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_preset_message, "str_your_faction_subjugated_by_s1", preset_message_faction|preset_message_log, ":victor_faction"),
        (else_try),
          (call_script, "script_change_faction", ":player_id", ":victor_faction", change_faction_type_subjugate),
          (call_script, "script_player_redraw_heraldic_items", ":player_id"),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_preset_message, "str_you_have_been_subjugated_by_s1", preset_message_faction|preset_message_log, ":victor_faction"),
        (try_end),
      (try_end),
    (try_end),
    ]),
    
  ("cf_use_subjugate_point", # server: after an agent uses a subjugate point scene prop, subjugate the castle if checks succeed
   [(store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    ...
    (try_begin), # capturing a hostile point with own faction's banner
      (neq, ":faction_id", ":player_faction_id"),
      (try_begin),# Factions must be hostile to subjugate
        (call_script, "script_cf_factions_are_hostile", ":faction_id", ":player_faction_id"),
      (else_try),
        (assign, ":castle_no", -1),
        (multiplayer_send_3_int_to_player, ":player_id", server_event_preset_message, "str_your_faction_not_hostile_to_s1", preset_message_faction|preset_message_fail_sound, ":faction_id"),
      ...
      (ge, ":strength", ":difficulty"),
      (try_begin),
        (call_script, "script_cf_player_is_lord", ":player_id"), # must be lord to subjugate
        (try_begin), # when capturing a primary point, check whether the required secondary points have been captured
          (eq, ":capture_type", capture_point_type_primary),
          (assign, ":type_secondary_all_check_result", -1),
          (assign, ":type_secondary_one_check_result", -1),
          ...
          (try_begin),
            (neq, ":type_secondary_all_check_result", 0),
            (neq, ":type_secondary_one_check_result", 0),
            (call_script, "script_cf_faction_owned_castles", ":player_id"),
            (try_begin),
              (eq,reg20,1),#Ensure the faction only owns one castle
              (call_script, "script_cf_agent_consume_item", ":agent_id", ":banner_item_id", 1),
              (call_script, "script_capture_castle", ":player_faction_id", ":castle_no"),
              (call_script, "script_cf_subjugate_members", ":faction_id", ":player_faction_id"),
            (else_try),
              (multiplayer_send_3_int_to_player, ":player_id", server_event_preset_message, "str_cannot_subjugate_faction_who_still_own_castles", preset_message_faction|preset_message_fail_sound, ":player_faction_id"),
            (try_end),
          (else_try),
            (multiplayer_send_3_int_to_player, ":player_id", server_event_preset_message, "str_your_faction_not_captured_required_points", preset_message_faction|preset_message_fail_sound, ":player_faction_id"),
          (try_end),
        (try_end),
      (else_try),
        (multiplayer_send_3_int_to_player, ":player_id", server_event_preset_message, "str_lord_to_subjugate", preset_message_faction|preset_message_fail_sound, ":player_faction_id"),
      (try_end),
    (else_try),
      (assign, ":castle_no", -1),
    (try_end),
  ...
  ("cf_damage_agents_in_area", # server: damage agents in a radius on a position
   [(multiplayer_is_server),
    (store_script_param, ":pos", 1), # must be valid
    (store_script_param, ":max_distance", 2), # must be valid
    (store_script_param, ":min_damage", 3), # must be valid
    (store_script_param, ":max_damage", 4), # must be valid
    (try_for_agents, ":agent_id"),# Deal damage to agents
      (agent_is_active,":agent_id"),
      (agent_is_alive,":agent_id"),
      (agent_get_position,pos2,":agent_id"),
      (get_distance_between_positions,":distance",":pos",pos2),
      (le,":distance",":max_distance"),# Is the agent close enough to get damaged
      (store_agent_hit_points, ":hit_points", ":agent_id", 1),
      (store_random_in_range,":damage",":min_damage",":max_damage"),
      (val_sub, ":hit_points", ":damage"),
      (agent_set_hit_points, ":agent_id", ":hit_points", 1),
      (try_begin),#Do anims if human
        (agent_is_human,":agent_id"),
        (store_random_in_range,":anim",1,2),
        (try_begin),
          (eq,":anim",1),
  ...
  ("cf_alchemy_extract", # server: Using the extract prop to produce alchemy ingredients from certain items.
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    
    (call_script, "script_cf_has_enough_skill_level", ":agent_id", "skl_alchemy", 1),#Assign reg4
    (try_begin),
    (eq,reg4,0),#Must have atleast level 1 in alchemy to extract ingredients.
      (agent_get_wielded_item,":item",":agent_id",0),
      ...
      (try_begin),
        (eq,":item","itm_bone"),
        (assign,":new_item","itm_bone_meal"),
      (else_try),
        (eq,":item","itm_raw_meat"),
        (assign,":new_item","itm_potion_blood"),
      (else_try),
        (eq,":item","itm_strange_meat"),
        (assign,":new_item","itm_potion_human_blood"),
      (else_try),
        (eq,":item","itm_coal"),
        (assign,":new_item","itm_black_powder"),
      (try_end),
      
      #Produce new item if available
      (try_begin),
        (gt,":new_item",-1),
        (call_script, "script_cf_agent_consume_item", ":agent_id", ":item", 1),
        (prop_instance_get_position, pos1, ":instance_id"),
        (set_spawn_position, pos1),
        (spawn_item, ":new_item", 0, "$g_spawn_item_prune_time"),
      (try_end),
    (try_end),
    
    ]),
    
  ("cf_alchemy_mixing_bowl_item", # server: Using the mixing bowl of a alchemy station with a wielded item
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    ...
    (try_begin),
      ...
      (item_get_slot,":item_type",":item",slot_item_class),
      (this_or_next|eq, ":item_type", item_class_alchemy),
      (this_or_next|eq, ":item_type", item_class_fuel),
      (this_or_next|eq, ":item_type", item_class_poison),
      (this_or_next|eq, ":item_type", item_class_remedy),
      (this_or_next|eq, ":item_type", item_class_drink),
      (eq,":item_type",item_class_food),
      ...
      (else_try),
        ...
        (call_script, "script_cf_agent_consume_item", ":agent_id", ":item", 1),
      (try_end),
    (else_try),#Recover third ingredient
      (eq,":fail",1),
      (neq,":item_3",0),
      (call_script, "script_spawn_processed_resources", ":agent_id", ":item_3", 1),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_3, 0),
  ...
  ("cf_alchemy_mixing_bowl", # server: Using the mixing bowl of a alchemy station with no item
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    ...
    (try_begin),
      (gt,":slotfree",1),#There must be some items inside before we can take them out
      (try_begin),
        (eq,":fail",1),# Grab items out if the pot isnt full
        (try_begin),
          (eq,":slotfree",3),
          (call_script, "script_spawn_processed_resources", ":agent_id", ":item_2", 1),
          (scene_prop_set_slot, ":instance_id", slot_scene_prop_item_slot_2, 0),
  ...
  ("cf_alchemy_try_produce_potion", # server: Try to produce the specific potion
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
    (store_script_param, ":level", 3), # must be valid
    (store_script_param, ":potion", 4), # must be valid
    (store_script_param, ":ingredient_1", 5), # must be valid
    (store_script_param, ":ingredient_2", 6), # must be valid
    (store_script_param, ":ingredient_3", 7), # must be valid
    ...
    (call_script, "script_cf_has_enough_skill_level", ":agent_id", "skl_alchemy", ":level"),
    (try_begin),#Burn the ingredients as the alchemist doesnt have the required level
      (eq,reg4,1),
      (assign,":Checklist",0),
    (try_end),
  ...
  ("cf_alchemy_do_poison_effects", # server: Applying poisons to consumables e.g food
  [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    ...
    (item_get_slot, ":potion_intensity", ":item", slot_item_resource_amount),
    (gt,":potion_intensity",0),
    
    (agent_get_slot, ":poison", ":agent_id", slot_agent_poison_amount),
    (val_add, ":poison", ":potion_intensity"),
    (agent_set_slot, ":agent_id", slot_agent_poison_amount, ":poison"),
    (agent_set_slot, ":agent_id", slot_agent_poisoner_agent_id, ":agent_id"),
    (agent_set_slot, ":agent_id", slot_agent_poisoner_player_uid, -1),
    
    
    (try_begin),#Test to see if the item is food if so give them food amount to not arise suspicious intents
      (this_or_next|eq,":potion_intensity",2),
      (eq,":potion_intensity",1),
      
      (assign,":original_item",":item"),
      (val_sub,":original_item",":potion_intensity"),
      (item_get_slot,":original_item_type",":original_item",slot_item_class),
      (this_or_next|eq,":original_item_type",item_class_food),
      (eq,":original_item_type",item_class_drink),

      (item_get_slot, ":food", ":original_item", slot_item_resource_amount),
      (gt, ":food", 0),
      (agent_get_slot, ":food_amount", ":agent_id", slot_agent_food_amount),
      (lt, ":food_amount", max_food_amount),
      (val_add, ":food_amount", ":food"),
      ...
      (try_begin),#Apply drunkness
        (eq,":original_item_type",item_class_drink),
        (agent_set_slot, ":agent_id", slot_agent_drunkness, ":food"),
      (try_end),
  ...
  ("cf_alchemy_do_remedy_effects", # server: Applying cures to poison to consumables e.g herbs
  [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":item", 2),
    (agent_is_active,":agent_id"),
    ...
    (try_begin),
      (gt,":poison",0),
      (assign,":new_poison",":poison"),
      (val_sub, ":new_poison", ":potion_intensity"),
      (try_begin),
        (lt,":new_poison",0),
        (assign,":new_poison",0),
      (try_end),
      (agent_set_slot, ":agent_id", slot_agent_poison_amount, ":new_poison"),
    (try_end),
    (call_script, "script_cf_agent_consume_item", ":agent_id", ":item", 1),
  ]),
    
  ("cf_alchemy_consume_potion", # server: Using potion effects - Consume only
  [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":potion", 2), # must be valid
    (agent_is_active,":agent_id"),
    (agent_is_alive,":agent_id"),
    (assign,":valid",0),

    (try_begin),
      (eq,":potion","itm_potion_poison"),
        (agent_get_slot, ":poison", ":agent_id", slot_agent_poison_amount),
        (val_add, ":poison", 1),
        (agent_set_slot, ":agent_id", slot_agent_poison_amount, ":poison"),
        (agent_set_slot, ":agent_id", slot_agent_poisoner_agent_id, ":agent_id"),
    ...
    (else_try),
      (eq,":potion","itm_potion_toxin"),
        ...
        (assign,":valid",1),
    (else_try),
      (eq,":potion","itm_potion_remedy"),
        (agent_get_slot, ":poison", ":agent_id", slot_agent_poison_amount),
        (try_begin),
          (gt,":poison",0),
          (assign,":new_poison",":poison"),
          (val_sub, ":new_poison", 2),
          (try_begin),
            (lt,":new_poison",0),
            (assign,":new_poison",0),
          (try_end),
        ...
        (assign,":valid",1),
    (else_try),
      (eq,":potion","itm_potion_advanced_remedy"),
        (agent_set_slot, ":agent_id", slot_agent_poison_amount, 0),
        (assign,":valid",1),
    (else_try),
      (eq,":potion","itm_potion_health"),
        (store_agent_hit_points, ":health_percent", ":agent_id", 0),
        (val_add,":health_percent",25),
        (agent_set_hit_points, ":agent_id" , ":health_percent", 0),
        (assign,":valid",1),
    (else_try),
      (eq,":potion","itm_potion_advanced_health"),
        (store_agent_hit_points, ":health_percent", ":agent_id", 0),
        (val_add,":health_percent",50),
        (agent_set_hit_points, ":agent_id" , ":health_percent", 0),
        (assign,":valid",1),
    (try_end),
    ...
    (try_begin),
      (eq,":valid",1),
      (call_script, "script_cf_agent_consume_item", ":agent_id", ":potion", 1),
    (try_end),
  ]),
  
  ("cf_alchemy_throw_potion", # server: Using potion effects - Throw only
  [(multiplayer_is_server),
    (store_script_param, ":pos", 1), # must be valid
    (store_script_param, ":hittype", 2), # must be valid
    (store_script_param, ":potion", 3), # must be valid
    
    (try_begin),
      (eq,":potion","itm_potion_smoke"),
        (particle_system_burst, "psys_potion_smoke", ":pos", 300),
    (else_try),
      (eq,":potion","itm_potion_fire"),
        (particle_system_burst, "psys_potion_fire", ":pos", 40),
        (call_script, "script_cf_burn_position", 1, ":pos", 80), # Set other props on fire around this object
        (try_begin),
          (eq,":hittype",1),#If hit agent
          (try_for_agents,":target"),
            (agent_is_active,":target"),
            (assign,":distance",250),
            (agent_get_position,pos2,":target"),
          ...
          (ge,":agent_id",0),
          (agent_get_position,pos2,":agent_id"),
          (call_script, "script_cf_damage_agents_in_area", pos2, 130, 8, 20),
        (else_try),
          (call_script, "script_cf_damage_agents_in_area", ":pos", 180, 8, 20),
        (try_end),
    (else_try),
      (eq,":potion","itm_potion_dragon_fire"),
        (particle_system_burst, "psys_potion_dragon_fire", ":pos", 120),
        (call_script, "script_cf_burn_position", 2, ":pos", 80), # Set other props on fire around this object
        (try_begin),
          (eq,":hittype",1),#If hit agent
          (try_for_agents,":target"),
            (agent_is_active,":target"),
          ...
          (ge,":agent_id",0),
          (agent_get_position,pos2,":agent_id"),
          (call_script, "script_cf_damage_agents_in_area", pos2, 130, 8, 40),
        (else_try),
          (call_script, "script_cf_damage_agents_in_area", ":pos", 180, 8, 40),
        (try_end),
    (try_end),
  ]),
  ...
  ("cf_horse_move_to_position", # server: Moving horses to set positions
   [(multiplayer_is_server),
    (store_script_param, ":animal_agent_id", 1), # must be valid
    (store_script_param, ":pos", 2), # must be valid
    (agent_is_active,":animal_agent_id"),
    (agent_is_alive,":animal_agent_id"),
    (neg|agent_is_human,":animal_agent_id"),
    (store_random_in_range, ":random_angle", -30, 30),
    (get_scene_boundaries, pos8, pos9),
    (position_get_x, ":scene_min_x", pos8),
    (position_get_y, ":scene_min_y", pos8),
    ...
    (assign, ":loop_end", 10),
    (try_for_range, ":unused", 0, ":loop_end"), # test multiple different distances and angles diverging from the current heading
      (position_rotate_z, ":pos", ":random_angle"),
      (store_random_in_range, ":random_distance", 100, 1000),
      (position_move_y, ":pos", ":random_distance"),
      (copy_position, pos3, ":pos"),
      (position_set_z, pos3, 0),
      (position_get_distance_to_terrain, ":water_depth", pos3),
      (try_begin), # avoid water and scene boundaries
        (lt, ":water_depth", z_position_water_level * -1),
        ...
        (try_end),
        (eq, ":continue", 1),
        (position_get_distance_to_terrain, ":distance_to_terrain", ":pos"),
        (val_mul, ":distance_to_terrain", -1),
        (position_move_z, ":pos", ":distance_to_terrain"),   
        (agent_set_scripted_destination, ":animal_agent_id", ":pos", 1),
        (assign, ":loop_end", -1),
      (try_end),
    (try_end),
    ]),
  
  ("cf_equip_wield_item", # server: Quick and easy equip and wield item
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":item_id", 2), # must be valid
    (assign,":SlotFree", 0),
    (try_for_range, ":equip_slot", ek_item_0, ek_item_3 + 1),
      (eq,":SlotFree",0),
      (agent_get_item_slot, ":item_slot", ":agent_id", ":equip_slot"),
      (try_begin),
        (lt,":item_slot", 0),
        (assign,":SlotFree",1),
      (try_end),
  ...
  ("cf_agent_drop_all_weapons", # server: Agent drop all weapons
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (agent_get_position, pos1, ":agent_id"),
    (set_fixed_point_multiplier, 100),
    (try_for_range, ":equip_slot", ek_item_0, ek_item_3 + 1),
      ...
      (call_script, "script_set_random_spawn_position", 50),
      (spawn_item, ":item_id", 0, "$g_spawn_item_prune_time"),
      (call_script, "script_check_on_item_dropped", ":agent_id", ":item_id", 0, 1),
    (try_end),
    ]),
    
  ("cf_agent_realign_ammo", # server: Agent realign ammo to a correct order # reg2 = default  ammo # reg3 = new ammo
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":type", 2), # must be valid
    (store_script_param, ":first_item", 3), # must be valid
    ...
    (try_begin),#Slot 0
      (agent_get_item_slot, ":item_id_0", ":agent_id", ek_item_0),
      (ge,":item_id_0",0),
      (item_get_type, ":ammo_type", ":item_id_0"),
      (eq,":ammo_type",":type"),# Check if correct type
      (assign,":slot_0",":item_id_0"),
      (agent_get_ammo_for_slot, ":slot_0_ammo", ":agent_id", ek_item_0),
    (try_end),
    
    (try_begin),#Slot 1
      (agent_get_item_slot, ":item_id_1", ":agent_id", ek_item_1),
      (ge,":item_id_1",0),
      (item_get_type, ":ammo_type_1", ":item_id_1"),
      (eq,":ammo_type_1",":type"),# Check if correct type
      (assign,":slot_1",":item_id_1"),
      (agent_get_ammo_for_slot, ":slot_1_ammo", ":agent_id", ek_item_1),
    (try_end),
    
    (try_begin),#Slot 2
      (agent_get_item_slot, ":item_id_2", ":agent_id", ek_item_2),
      (ge,":item_id_2",0),
      (item_get_type, ":ammo_type_2", ":item_id_2"),
      (eq,":ammo_type_2",":type"),# Check if correct type
      (assign,":slot_2",":item_id_2"),
      (agent_get_ammo_for_slot, ":slot_2_ammo", ":agent_id", ek_item_2),
    (try_end),
    
    (try_begin),#Slot 3
      (agent_get_item_slot, ":item_id_3", ":agent_id", ek_item_3),
      (ge,":item_id_3",0),
      (item_get_type, ":ammo_type_3", ":item_id_3"),
      (eq,":ammo_type_3",":type"),# Check if correct type
      (assign,":slot_3",":item_id_3"),
      (agent_get_ammo_for_slot, ":slot_3_ammo", ":agent_id", ek_item_3),
    (try_end),

    ## Go the opposite way to find the first ammo of its type
    (try_begin),
      (ge,":slot_3",0),
        (agent_unequip_item, ":agent_id", ":slot_3", ek_item_3),
        (assign,reg2,":slot_3"),
    (try_end),
    
    (try_begin),
      (ge,":slot_2",0),
        (agent_unequip_item, ":agent_id", ":slot_2", ek_item_2),
        (assign,reg2,":slot_2"),
    (try_end),
    
    (try_begin),
      (ge,":slot_1",0),
        (agent_unequip_item, ":agent_id", ":slot_1", ek_item_1),
        (assign,reg2,":slot_1"),
    (try_end),
    
    (try_begin),
      (ge,":slot_0",0),
        (agent_unequip_item, ":agent_id", ":slot_0", ek_item_0),
        (assign,reg2,":slot_0"),
    (try_end),
    
    (assign,reg3,":first_item"),
    (agent_equip_item, ":agent_id", ":first_item"),
    (agent_set_wielded_item, ":agent_id", ":first_item"), # not sure if this affects it but do it eitherway
    
    # Now equip the old ammo
    
    (try_begin),
      (ge,":slot_0",0),
      (gt,":slot_0_ammo",0),
      (agent_equip_item, ":agent_id", ":slot_0"),
      (agent_set_ammo,":agent_id",":slot_0",":slot_0_ammo"),
    (try_end),
    
    (try_begin),
      (ge,":slot_1",0),
      (gt,":slot_1_ammo",0),
      (agent_equip_item, ":agent_id", ":slot_1"),
      (agent_set_ammo,":agent_id",":slot_1",":slot_1_ammo"), 
    (try_end),
    
    (try_begin),
      (ge,":slot_2",0),
      (gt,":slot_2_ammo",0),
      (agent_equip_item, ":agent_id", ":slot_2"),
      (agent_set_ammo,":agent_id",":slot_2",":slot_2_ammo"),
    (try_end),
    
    (try_begin),
      (ge,":slot_3",0),
      (gt,":slot_3_ammo",0),
      (agent_equip_item, ":agent_id", ":slot_3"),
      (agent_set_ammo,":agent_id",":slot_3",":slot_3_ammo"),
    (try_end),
    ]),
    
  ("cf_fire_items", # server: Using fire on certain items
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (agent_get_wielded_item, ":weapon", ":agent_id", 0),# Get wielded item
    (ge,":weapon",0),#Ensure there is a weapon there
    (item_get_type, ":weapon_type", ":weapon"),
    (try_begin),
      (eq,":weapon_type",itp_type_bow),# Ensure the agent is holding a bow to do fire arrows
      (call_script, "script_cf_equip_bow_special_ammo", ":agent_id", "itm_fire_arrows", 1),
    (else_try),
      (eq,":weapon","itm_stick"),
        (call_script, "script_cf_agent_consume_item", ":agent_id", ":weapon", 1),
        (agent_equip_item, ":agent_id", "itm_torch"),
        (agent_set_wielded_item, ":agent_id", "itm_torch"),
    (try_end),
    ]),
    
  ("cf_equip_bow_special_ammo", # server: Equiping special ammo handling e.g. fire arrows
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":item_id", 2), # must be valid
    (store_script_param, ":quantity", 3), # must have a value

    (assign,":default_ammo_slot", -1),
    (try_for_range, ":default_check", ek_item_0, ek_item_3),# Check for special ammo type
      (agent_get_item_slot, ":default_check_item", ":agent_id", ":default_check"),
      (ge,":default_check_item",0), # Ensure there is a item there
      (eq,":default_ammo_slot", -1),# Check if already found first set of ammo
      (item_get_type, ":default_ammo_type", ":default_check_item"),
      (eq,":default_ammo_type",itp_type_arrows),# Check if correct type
      (neq,":default_check_item",":item_id"),# Ensure we dont check for the ammo we want
      (assign,":default_ammo_slot", ":default_check"),
    (try_end),
    (ge,":default_ammo_slot",0),# If agent has ammo continue
    (agent_get_item_slot, ":default_ammo", ":agent_id", ":default_ammo_slot"),
    (agent_get_ammo_for_slot, ":default_ammo_amount", ":agent_id", ":default_ammo_slot"),
    (ge,":default_ammo_amount",":quantity"),# Ensure the agent has more or the required amount of ammo to continue
    
    (assign,":slot", -1),
    (assign,":HasAmmo", 0),
    (try_for_range, ":equip_slot", ek_item_0, ek_item_3 + 1),# Check for special ammo type
      (agent_get_item_slot, ":item_slot", ":agent_id", ":equip_slot"),
      (ge,":item_slot",0), # Ensure there is a item there
      (eq,":slot", -1),
      (eq,":item_slot", ":item_id"),
      (assign,":HasAmmo",1),
      (assign,":slot", ":equip_slot"),
    (try_end),
    (try_begin),# See if agent already has the special ammo type already
      (eq,":HasAmmo",1),
        (val_sub,":default_ammo_amount",":quantity"),
        (agent_set_ammo,":agent_id",":default_ammo",":default_ammo_amount"),# Sub Default Ammo

        (agent_get_ammo_for_slot, ":AmmoAmount", ":agent_id", ":slot"),
        (val_add,":AmmoAmount",":quantity"),
        (agent_set_ammo,":agent_id",":item_id",":AmmoAmount"),# Add Special Ammo
    (else_try),# Agent doesnt already have ammo try equiping the new type
      (assign,":SlotFree", 0),
      (try_for_range, ":equip_slot2", ek_item_0, ek_item_3 + 1),# Check for a free slot
        (agent_get_item_slot, ":item_slot2", ":agent_id", ":equip_slot2"),
        (lt,":item_slot2", 0),
          (assign,":SlotFree",1),
      (try_end),
      (try_begin),# Has a free slot so now just equip the ammo type.
        (ge,":SlotFree",1),
          (assign,":Arrow_Types",0),
          (try_for_range, ":equip_slot3", ek_item_0, ek_item_3 + 1),# Check for a free slot
            (agent_get_item_slot, ":item_slot3", ":agent_id", ":equip_slot3"),
            (ge,":item_slot3", 0), # Ensure item is there
            (eq,":item_slot3", ":default_check_item"),
            (val_add,":Arrow_Types",1),
          (try_end),
          (le,":Arrow_Types",1),# ensure there is no multiple stacks of the same type of ammo due to bug
          (call_script, "script_cf_agent_realign_ammo", ":agent_id", itp_type_arrows, ":item_id"),
          (val_sub,":default_ammo_amount",":quantity"),
          (agent_set_ammo,":agent_id",reg2,":default_ammo_amount"),# Sub Default Ammo
          (agent_set_ammo,":agent_id",reg3,":quantity"),# Add Special Ammo
      (try_end),
    (try_end),
    ]),
    
  ("player_adjust_gold_silent", # server: adjust player gold but silent
   [(store_script_param, ":player_id", 1), # must be valid
    (store_script_param, ":gold_value", 2), # ignored if not positive
    (store_script_param, ":add_abs_sub", 3), # -1 = subtract, 0 = set, 1 = add
  ...
  ("cf_faction_issue_wages", # server: Issue wages to faction members
   [(multiplayer_is_server),
    (store_script_param, ":faction_id", 1), # faction
    (store_script_param, ":gold_value", 2), # Cost
    (store_script_param, ":percentage", 3), # wages percentage
    (try_begin),
      (neg|is_between, ":faction_id", factions_begin, castle_factions_begin), # Ensure no commoners or bandits get wages p.s had to end with townwatch due to is between and how it works
    
      (try_begin), # Work out how much gold is going to each worker
        (gt, ":percentage", -1),
        (val_mul, ":gold_value", ":percentage"),
        (val_div, ":gold_value", 100),
      (try_end),
      
      #(assign,reg0,":gold_value"),
      ...
      (try_for_range, ":player_id", 1, ":max_players"),
        ...
        (try_begin),
          (eq,":faction_id",":player_faction_id"),#Give wages if player is part of the faction
          (player_get_agent_id, ":agent_id", ":player_id"),
          (agent_is_active,":agent_id"),
          (agent_is_alive,":agent_id"),# You need to be alive to receive wages
          (player_get_troop_id, ":troop_id", ":player_id"),
          (store_skill_level, ":wage", "skl_wage", ":troop_id"),
          (try_begin),
            (ge,":wage",1),
            #(val_mul, ":gold_value", ":wage"), # Set players wage multiplied by the wage skill
            (call_script, "script_player_adjust_gold_silent", ":player_id", ":gold_value", 1),
          (try_end),
        (try_end),
      (try_end),
    (try_end),
  ...
  ("cf_import_item", # server: handle players trying to import items
   [(store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":instance_id", 2), # must be valid
   ...
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    (try_begin),
      ...
      (try_begin), # the first script parameter is the name string id, which must be in the appropriate section of module_strings.py
        ...
        animation_menu_entry("str_anim_whistle", man_sound="snd_whistle", woman_sound="snd_whistle"),
      (else_try),
        (assign, ":string_id", -1),
      (try_end),
      (gt, ":string_id", -1),
      ...
      (try_end),
      (try_begin),
        (eq,":sound","snd_whistle"),# Check to call horse if player is whistling
        (agent_get_slot, ":horse_agent_id", ":agent_id", slot_agent_last_horse_ridden),
        (gt,":horse_agent_id",0),
        (agent_is_active,":horse_agent_id"),
        (agent_is_alive,":horse_agent_id"),
        ...
        (agent_get_slot, ":last_rider", ":horse_agent_id", slot_agent_horse_last_rider),
        (eq,":agent_id",":last_rider"),
        
        (agent_get_position,pos2,":agent_id"),
        (call_script, "script_cf_horse_move_to_position", ":horse_agent_id", pos2),
      (try_end),
      (try_begin),
        (gt, ":animation", -1),
        (eq, ":duration_ms", 0),
