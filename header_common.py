...
server_event_set_attached_scene_prop            = 25
server_event_local_animation                    = 26
server_event_update_scene_prop_hit_points       = 27

server_event_agent_stop_sound                   = 28
server_event_agent_play_sound                   = 29

server_event_player_advanced_lord_announce      = 30
server_event_player_minor_lord_announce         = 31
server_event_player_announce_message            = 32

server_event_update_scene_prop_update_physics   = 33

server_event_whisper_chat                       = 34

server_event_set_skybox                         = 35

# Add new events here: above if sent from the server, below if from clients.
client_event_toggle_walk                        = 89

client_event_transfer_bank_gold                 = 90
client_event_request_player_slot                = 91
client_event_request_faction_slot               = 92
client_event_request_scene_prop_slot            = 93
client_event_agent_animate                      = 94
...
admin_action_warn_player                        = 1
admin_action_karma_player                       = 2
admin_action_ban_player_temp                    = 3
admin_action_ban_player_perm                    = 4
admin_action_mute_player                        = 5
admin_action_kill_player                        = 6
admin_action_fade_player_out                    = 7
admin_action_freeze_player                      = 8
admin_action_outlaw_player                      = 9
admin_action_teleport_to_player                 = 10
admin_action_teleport_behind_player             = 11
admin_action_teleport_player_to_admin           = 12
admin_action_teleport_forwards                  = 13
admin_action_get_armor                          = 14
admin_action_get_invisible                      = 15
admin_action_refill_health                      = 16
admin_action_become_godlike                     = 17
admin_action_get_horse                          = 18
admin_action_remove_horses                      = 19
admin_action_remove_stray_horses                = 20
admin_action_remove_wild_animals                = 21
admin_action_remove_corpses                     = 22
admin_action_remove_all_weapons                 = 23
admin_action_reset_carts                        = 24
admin_action_teleport_to_ships                  = 25
admin_action_reset_ships                        = 26
admin_action_lock_faction                       = 27
...
faction_admin_action_set_marshal                = 10
faction_admin_action_set_steward                = 11
faction_admin_action_lock_faction               = 12
